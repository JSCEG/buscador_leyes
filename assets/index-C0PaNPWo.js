 ...
 * lunr.utils
 * Copyright (C) 2020 Oliver Nightingale
 */t.utils={},t.utils.warn=function(e){return function(r){e.console&&console.warn&&console.warn(r)}}(this),t.utils.asString=function(e){return e==null?"":e.toString()},t.utils.clone=function(e){if(e==null)return e;for(var r=Object.create(null),o=Object.keys(e),n=0;n<o.length;n++){var i=o[n],d=e[i];if(Array.isArray(d)){r[i]=d.slice();continue}if(typeof d=="string"||typeof d=="number"||typeof d=="boolean"){r[i]=d;continue}throw new TypeError("clone is not deep and does not support nested objects")}return r},t.FieldRef=function(e,r,o){this.docRef=e,this.fieldName=r,this._stringValue=o},t.FieldRef.joiner="/",t.FieldRef.fromString=function(e){var r=e.indexOf(t.FieldRef.joiner);if(r===-1)throw"malformed field ref string";var o=e.slice(0,r),n=e.slice(r+1);return new t.FieldRef(n,o,e)},t.FieldRef.prototype.toString=function(){return this._stringValue==null&&(this._stringValue=this.fieldName+t.FieldRef.joiner+this.docRef),this._stringValue};/*!
 * lunr.Set
 * Copyright (C) 2020 Oliver Nightingale
 */t.Set=function(e){if(this.elements=Object.create(null),e){this.length=e.length;for(var r=0;r<this.length;r++)this.elements[e[r]]=!0}else this.length=0},t.Set.complete={intersect:function(e){return e},union:function(){return this},contains:function(){return!0}},t.Set.empty={intersect:function(){return this},union:function(e){return e},contains:function(){return!1}},t.Set.prototype.contains=function(e){return!!this.elements[e]},t.Set.prototype.intersect=function(e){var r,o,n,i=[];if(e===t.Set.complete)return this;if(e===t.Set.empty)return e;this.length<e.length?(r=this,o=e):(r=e,o=this),n=Object.keys(r.elements);for(var d=0;d<n.length;d++){var g=n[d];g in o.elements&&i.push(g)}return new t.Set(i)},t.Set.prototype.union=function(e){return e===t.Set.complete?t.Set.complete:e===t.Set.empty?this:new t.Set(Object.keys(this.elements).concat(Object.keys(e.elements)))},t.idf=function(e,r){var o=0;for(var n in e)n!="_index"&&(o+=Object.keys(e[n]).length);var i=(r-o+.5)/(o+.5);return Math.log(1+Math.abs(i))},t.Token=function(e,r){this.str=e||"",this.metadata=r||{}},t.Token.prototype.toString=function(){return this.str},t.Token.prototype.update=function(e){return this.str=e(this.str,this.metadata),this},t.Token.prototype.clone=function(e){return e=e||function(r){return r},new t.Token(e(this.str,this.metadata),this.metadata)};/*!
 * lunr.tokenizer
 * Copyright (C) 2020 Oliver Nightingale
 */t.tokenizer=function(e,r){if(e==null||e==null)return[];if(Array.isArray(e))return e.map(function(M){return new t.Token(t.utils.asString(M).toLowerCase(),t.utils.clone(r))});for(var o=e.toString().toLowerCase(),n=o.length,i=[],d=0,g=0;d<=n;d++){var k=o.charAt(d),L=d-g;if(k.match(t.tokenizer.separator)||d==n){if(L>0){var T=t.utils.clone(r)||{};T.position=[g,L],T.index=i.length,i.push(new t.Token(o.slice(g,d),T))}g=d+1}}return i},t.tokenizer.separator=/[\s\-]+/;/*!
 * lunr.Pipeline
 * Copyright (C) 2020 Oliver Nightingale
 */t.Pipeline=function(){this._stack=[]},t.Pipeline.registeredFunctions=Object.create(null),t.Pipeline.registerFunction=function(e,r){r in this.registeredFunctions&&t.utils.warn("Overwriting existing registered function: "+r),e.label=r,t.Pipeline.registeredFunctions[e.label]=e},t.Pipeline.warnIfFunctionNotRegistered=function(e){var r=e.label&&e.label in this.registeredFunctions;r||t.utils.warn(`Function is not registered with pipeline. This may cause problems when serialising the index.
`,e)},t.Pipeline.load=function(e){var r=new t.Pipeline;return e.forEach(function(o){var n=t.Pipeline.registeredFunctions[o];if(n)r.add(n);else throw new Error("Cannot load unregistered function: "+o)}),r},t.Pipeline.prototype.add=function(){var e=Array.prototype.slice.call(arguments);e.forEach(function(r){t.Pipeline.warnIfFunctionNotRegistered(r),this._stack.push(r)},this)},t.Pipeline.prototype.after=function(e,r){t.Pipeline.warnIfFunctionNotRegistered(r);var o=this._stack.indexOf(e);if(o==-1)throw new Error("Cannot find existingFn");o=o+1,this._stack.splice(o,0,r)},t.Pipeline.prototype.before=function(e,r){t.Pipeline.warnIfFunctionNotRegistered(r);var o=this._stack.indexOf(e);if(o==-1)throw new Error("Cannot find existingFn");this._stack.splice(o,0,r)},t.Pipeline.prototype.remove=function(e){var r=this._stack.indexOf(e);r!=-1&&this._stack.splice(r,1)},t.Pipeline.prototype.run=function(e){for(var r=this._stack.length,o=0;o<r;o++){for(var n=this._stack[o],i=[],d=0;d<e.length;d++){var g=n(e[d],d,e);if(!(g==null||g===""))if(Array.isArray(g))for(var k=0;k<g.length;k++)i.push(g[k]);else i.push(g)}e=i}return e},t.Pipeline.prototype.runString=function(e,r){var o=new t.Token(e,r);return this.run([o]).map(function(n){return n.toString()})},t.Pipeline.prototype.reset=function(){this._stack=[]},t.Pipeline.prototype.toJSON=function(){return this._stack.map(function(e){return t.Pipeline.warnIfFunctionNotRegistered(e),e.label})};/*!
 * lunr.Vector
 * Copyright (C) 2020 Oliver Nightingale
 */t.Vector=function(e){this._magnitude=0,this.elements=e||[]},t.Vector.prototype.positionForIndex=function(e){if(this.elements.length==0)return 0;for(var r=0,o=this.elements.length/2,n=o-r,i=Math.floor(n/2),d=this.elements[i*2];n>1&&(d<e&&(r=i),d>e&&(o=i),d!=e);)n=o-r,i=r+Math.floor(n/2),d=this.elements[i*2];if(d==e||d>e)return i*2;if(d<e)return(i+1)*2},t.Vector.prototype.insert=function(e,r){this.upsert(e,r,function(){throw"duplicate index"})},t.Vector.prototype.upsert=function(e,r,o){this._magnitude=0;var n=this.positionForIndex(e);this.elements[n]==e?this.elements[n+1]=o(this.elements[n+1],r):this.elements.splice(n,0,e,r)},t.Vector.prototype.magnitude=function(){if(this._magnitude)return this._magnitude;for(var e=0,r=this.elements.length,o=1;o<r;o+=2){var n=this.elements[o];e+=n*n}return this._magnitude=Math.sqrt(e)},t.Vector.prototype.dot=function(e){for(var r=0,o=this.elements,n=e.elements,i=o.length,d=n.length,g=0,k=0,L=0,T=0;L<i&&T<d;)g=o[L],k=n[T],g<k?L+=2:g>k?T+=2:g==k&&(r+=o[L+1]*n[T+1],L+=2,T+=2);return r},t.Vector.prototype.similarity=function(e){return this.dot(e)/this.magnitude()||0},t.Vector.prototype.toArray=function(){for(var e=new Array(this.elements.length/2),r=1,o=0;r<this.elements.length;r+=2,o++)e[o]=this.elements[r];return e},t.Vector.prototype.toJSON=function(){return this.elements};/*!
 * lunr.stemmer
 * Copyright (C) 2020 Oliver Nightingale
 * Includes code from - http://tartarus.org/~martin/PorterStemmer/js.txt
 */t.stemmer=function(){var e={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},r={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},o="[^aeiou]",n="[aeiouy]",i=o+"[^aeiouy]*",d=n+"[aeiou]*",g="^("+i+")?"+d+i,k="^("+i+")?"+d+i+"("+d+")?$",L="^("+i+")?"+d+i+d+i,T="^("+i+")?"+n,M=new RegExp(g),P=new RegExp(L),F=new RegExp(k),j=new RegExp(T),N=/^(.+?)(ss|i)es$/,A=/^(.+?)([^s])s$/,R=/^(.+?)eed$/,J=/^(.+?)(ed|ing)$/,s=/.$/,ae=/(at|bl|iz)$/,ce=new RegExp("([^aeiouylsz])\\1$"),ue=new RegExp("^"+i+n+"[^aeiouwxy]$"),de=/^(.+?[^aeiou])y$/,oe=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,U=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,q=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,Le=/^(.+?)(s|t)(ion)$/,Y=/^(.+?)e$/,Ce=/ll$/,xe=new RegExp("^"+i+n+"[^aeiouwxy]$"),pe=function($){var Q,Z,I,_,O,V,fe;if($.length<3)return $;if(I=$.substr(0,1),I=="y"&&($=I.toUpperCase()+$.substr(1)),_=N,O=A,_.test($)?$=$.replace(_,"$1$2"):O.test($)&&($=$.replace(O,"$1$2")),_=R,O=J,_.test($)){var X=_.exec($);_=M,_.test(X[1])&&(_=s,$=$.replace(_,""))}else if(O.test($)){var X=O.exec($);Q=X[1],O=j,O.test(Q)&&($=Q,O=ae,V=ce,fe=ue,O.test($)?$=$+"e":V.test($)?(_=s,$=$.replace(_,"")):fe.test($)&&($=$+"e"))}if(_=de,_.test($)){var X=_.exec($);Q=X[1],$=Q+"i"}if(_=oe,_.test($)){var X=_.exec($);Q=X[1],Z=X[2],_=M,_.test(Q)&&($=Q+e[Z])}if(_=U,_.test($)){var X=_.exec($);Q=X[1],Z=X[2],_=M,_.test(Q)&&($=Q+r[Z])}if(_=q,O=Le,_.test($)){var X=_.exec($);Q=X[1],_=P,_.test(Q)&&($=Q)}else if(O.test($)){var X=O.exec($);Q=X[1]+X[2],O=P,O.test(Q)&&($=Q)}if(_=Y,_.test($)){var X=_.exec($);Q=X[1],_=P,O=F,V=xe,(_.test(Q)||O.test(Q)&&!V.test(Q))&&($=Q)}return _=Ce,O=P,_.test($)&&O.test($)&&(_=s,$=$.replace(_,"")),I=="y"&&($=I.toLowerCase()+$.substr(1)),$};return function(me){return me.update(pe)}}(),t.Pipeline.registerFunction(t.stemmer,"stemmer");/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
 ...
 * lunr.TokenSet
 * Copyright (C) 2020 Oliver Nightingale
 */t.TokenSet=function(){this.final=!1,this.edges={},this.id=t.TokenSet._nextId,t.TokenSet._nextId+=1},t.TokenSet._nextId=1,t.TokenSet.fromArray=function(e){for(var r=new t.TokenSet.Builder,o=0,n=e.length;o<n;o++)r.insert(e[o]);return r.finish(),r.root},t.TokenSet.fromClause=function(e){return"editDistance"in e?t.TokenSet.fromFuzzyString(e.term,e.editDistance):t.TokenSet.fromString(e.term)},t.TokenSet.fromFuzzyString=function(e,r){for(var o=new t.TokenSet,n=[{node:o,editsRemaining:r,str:e}];n.length;){var i=n.pop();if(i.str.length>0){var d=i.str.charAt(0),g;d in i.node.edges?g=i.node.edges[d]:(g=new t.TokenSet,i.node.edges[d]=g),i.str.length==1&&(g.final=!0),n.push({node:g,editsRemaining:i.editsRemaining,str:i.str.slice(1)})}if(i.editsRemaining!=0){if("*"in i.node.edges)var k=i.node.edges["*"];else{var k=new t.TokenSet;i.node.edges["*"]=k}if(i.str.length==0&&(k.final=!0),n.push({node:k,editsRemaining:i.editsRemaining-1,str:i.str}),i.str.length>1&&n.push({node:i.node,editsRemaining:i.editsRemaining-1,str:i.str.slice(1)}),i.str.length==1&&(i.node.final=!0),i.str.length>=1){if("*"in i.node.edges)var L=i.node.edges["*"];else{var L=new t.TokenSet;i.node.edges["*"]=L}i.str.length==1&&(L.final=!0),n.push({node:L,editsRemaining:i.editsRemaining-1,str:i.str.slice(1)})}if(i.str.length>1){var T=i.str.charAt(0),M=i.str.charAt(1),P;M in i.node.edges?P=i.node.edges[M]:(P=new t.TokenSet,i.node.edges[M]=P),i.str.length==1&&(P.final=!0),n.push({node:P,editsRemaining:i.editsRemaining-1,str:T+i.str.slice(2)})}}}return o},t.TokenSet.fromString=function(e){for(var r=new t.TokenSet,o=r,n=0,i=e.length;n<i;n++){var d=e[n],g=n==i-1;if(d=="*")r.edges[d]=r,r.final=g;else{var k=new t.TokenSet;k.final=g,r.edges[d]=k,r=k}}return o},t.TokenSet.prototype.toArray=function(){for(var e=[],r=[{prefix:"",node:this}];r.length;){var o=r.pop(),n=Object.keys(o.node.edges),i=n.length;o.node.final&&(o.prefix.charAt(0),e.push(o.prefix));for(var d=0;d<i;d++){var g=n[d];r.push({prefix:o.prefix.concat(g),node:o.node.edges[g]})}}return e},t.TokenSet.prototype.toString=function(){if(this._str)return this._str;for(var e=this.final?"1":"0",r=Object.keys(this.edges).sort(),o=r.length,n=0;n<o;n++){var i=r[n],d=this.edges[i];e=e+i+d.id}return e},t.TokenSet.prototype.intersect=function(e){for(var r=new t.TokenSet,o=void 0,n=[{qNode:e,output:r,node:this}];n.length;){o=n.pop();for(var i=Object.keys(o.qNode.edges),d=i.length,g=Object.keys(o.node.edges),k=g.length,L=0;L<d;L++)for(var T=i[L],M=0;M<k;M++){var P=g[M];if(P==T||T=="*"){var F=o.node.edges[P],j=o.qNode.edges[T],N=F.final&&j.final,A=void 0;P in o.output.edges?(A=o.output.edges[P],A.final=A.final||N):(A=new t.TokenSet,A.final=N,o.output.edges[P]=A),n.push({qNode:j,output:A,node:F})}}}return r},t.TokenSet.Builder=function(){this.previousWord="",this.root=new t.TokenSet,this.uncheckedNodes=[],this.minimizedNodes={}},t.TokenSet.Builder.prototype.insert=function(e){var r,o=0;if(e<this.previousWord)throw new Error("Out of order word insertion");for(var n=0;n<e.length&&n<this.previousWord.length&&e[n]==this.previousWord[n];n++)o++;this.minimize(o),this.uncheckedNodes.length==0?r=this.root:r=this.uncheckedNodes[this.uncheckedNodes.length-1].child;for(var n=o;n<e.length;n++){var i=new t.TokenSet,d=e[n];r.edges[d]=i,this.uncheckedNodes.push({parent:r,char:d,child:i}),r=i}r.final=!0,this.previousWord=e},t.TokenSet.Builder.prototype.finish=function(){this.minimize(0)},t.TokenSet.Builder.prototype.minimize=function(e){for(var r=this.uncheckedNodes.length-1;r>=e;r--){var o=this.uncheckedNodes[r],n=o.child.toString();n in this.minimizedNodes?o.parent.edges[o.char]=this.minimizedNodes[n]:(o.child._str=n,this.minimizedNodes[n]=o.child),this.uncheckedNodes.pop()}};/*!
 * lunr.Index
 * Copyright (C) 2020 Oliver Nightingale
 */t.Index=function(e){this.invertedIndex=e.invertedIndex,this.fieldVectors=e.fieldVectors,this.tokenSet=e.tokenSet,this.fields=e.fields,this.pipeline=e.pipeline},t.Index.prototype.search=function(e){return this.query(function(r){var o=new t.QueryParser(e,r);o.parse()})},t.Index.prototype.query=function(e){for(var r=new t.Query(this.fields),o=Object.create(null),n=Object.create(null),i=Object.create(null),d=Object.create(null),g=Object.create(null),k=0;k<this.fields.length;k++)n[this.fields[k]]=new t.Vector;e.call(r,r);for(var k=0;k<r.clauses.length;k++){var L=r.clauses[k],T=null,M=t.Set.empty;L.usePipeline?T=this.pipeline.runString(L.term,{fields:L.fields}):T=[L.term];for(var P=0;P<T.length;P++){var F=T[P];L.term=F;var j=t.TokenSet.fromClause(L),N=this.tokenSet.intersect(j).toArray();if(N.length===0&&L.presence===t.Query.presence.REQUIRED){for(var A=0;A<L.fields.length;A++){var R=L.fields[A];d[R]=t.Set.empty}break}for(var J=0;J<N.length;J++)for(var s=N[J],ae=this.invertedIndex[s],ce=ae._index,A=0;A<L.fields.length;A++){var R=L.fields[A],ue=ae[R],de=Object.keys(ue),oe=s+"/"+R,U=new t.Set(de);if(L.presence==t.Query.presence.REQUIRED&&(M=M.union(U),d[R]===void 0&&(d[R]=t.Set.complete)),L.presence==t.Query.presence.PROHIBITED){g[R]===void 0&&(g[R]=t.Set.empty),g[R]=g[R].union(U);continue}if(n[R].upsert(ce,L.boost,function(Ie,Pe){return Ie+Pe}),!i[oe]){for(var q=0;q<de.length;q++){var Le=de[q],Y=new t.FieldRef(Le,R),Ce=ue[Le],xe;(xe=o[Y])===void 0?o[Y]=new t.MatchData(s,R,Ce):xe.add(s,R,Ce)}i[oe]=!0}}}if(L.presence===t.Query.presence.REQUIRED)for(var A=0;A<L.fields.length;A++){var R=L.fields[A];d[R]=d[R].intersect(M)}}for(var pe=t.Set.complete,me=t.Set.empty,k=0;k<this.fields.length;k++){var R=this.fields[k];d[R]&&(pe=pe.intersect(d[R])),g[R]&&(me=me.union(g[R]))}var $=Object.keys(o),Q=[],Z=Object.create(null);if(r.isNegated()){$=Object.keys(this.fieldVectors);for(var k=0;k<$.length;k++){var Y=$[k],I=t.FieldRef.fromString(Y);o[Y]=new t.MatchData}}for(var k=0;k<$.length;k++){var I=t.FieldRef.fromString($[k]),_=I.docRef;if(pe.contains(_)&&!me.contains(_)){var O=this.fieldVectors[I],V=n[I.fieldName].similarity(O),fe;if((fe=Z[_])!==void 0)fe.score+=V,fe.matchData.combine(o[I]);else{var X={ref:_,score:V,matchData:o[I]};Z[_]=X,Q.push(X)}}}return Q.sort(function(ye,Ae){return Ae.score-ye.score})},t.Index.prototype.toJSON=function(){var e=Object.keys(this.invertedIndex).sort().map(function(o){return[o,this.invertedIndex[o]]},this),r=Object.keys(this.fieldVectors).map(function(o){return[o,this.fieldVectors[o].toJSON()]},this);return{version:t.version,fields:this.fields,fieldVectors:r,invertedIndex:e,pipeline:this.pipeline.toJSON()}},t.Index.load=function(e){var r={},o={},n=e.fieldVectors,i=Object.create(null),d=e.invertedIndex,g=new t.TokenSet.Builder,k=t.Pipeline.load(e.pipeline);e.version!=t.version&&t.utils.warn("Version mismatch when loading serialised index. Current version of lunr '"+t.version+"' does not match serialized index '"+e.version+"'");for(var L=0;L<n.length;L++){var T=n[L],M=T[0],P=T[1];o[M]=new t.Vector(P)}for(var L=0;L<d.length;L++){var T=d[L],F=T[0],j=T[1];g.insert(F),i[F]=j}return g.finish(),r.fields=e.fields,r.fieldVectors=o,r.invertedIndex=i,r.tokenSet=g.root,r.pipeline=k,new t.Index(r)};/*!
 * lunr.Builder
 * Copyright (C) 2020 Oliver Nightingale
 */t.Builder=function(){this._ref="id",this._fields=Object.create(null),this._documents=Object.create(null),this.invertedIndex=Object.create(null),this.fieldTermFrequencies={},this.fieldLengths={},this.tokenizer=t.tokenizer,this.pipeline=new t.Pipeline,this.searchPipeline=new t.Pipeline,this.documentCount=0,this._b=.75,this._k1=1.2,this.termIndex=0,this.metadataWhitelist=[]},t.Builder.prototype.ref=function(e){this._ref=e},t.Builder.prototype.field=function(e,r){if(/\//.test(e))throw new RangeError("Field '"+e+"' contains illegal character '/'");this._fields[e]=r||{}},t.Builder.prototype.b=function(e){e<0?this._b=0:e>1?this._b=1:this._b=e},t.Builder.prototype.k1=function(e){this._k1=e},t.Builder.prototype.add=function(e,r){var o=e[this._ref],n=Object.keys(this._fields);this._documents[o]=r||{},this.documentCount+=1;for(var i=0;i<n.length;i++){var d=n[i],g=this._fields[d].extractor,k=g?g(e):e[d],L=this.tokenizer(k,{fields:[d]}),T=this.pipeline.run(L),M=new t.FieldRef(o,d),P=Object.create(null);this.fieldTermFrequencies[M]=P,this.fieldLengths[M]=0,this.fieldLengths[M]+=T.length;for(var F=0;F<T.length;F++){var j=T[F];if(P[j]==null&&(P[j]=0),P[j]+=1,this.invertedIndex[j]==null){var N=Object.create(null);N._index=this.termIndex,this.termIndex+=1;for(var A=0;A<n.length;A++)N[n[A]]=Object.create(null);this.invertedIndex[j]=N}this.invertedIndex[j][d][o]==null&&(this.invertedIndex[j][d][o]=Object.create(null));for(var R=0;R<this.metadataWhitelist.length;R++){var J=this.metadataWhitelist[R],s=j.metadata[J];this.invertedIndex[j][d][o][J]==null&&(this.invertedIndex[j][d][o][J]=[]),this.invertedIndex[j][d][o][J].push(s)}}}},t.Builder.prototype.calculateAverageFieldLengths=function(){for(var e=Object.keys(this.fieldLengths),r=e.length,o={},n={},i=0;i<r;i++){var d=t.FieldRef.fromString(e[i]),g=d.fieldName;n[g]||(n[g]=0),n[g]+=1,o[g]||(o[g]=0),o[g]+=this.fieldLengths[d]}for(var k=Object.keys(this._fields),i=0;i<k.length;i++){var L=k[i];o[L]=o[L]/n[L]}this.averageFieldLength=o},t.Builder.prototype.createFieldVectors=function(){for(var e={},r=Object.keys(this.fieldTermFrequencies),o=r.length,n=Object.create(null),i=0;i<o;i++){for(var d=t.FieldRef.fromString(r[i]),g=d.fieldName,k=this.fieldLengths[d],L=new t.Vector,T=this.fieldTermFrequencies[d],M=Object.keys(T),P=M.length,F=this._fields[g].boost||1,j=this._documents[d.docRef].boost||1,N=0;N<P;N++){var A=M[N],R=T[A],J=this.invertedIndex[A]._index,s,ae,ce;n[A]===void 0?(s=t.idf(this.invertedIndex[A],this.documentCount),n[A]=s):s=n[A],ae=s*((this._k1+1)*R)/(this._k1*(1-this._b+this._b*(k/this.averageFieldLength[g]))+R),ae*=F,ae*=j,ce=Math.round(ae*1e3)/1e3,L.insert(J,ce)}e[d]=L}this.fieldVectors=e},t.Builder.prototype.createTokenSet=function(){this.tokenSet=t.TokenSet.fromArray(Object.keys(this.invertedIndex).sort())},t.Builder.prototype.build=function(){return this.calculateAverageFieldLengths(),this.createFieldVectors(),this.createTokenSet(),new t.Index({invertedIndex:this.invertedIndex,fieldVectors:this.fieldVectors,tokenSet:this.tokenSet,fields:Object.keys(this._fields),pipeline:this.searchPipeline})},t.Builder.prototype.use=function(e){var r=Array.prototype.slice.call(arguments,1);r.unshift(this),e.apply(this,r)},t.MatchData=function(e,r,o){for(var n=Object.create(null),i=Object.keys(o||{}),d=0;d<i.length;d++){var g=i[d];n[g]=o[g].slice()}this.metadata=Object.create(null),e!==void 0&&(this.metadata[e]=Object.create(null),this.metadata[e][r]=n)},t.MatchData.prototype.combine=function(e){for(var r=Object.keys(e.metadata),o=0;o<r.length;o++){var n=r[o],i=Object.keys(e.metadata[n]);this.metadata[n]==null&&(this.metadata[n]=Object.create(null));for(var d=0;d<i.length;d++){var g=i[d],k=Object.keys(e.metadata[n][g]);this.metadata[n][g]==null&&(this.metadata[n][g]=Object.create(null));for(var L=0;L<k.length;L++){var T=k[L];this.metadata[n][g][T]==null?this.metadata[n][g][T]=e.metadata[n][g][T]:this.metadata[n][g][T]=this.metadata[n][g][T].concat(e.metadata[n][g][T])}}}},t.MatchData.prototype.add=function(e,r,o){if(!(e in this.metadata)){this.metadata[e]=Object.create(null),this.metadata[e][r]=o;return}if(!(r in this.metadata[e])){this.metadata[e][r]=o;return}for(var n=Object.keys(o),i=0;i<n.length;i++){var d=n[i];d in this.metadata[e][r]?this.metadata[e][r][d]=this.metadata[e][r][d].concat(o[d]):this.metadata[e][r][d]=o[d]}},t.Query=function(e){this.clauses=[],this.allFields=e},t.Query.wildcard=new String("*"),t.Query.wildcard.NONE=0,t.Query.wildcard.LEADING=1,t.Query.wildcard.TRAILING=2,t.Query.presence={OPTIONAL:1,REQUIRED:2,PROHIBITED:3},t.Query.prototype.clause=function(e){return"fields"in e||(e.fields=this.allFields),"boost"in e||(e.boost=1),"usePipeline"in e||(e.usePipeline=!0),"wildcard"in e||(e.wildcard=t.Query.wildcard.NONE),e.wildcard&t.Query.wildcard.LEADING&&e.term.charAt(0)!=t.Query.wildcard&&(e.term="*"+e.term),e.wildcard&t.Query.wildcard.TRAILING&&e.term.slice(-1)!=t.Query.wildcard&&(e.term=""+e.term+"*"),"presence"in e||(e.presence=t.Query.presence.OPTIONAL),this.clauses.push(e),this},t.Query.prototype.isNegated=function(){for(var e=0;e<this.clauses.length;e++)if(this.clauses[e].presence!=t.Query.presence.PROHIBITED)return!1;return!0},t.Query.prototype.term=function(e,r){if(Array.isArray(e))return e.forEach(function(n){this.term(n,t.utils.clone(r))},this),this;var o=r||{};return o.term=e.toString(),this.clause(o),this},t.QueryParseError=function(e,r,o){this.name="QueryParseError",this.message=e,this.start=r,this.end=o},t.QueryParseError.prototype=new Error,t.QueryLexer=function(e){this.lexemes=[],this.str=e,this.length=e.length,this.pos=0,this.start=0,this.escapeCharPositions=[]},t.QueryLexer.prototype.run=function(){for(var e=t.QueryLexer.lexText;e;)e=e(this)},t.QueryLexer.prototype.sliceString=function(){for(var e=[],r=this.start,o=this.pos,n=0;n<this.escapeCharPositions.length;n++)o=this.escapeCharPositions[n],e.push(this.str.slice(r,o)),r=o+1;return e.push(this.str.slice(r,this.pos)),this.escapeCharPositions.length=0,e.join("")},t.QueryLexer.prototype.emit=function(e){this.lexemes.push({type:e,str:this.sliceString(),start:this.start,end:this.pos}),this.start=this.pos},t.QueryLexer.prototype.escapeCharacter=function(){this.escapeCharPositions.push(this.pos-1),this.pos+=1},t.QueryLexer.prototype.next=function(){if(this.pos>=this.length)return t.QueryLexer.EOS;var e=this.str.charAt(this.pos);return this.pos+=1,e},t.QueryLexer.prototype.width=function(){return this.pos-this.start},t.QueryLexer.prototype.ignore=function(){this.start==this.pos&&(this.pos+=1),this.start=this.pos},t.QueryLexer.prototype.backup=function(){this.pos-=1},t.QueryLexer.prototype.acceptDigitRun=function(){var e,r;do e=this.next(),r=e.charCodeAt(0);while(r>47&&r<58);e!=t.QueryLexer.EOS&&this.backup()},t.QueryLexer.prototype.more=function(){return this.pos<this.length},t.QueryLexer.EOS="EOS",t.QueryLexer.FIELD="FIELD",t.QueryLexer.TERM="TERM",t.QueryLexer.EDIT_DISTANCE="EDIT_DISTANCE",t.QueryLexer.BOOST="BOOST",t.QueryLexer.PRESENCE="PRESENCE",t.QueryLexer.lexField=function(e){return e.backup(),e.emit(t.QueryLexer.FIELD),e.ignore(),t.QueryLexer.lexText},t.QueryLexer.lexTerm=function(e){if(e.width()>1&&(e.backup(),e.emit(t.QueryLexer.TERM)),e.ignore(),e.more())return t.QueryLexer.lexText},t.QueryLexer.lexEditDistance=function(e){return e.ignore(),e.acceptDigitRun(),e.emit(t.QueryLexer.EDIT_DISTANCE),t.QueryLexer.lexText},t.QueryLexer.lexBoost=function(e){return e.ignore(),e.acceptDigitRun(),e.emit(t.QueryLexer.BOOST),t.QueryLexer.lexText},t.QueryLexer.lexEOS=function(e){e.width()>0&&e.emit(t.QueryLexer.TERM)},t.QueryLexer.termSeparator=t.tokenizer.separator,t.QueryLexer.lexText=function(e){for(;;){var r=e.next();if(r==t.QueryLexer.EOS)return t.QueryLexer.lexEOS;if(r.charCodeAt(0)==92){e.escapeCharacter();continue}if(r==":")return t.QueryLexer.lexField;if(r=="~")return e.backup(),e.width()>0&&e.emit(t.QueryLexer.TERM),t.QueryLexer.lexEditDistance;if(r=="^")return e.backup(),e.width()>0&&e.emit(t.QueryLexer.TERM),t.QueryLexer.lexBoost;if(r=="+"&&e.width()===1||r=="-"&&e.width()===1)return e.emit(t.QueryLexer.PRESENCE),t.QueryLexer.lexText;if(r.match(t.QueryLexer.termSeparator))return t.QueryLexer.lexTerm}},t.QueryParser=function(e,r){this.lexer=new t.QueryLexer(e),this.query=r,this.currentClause={},this.lexemeIdx=0},t.QueryParser.prototype.parse=function(){this.lexer.run(),this.lexemes=this.lexer.lexemes;for(var e=t.QueryParser.parseClause;e;)e=e(this);return this.query},t.QueryParser.prototype.peekLexeme=function(){return this.lexemes[this.lexemeIdx]},t.QueryParser.prototype.consumeLexeme=function(){var e=this.peekLexeme();return this.lexemeIdx+=1,e},t.QueryParser.prototype.nextClause=function(){var e=this.currentClause;this.query.clause(e),this.currentClause={}},t.QueryParser.parseClause=function(e){var r=e.peekLexeme();if(r!=null)switch(r.type){case t.QueryLexer.PRESENCE:return t.QueryParser.parsePresence;case t.QueryLexer.FIELD:return t.QueryParser.parseField;case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var o="expected either a field or a term, found "+r.type;throw r.str.length>=1&&(o+=" with value '"+r.str+"'"),new t.QueryParseError(o,r.start,r.end)}},t.QueryParser.parsePresence=function(e){var r=e.consumeLexeme();if(r!=null){switch(r.str){case"-":e.currentClause.presence=t.Query.presence.PROHIBITED;break;case"+":e.currentClause.presence=t.Query.presence.REQUIRED;break;default:var o="unrecognised presence operator'"+r.str+"'";throw new t.QueryParseError(o,r.start,r.end)}var n=e.peekLexeme();if(n==null){var o="expecting term or field, found nothing";throw new t.QueryParseError(o,r.start,r.end)}switch(n.type){case t.QueryLexer.FIELD:return t.QueryParser.parseField;case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var o="expecting term or field, found '"+n.type+"'";throw new t.QueryParseError(o,n.start,n.end)}}},t.QueryParser.parseField=function(e){var r=e.consumeLexeme();if(r!=null){if(e.query.allFields.indexOf(r.str)==-1){var o=e.query.allFields.map(function(d){return"'"+d+"'"}).join(", "),n="unrecognised field '"+r.str+"', possible fields: "+o;throw new t.QueryParseError(n,r.start,r.end)}e.currentClause.fields=[r.str];var i=e.peekLexeme();if(i==null){var n="expecting term, found nothing";throw new t.QueryParseError(n,r.start,r.end)}switch(i.type){case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var n="expecting term, found '"+i.type+"'";throw new t.QueryParseError(n,i.start,i.end)}}},t.QueryParser.parseTerm=function(e){var r=e.consumeLexeme();if(r!=null){e.currentClause.term=r.str.toLowerCase(),r.str.indexOf("*")!=-1&&(e.currentClause.usePipeline=!1);var o=e.peekLexeme();if(o==null){e.nextClause();return}switch(o.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var n="Unexpected lexeme type '"+o.type+"'";throw new t.QueryParseError(n,o.start,o.end)}}},t.QueryParser.parseEditDistance=function(e){var r=e.consumeLexeme();if(r!=null){var o=parseInt(r.str,10);if(isNaN(o)){var n="edit distance must be numeric";throw new t.QueryParseError(n,r.start,r.end)}e.currentClause.editDistance=o;var i=e.peekLexeme();if(i==null){e.nextClause();return}switch(i.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var n="Unexpected lexeme type '"+i.type+"'";throw new t.QueryParseError(n,i.start,i.end)}}},t.QueryParser.parseBoost=function(e){var r=e.consumeLexeme();if(r!=null){var o=parseInt(r.str,10);if(isNaN(o)){var n="boost must be numeric";throw new t.QueryParseError(n,r.start,r.end)}e.currentClause.boost=o;var i=e.peekLexeme();if(i==null){e.nextClause();return}switch(i.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var n="Unexpected lexeme type '"+i.type+"'";throw new t.QueryParseError(n,i.start,i.end)}}},function(e,r){u.exports=r()}(this,function(){return t})})()})(zt);var rr=zt.exports;const qe=mt(rr);var Ft={exports:{}};/*!
...
.dark-mode .atema-nav-btn.active .atema-nav-label { color: #f5f5f5; }
            ...
            ${u.atributos.map(f=>`
                <div class="atema-attr">
                    <div class="atema-attr-head">
                        <span style="color:${u.color}">${Mt[f.tipo]||Mt.gov}</span>
    ...
    `).join("");return`
        ...
        </div>`,e.classList.remove("hidden"),setTimeout(()=>e.scrollIntoView({behavior:"smooth",block:"nearest"}),50),(i=e.querySelector(`[data-close-panel="${f.id}"]`))==null||i.addEventListener("click",()=>{e.classList.add("hidden"),e.dataset.activeNode="",u.querySelectorAll(".aflujo-node").forEach(d=>{d.classList.remove("anode-active"),d.style.boxShadow=""})}),qt(e,f)}function qt(u,f){u.querySelectorAll("[data-open-article]").forEach(t=>{t.addEventListener("click",()=>{const e=f.articulosClave.map(r=>r.id);document.dispatchEvent(new CustomEvent("analisis:openArticle",{detail:{id:t.dataset.openArticle,list:e}}))})})}function pt(u){u.querySelectorAll(".achart-bar").forEach(f=>{const t=f.dataset.target;t&&setTimeout(()=>{f.style.width=t+"%"},60)})}function Cr(u,f){u.querySelectorAll(".atema-tab").forEach(e=>{e.addEventListener("click",()=>{u.querySelectorAll(".atema-tab").forEach(o=>o.classList.remove("active")),e.classList.add("active");const r=e.dataset.target;u.querySelectorAll(".atema-tab-panel").forEach(o=>{o.classList.toggle("hidden",o.id!==r)}),r!=null&&r.includes("menciones")&&pt(u)})}),u.querySelectorAll(".aflujo-node").forEach(e=>{e.addEventListener("click",()=>{const r=e.dataset.nodeId,o=f.cadena.find(i=>i.nodos.some(d=>d.id===r)),n=o==null?void 0:o.nodos.find(i=>i.id===r);n&&Lr(u,f,n)})}),qt(u,f);const t=u.querySelector(`#chart-${f.id}`);if(t&&"IntersectionObserver"in window){const e=new IntersectionObserver(r=>{r[0].isIntersecting&&(pt(u),e.disconnect())},{threshold:.2});e.observe(t)}}function Sr(u){var o;gr();const f=`
    ...
    `).join("");u.innerHTML=`
        <div style="max-width:800px;margin:0 auto;padding-bottom:3rem">
            ...
            ${f}
            ${t}
        </div>`,(o=u.querySelector("#analisis-back-btn"))==null||o.addEventListener("click",()=>{document.dispatchEvent(new CustomEvent("analisis:goHome"))});const e=u.querySelectorAll(".atema-nav-btn"),r=u.querySelectorAll(".atema-card-wrapper");e.forEach(n=>{n.addEventListener("click",()=>{e.forEach(g=>g.classList.remove("active")),n.classList.add("active");const i=n.dataset.temaId;r.forEach(g=>{g.classList.toggle("hidden",g.id!=="wrapper-"+i)});const d=u.querySelector("#wrapper-"+i);d&&pt(d)})}),ut.forEach(n=>Cr(u,n))}function $r(){var Ct,St,$t,_t,Bt;const u=document.getElementById("search-input"),f=document.getElementById("results-container"),t=document.getElementById("law-detail-container"),e=document.getElementById("stats-minimal"),r=document.getElementById("hero-section"),o=document.getElementById("main-container"),n=document.getElementById("quick-filters"),i=document.getElementById("detail-modal"),d=document.getElementById("modal-panel"),g=document.getElementById("modal-content"),k=document.getElementById("modal-title"),L=document.getElementById("modal-ley"),T=document.getElementById("close-modal"),M=document.getElementById("copy-btn"),P=document.getElementById("loading-indicator"),F=document.getElementById("nav-inicio"),j=document.getElementById("nav-leyes"),N=document.getElementById("mobile-menu-btn"),A=document.getElementById("mobile-menu-overlay"),R=document.getElementById("mobile-menu-drawer"),J=document.getElementById("close-mobile-menu"),s=document.getElementById("mobile-nav-inicio"),ae=document.getElementById("mobile-nav-leyes"),ce="app-dark-mode";let ue=localStorage.getItem(ce)==="true";function de(a){if(ue=a,localStorage.setItem(ce,a),document.documentElement.classList.toggle("dark-mode",a),!document.getElementById("global-dark-style")){const p=document.createElement("style");p.id="global-dark-style",p.innerHTML=`
            ...
            `,document.head.appendChild(p)}const l=document.querySelectorAll("#darkmode-icon-moon, #mobile-darkmode-moon"),c=document.querySelectorAll("#darkmode-icon-sun, #mobile-darkmode-sun"),m=document.getElementById("mobile-darkmode-label");l.forEach(p=>p.classList.toggle("hidden",a)),c.forEach(p=>p.classList.toggle("hidden",!a)),m&&(m.textContent=a?"Modo claro":"Modo oscuro")}ue&&de(!0),(Ct=document.getElementById("darkmode-toggle"))==null||Ct.addEventListener("click",()=>de(!ue)),(St=document.getElementById("mobile-darkmode-toggle"))==null||St.addEventListener("click",()=>de(!ue));function oe(a){!R||!A||(a?(A.classList.remove("hidden"),A.offsetWidth,A.classList.remove("opacity-0"),R.classList.remove("translate-x-full"),document.body.style.overflow="hidden"):(A.classList.add("opacity-0"),R.classList.add("translate-x-full"),document.body.style.overflow="",setTimeout(()=>{A.classList.add("hidden")},300)))}N&&N.addEventListener("click",()=>oe(!0)),J&&J.addEventListener("click",()=>oe(!1)),A&&A.addEventListener("click",()=>oe(!1)),s&&s.addEventListener("click",a=>{a.preventDefault(),Ie(),oe(!1)}),ae&&ae.addEventListener("click",a=>{a.preventDefault(),Pe(),oe(!1)});let U=[],q=[];window.addEventListener("search-ready",a=>{const{totalLeyes:l,totalArticulos:c,summaries:m}=a.detail;U=m,e&&(e.innerHTML=`
            ...
            `),bt(),setTimeout(Q,0)});const Le=document.getElementById("nav-favorites"),Y=document.getElementById("mobile-nav-favorites");Le&&Le.addEventListener("click",()=>xt()),Y&&Y.addEventListener("click",()=>{xt(),oe(!1)});const Ce=document.getElementById("nav-analisis"),xe=document.getElementById("mobile-nav-analisis");Ce&&Ce.addEventListener("click",a=>{a.preventDefault(),Lt()}),xe&&xe.addEventListener("click",a=>{a.preventDefault(),Lt(),oe(!1)});const pe=document.getElementById("nav-stats"),me=document.getElementById("mobile-nav-stats");pe&&pe.addEventListener("click",a=>{a.preventDefault(),kt()}),me&&me.addEventListener("click",a=>{a.preventDefault(),kt(),oe(!1)}),document.addEventListener("analisis:openArticle",a=>{const{id:l,list:c}=a.detail;c&&c.length&&(ke=c.map(m=>je(m)).filter(Boolean)),ge(l)}),document.addEventListener("analisis:goHome",()=>Ie()),($t=document.getElementById("close-compare-modal"))==null||$t.addEventListener("click",tt),(_t=document.getElementById("compare-modal"))==null||_t.addEventListener("click",a=>{a.target===document.getElementById("compare-modal")&&tt()});function $(a){history.pushState(null,"",a?`${location.pathname}${a}`:location.pathname)}function Q(){const a=location.hash;if(a){if(a.startsWith("#art-")){const l=decodeURIComponent(a.slice(5)),c=je(l);if(!c)return;ke=[c],ge(l)}else if(a.startsWith("#ley-")){const l=decodeURIComponent(a.slice(5)),c=U.find(m=>m.id===l);c&&Me(c)}}}window.addEventListener("popstate",()=>{const a=location.hash;if(!a)Ie();else if(a.startsWith("#art-")){const l=decodeURIComponent(a.slice(5)),c=je(l);if(!c)return;ke=[c],ge(l)}else if(a.startsWith("#ley-")){const l=decodeURIComponent(a.slice(5)),c=U.find(m=>m.id===l);c&&Me(c)}});function Z(a,l="✓",c="bg-gray-900"){const m=document.getElementById("app-toast");m&&m.remove();const p=document.createElement("div");p.id="app-toast",p.className=`fixed bottom-24 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-2 px-5 py-3 ${c} text-white text-xs font-semibold rounded-full shadow-2xl transition-all duration-300 opacity-0 scale-90 pointer-events-none`,p.innerHTML=`<span>${l}</span><span>${a}</span>`,document.body.appendChild(p),requestAnimationFrame(()=>{p.classList.replace("opacity-0","opacity-100"),p.classList.replace("scale-90","scale-100")}),setTimeout(()=>{p.classList.replace("opacity-100","opacity-0"),p.classList.replace("scale-100","scale-90"),setTimeout(()=>p.remove(),300)},2500)}function I(a=5){f.innerHTML=Array(a).fill("").map(()=>`
        ...
        `}function Me(a){var ve,nt,It,Tt,jt,At,Pt;if(!t)return;ye(),ft(),q=mr(a.titulo);const l=[...new Set(q.map(S=>S.capitulo_nombre).filter(Boolean))];[...new Set(q.map(S=>S.titulo_nombre).filter(Boolean))];const c=q.filter(S=>S.articulo_label.toLowerCase().includes("transitorio")).length;f.classList.add("hidden"),r.classList.add("hidden"),n.classList.add("hidden"),e.classList.add("hidden"),(ve=document.getElementById("analisis-container"))==null||ve.classList.add("hidden","opacity-0"),t.classList.remove("hidden"),setTimeout(()=>t.classList.remove("opacity-0"),50),$(`#ley-${encodeURIComponent(a.id)}`);let m=100,p=localStorage.getItem("reader-theme")||"light";t.innerHTML=`
...
`)[0]}</div>`:""}
        ...
        `,document.body.appendChild(h);const x=h.querySelector("#toc-tab-grid"),E=h.querySelector("#toc-tab-list"),y=h.querySelector("#toc-content-grid"),C=h.querySelector("#toc-content-list"),B=h.querySelector("#toc-search"),H=["bg-guinda","text-white","shadow-sm"],G=["text-gray-500","hover:text-guinda","hover:bg-guinda/5"];x.addEventListener("click",()=>{x.classList.add(...H),x.classList.remove(...G),E.classList.remove(...H),E.classList.add(...G),y.classList.remove("hidden"),C.classList.add("hidden"),B&&(B.value=""),y.querySelectorAll(".toc-art-btn").forEach(S=>S.style.display="")}),E.addEventListener("click",()=>{E.classList.add(...H),E.classList.remove(...G),x.classList.remove(...H),x.classList.add(...G),C.classList.remove("hidden"),y.classList.add("hidden"),B&&(B.value=""),C.querySelectorAll(".toc-art-btn").forEach(S=>S.style.display="")}),B&&(B.addEventListener("input",S=>{const z=S.target.value.toLowerCase().trim();(C.classList.contains("hidden")?y:C).querySelectorAll(".toc-art-btn").forEach(te=>{var it;const ze=!z||((it=te.title)==null?void 0:it.toLowerCase().includes(z))||te.textContent.toLowerCase().includes(z);te.style.display=ze?"":"none"})}),B.addEventListener("click",S=>S.stopPropagation()));let ee=!1;const Se=S=>{ee=S,S?(h.classList.remove("translate-y-full"),document.body.style.overflow="hidden"):(h.classList.add("translate-y-full"),document.body.style.overflow="")};w.addEventListener("click",()=>Se(!ee)),(nt=h.querySelector("#toc-close-btn"))==null||nt.addEventListener("click",()=>Se(!1)),h.querySelectorAll(".toc-art-btn").forEach(S=>{S.addEventListener("click",()=>{Se(!1),ge(S.dataset.id)})}),Fe(q.slice(0,20),""),setTimeout(()=>{gt(q)},100);const he=document.getElementById("law-articles-list"),$e=document.getElementById("btn-font-increase"),_e=document.getElementById("btn-font-decrease"),be=document.getElementById("font-size-display"),De=document.querySelectorAll(".theme-btn");document.getElementById("law-header-area");const Ge=S=>{if(p=S,localStorage.setItem("reader-theme",S),document.body.className=`bg-${S} text-gray-900 font-body min-h-screen flex flex-col antialiased transition-colors duration-300`,De.forEach(z=>{z.classList.remove("ring-2","ring-guinda","ring-offset-1"),z.dataset.theme===S&&z.classList.add("ring-2","ring-guinda","ring-offset-1")}),document.querySelectorAll(".mob-theme-btn").forEach(z=>{z.classList.remove("border-guinda","text-guinda"),z.classList.add("border-transparent"),z.dataset.theme===S&&(z.classList.remove("border-transparent"),z.classList.add("border-guinda"),S!=="dark"&&z.classList.add("text-guinda"))}),!document.getElementById("reader-themes-style")){const z=document.createElement("style");z.id="reader-themes-style",z.innerHTML=`
                ...
                `,document.head.appendChild(z)}};Ge(p);const Be=()=>{he&&(he.style.fontSize=`${m}%`),document.querySelectorAll("#font-size-display, #mob-font-display").forEach(S=>{S.innerText=`${m}%`})};$e&&$e.addEventListener("click",()=>{m<250&&(m+=10,Be())}),_e&&_e.addEventListener("click",()=>{m>80&&(m-=10,Be())}),be&&(be.addEventListener("click",()=>{m=100,Be()}),be.style.cursor="pointer",be.title="Restablecer al 100%"),De.forEach(S=>{S.addEventListener("click",z=>{Ge(z.target.dataset.theme)})});const D=document.getElementById("mobile-reading-toggle"),se=document.getElementById("mobile-reading-sheet"),le=document.getElementById("mobile-reading-overlay"),Je=S=>{se==null||se.classList.toggle("translate-y-full",!S),le==null||le.classList.toggle("hidden",!S)};D==null||D.addEventListener("click",()=>Je(!0)),le==null||le.addEventListener("click",()=>Je(!1)),(It=document.getElementById("mob-font-decrease"))==null||It.addEventListener("click",()=>{m>80&&(m-=10,Be())}),(Tt=document.getElementById("mob-font-increase"))==null||Tt.addEventListener("click",()=>{m<250&&(m+=10,Be())}),document.querySelectorAll(".mob-theme-btn").forEach(S=>{S.addEventListener("click",()=>{Ge(S.dataset.theme),Je(!1)})});const Qe=document.getElementById("law-share-btn"),re=document.getElementById("law-share-menu");document.getElementById("law-share-text-btn"),document.getElementById("law-share-link-btn"),Qe&&re&&(Qe.addEventListener("click",S=>{S.stopPropagation(),re.classList.toggle("hidden")}),document.addEventListener("click",function S(z){z.target.closest("#law-share-wrapper")||(re.classList.add("hidden"),document.removeEventListener("click",S))})),Object.entries({"law-share-whatsapp-btn":()=>Ue(a,"whatsapp"),"law-share-telegram-btn":()=>Ue(a,"telegram"),"law-share-twitter-btn":()=>Ue(a,"twitter"),"law-share-email-btn":()=>Ue(a,"email"),"law-share-link-btn":()=>{const S=`${location.origin}${location.pathname}#ley-${encodeURIComponent(a.id)}`;navigator.clipboard.writeText(S).then(()=>Z("¡Enlace copiado!","🔗","bg-blue-600"))}}).forEach(([S,z])=>{var ne;(ne=document.getElementById(S))==null||ne.addEventListener("click",()=>{re==null||re.classList.add("hidden"),z()})}),(jt=document.getElementById("print-btn"))==null||jt.addEventListener("click",()=>window.print()),(At=document.getElementById("crumb-inicio"))==null||At.addEventListener("click",()=>Ie()),(Pt=document.getElementById("crumb-categoria"))==null||Pt.addEventListener("click",()=>Pe()),document.querySelectorAll(".theme-filter-btn").forEach(S=>{S.addEventListener("click",z=>{const ne=z.target.dataset.theme,te=document.getElementById("law-search-input");te&&(te.value=ne,te.dispatchEvent(new Event("input")))})}),document.getElementById("law-search-input").addEventListener("input",S=>{const z=S.target.value.toLowerCase().trim();let ne=q;z.length>2&&(ne=q.filter(te=>te.texto.toLowerCase().includes(z)||te.articulo_label.toLowerCase().includes(z)||te.titulo_nombre&&te.titulo_nombre.toLowerCase().includes(z)||te.capitulo_nombre&&te.capitulo_nombre.toLowerCase().includes(z))),Fe(ne.slice(0,50),z)}),document.getElementById("export-csv-btn").addEventListener("click",()=>{Wt(q,`${a.titulo}.csv`)})}function gt(a){const l=document.getElementById("law-structure-chart");if(!l)return;if(!window.d3){l.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">Cargando visualización...</div>',setTimeout(()=>gt(a),1e3);return}if(l.innerHTML="",!a||a.length===0){l.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">No hay datos para visualizar</div>';return}const c={};a.forEach(C=>{let B=C.titulo_nombre||C.capitulo_nombre||"General";B=B.replace(/^TÍTULO\s+/i,"").replace(/^CAPÍTULO\s+/i,""),B=B.replace(/^[IVXLCDM]+\.?\s*-?\s*/,""),B=B.replace(/^(PRIMERO|SEGUNDO|TERCERO|CUARTO|QUINTO|SEXTO|SÉPTIMO|OCTAVO|NOVENO|DÉCIMO)\.?\s*-?\s*/i,""),B=B.trim(),B||(B="General"),B.length>25&&(B=B.substring(0,25)+"..."),c[B]=(c[B]||0)+1});const m=Object.entries(c).map(([C,B])=>({name:C,value:B})).sort((C,B)=>B.value-C.value).slice(0,5);if(m.length===0){l.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">Datos insuficientes</div>';return}const p={top:10,right:30,bottom:20,left:220},w=l.clientWidth,b=Math.max(l.clientHeight,m.length*35+p.top+p.bottom);d3.select(l).select("svg").remove();const h=d3.select(l).append("svg").attr("width","100%").attr("height",b).attr("viewBox",[0,0,w,b]).attr("style","max-width: 100%; height: auto; font: 11px sans-serif;"),x=d3.scaleLinear().domain([0,d3.max(m,C=>C.value)]).range([p.left,w-p.right]),E=d3.scaleBand().domain(m.map(C=>C.name)).rangeRound([p.top,b-p.bottom]).padding(.3);d3.selectAll(".d3-tooltip").remove();const y=d3.select("body").append("div").attr("class","d3-tooltip absolute bg-gray-900/90 backdrop-blur text-white text-[10px] rounded-lg py-1.5 px-3 pointer-events-none opacity-0 transition-opacity z-50 shadow-xl border border-gray-700").style("display","none");h.append("g").attr("fill","#9B2247").selectAll("rect").data(m).join("rect").attr("x",x(0)).attr("y",C=>E(C.name)).attr("width",C=>Math.max(0,x(C.value)-x(0))).attr("height",E.bandwidth()).attr("rx",4).on("mouseover",(C,B)=>{d3.select(C.target).attr("fill","#7A1C39"),y.style("opacity","1").style("display","block").text(`${B.name}: ${B.value} artículos`)}).on("mousemove",C=>{y.style("left",C.pageX+10+"px").style("top",C.pageY-10+"px")}).on("mouseout",C=>{d3.select(C.target).attr("fill","#9B2247"),y.style("opacity","0").style("display","none")}),h.append("g").attr("fill","black").attr("text-anchor","start").attr("font-size","10px").selectAll("text").data(m).join("text").attr("x",C=>x(C.value)+4).attr("y",C=>E(C.name)+E.bandwidth()/2).attr("dy","0.35em").text(C=>C.value),h.append("g").call(d3.axisLeft(E).tickSize(0)).attr("transform",`translate(${p.left},0)`).call(C=>C.select(".domain").remove()).call(C=>C.selectAll("text").attr("fill","#4B5563").attr("font-weight","500").style("text-anchor","end").attr("dx","-6"))}function Fe(a,l){const c=document.getElementById("law-articles-list");if(c){if(a.length===0){c.innerHTML='<div class="text-center py-8 text-gray-400 text-sm">No se encontraron artículos que coincidan con la búsqueda.</div>';return}ke=a,c.innerHTML=a.map(m=>{const p=l?Ve(m.texto,l):m.texto.substring(0,300)+"...",w=!!Ne(m.id),v=Oe(m.id)?'<svg class="w-3.5 h-3.5 text-guinda" fill="currentColor" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>':'<svg class="w-3.5 h-3.5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>',b=ie.includes(m.id),h=b?"text-guinda":ie.length>=2?"text-gray-100":"text-gray-300 hover:text-guinda",x=b?"bg-guinda/10":"";return`
...
`),w=new Blob([p],{type:"text/csv;charset=utf-8;"}),v=document.createElement("a");if(v.download!==void 0){const b=URL.createObjectURL(w);v.setAttribute("href",b),v.setAttribute("download",l),v.style.visibility="hidden",document.body.appendChild(v),v.click(),document.body.removeChild(v)}}function Gt(a){const l=Ke().filter(c=>c!==a);l.unshift(a),localStorage.setItem("search-history",JSON.stringify(l.slice(0,10)))}function Ke(){return JSON.parse(localStorage.getItem("search-history")||"[]")}n&&n.addEventListener("click",a=>{a.target.tagName==="BUTTON"&&(u.value=a.target.textContent,u.dispatchEvent(new Event("input")))});function Re(a){return a.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function ht(a,l){const c=Re(a),m=Re(l),p=c.indexOf(m);return p===-1?we(a):we(a.slice(0,p))+`<mark class="bg-guinda/10 text-guinda font-semibold not-italic">${we(a.slice(p,p+l.length))}</mark>`+we(a.slice(p+l.length))}function we(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}if(u){let c=function(){return Array.from(a.querySelectorAll("[data-navigable]"))},m=function(b){const h=c();h.forEach((x,E)=>{x.classList.toggle("bg-gray-50",E===b),x.setAttribute("aria-selected",E===b?"true":"false")}),l=b,h[b]&&h[b].scrollIntoView({block:"nearest"})},p=function(){a.classList.add("hidden"),l=-1},w=function(b){var x;l=-1;const h=[];if(b){const E=U.filter(H=>Re(H.titulo).includes(Re(b))).slice(0,4);E.length>0&&h.push({label:"Leyes",items:E.map(H=>({html:`
                                ...
                                <span class="text-sm text-gray-700 font-medium truncate">${ht(H.titulo,b)}</span>`,attrs:`data-navigable data-law-title="${we(H.titulo)}" class="px-4 py-3 hover:bg-gray-50 cursor-pointer flex items-center gap-3 transition-colors suggestion-law"`}))});const y=fr(),C=Re(b),B=[];for(const H of y){if(B.length>=4)break;const G=H.articulo_label||"",ee=H.titulo_nombre||"",Se=H.capitulo_nombre||"",he=[G,ee,Se].find($e=>$e&&Re($e).includes(C));he&&B.push({art:H,matchField:he})}B.length>0&&h.push({label:"Artículos",items:B.map(({art:H,matchField:G})=>({html:`
                            ...
                            <button class="remove-history-item text-gray-200 hover:text-gray-500 transition-colors text-base leading-none flex-shrink-0" data-query="${we(y)}">×</button>`,attrs:`data-navigable data-query="${we(y)}" class="px-4 py-3 hover:bg-gray-50 cursor-pointer flex items-center gap-3 transition-colors history-item"`}))})}if(h.length===0){p();return}a.innerHTML=h.map(E=>`
            ...
            `).join(""),a.classList.remove("hidden"),(x=document.getElementById("clear-all-history"))==null||x.addEventListener("click",E=>{E.stopPropagation(),localStorage.removeItem("search-history"),p()}),a.querySelectorAll(".history-item").forEach(E=>{E.addEventListener("click",y=>{if(y.target.classList.contains("remove-history-item")){y.stopPropagation();const C=y.target.dataset.query,B=Ke().filter(H=>H!==C);localStorage.setItem("search-history",JSON.stringify(B)),E.remove(),a.querySelectorAll(".history-item").length===0&&p();return}u.value=E.dataset.query,u.dispatchEvent(new Event("input")),p()})}),a.querySelectorAll(".suggestion-law").forEach(E=>{E.addEventListener("click",()=>{const y=E.dataset.lawTitle,C=U.find(B=>B.titulo===y);C&&(Me(C),p(),u.value="")})}),a.querySelectorAll(".suggestion-article").forEach(E=>{E.addEventListener("click",()=>{const y=E.dataset.articleId;y&&(ge(y),p(),u.value="")})})};var _r=c,Br=m,Ir=p,Tr=w;const a=document.createElement("div");a.id="autocomplete-results",a.className="absolute w-full bg-white border border-gray-100 rounded-2xl shadow-xl mt-2 hidden z-50 overflow-hidden max-h-96 overflow-y-auto",u.parentNode.appendChild(a);let l=-1;document.addEventListener("click",b=>{!u.contains(b.target)&&!a.contains(b.target)&&p()}),u.addEventListener("keydown",b=>{var x;if(a.classList.contains("hidden"))return;const h=c();b.key==="ArrowDown"?(b.preventDefault(),m(Math.min(l+1,h.length-1))):b.key==="ArrowUp"?(b.preventDefault(),m(Math.max(l-1,-1)),l===-1&&h.forEach(E=>E.classList.remove("bg-gray-50"))):b.key==="Enter"&&l>=0?(b.preventDefault(),(x=h[l])==null||x.click()):b.key==="Escape"&&p()}),u.addEventListener("focus",()=>{u.value.trim().length>0||w("")}),u.addEventListener("click",b=>{b.stopPropagation(),u.value.trim()||w("")});let v=null;u.addEventListener("input",b=>{var x,E;const h=b.target.value.trim();h.length>2?(ye(),t&&t.classList.add("hidden","opacity-0"),r.classList.add("hidden"),r.classList.remove("block"),n.classList.add("hidden"),e.classList.add("hidden"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),f.classList.remove("hidden"),setTimeout(()=>f.classList.remove("opacity-0"),50),P&&P.classList.remove("hidden"),I(),w(h),clearTimeout(v),v=setTimeout(()=>{O=pr(h),_=h,V=1,W={type:"all",law:"all",artNum:""},Gt(h),Te(),P&&P.classList.add("hidden")},250)):h.length===0&&(ye(),t&&t.classList.add("hidden","opacity-0"),r.classList.remove("hidden"),n.classList.remove("hidden"),e.classList.remove("hidden"),o.classList.add("justify-center","pt-24"),o.classList.remove("pt-8"),f.classList.add("hidden","opacity-0"),f.innerHTML="",(x=document.querySelector(".pagination-nav"))==null||x.remove(),(E=document.getElementById("search-filters"))==null||E.remove(),V=1,O=[],_="",w(""))})}let W={type:"all",law:"all",artNum:""},ke=[],ie=[];function He(){return JSON.parse(localStorage.getItem("article-favorites")||"[]")}function Oe(a){return He().includes(a)}function Ze(a){const l=He(),c=l.indexOf(a);c>=0?l.splice(c,1):l.unshift(a),localStorage.setItem("article-favorites",JSON.stringify(l)),bt()}function bt(){const a=He().length,l=Object.keys(et()).length;document.querySelectorAll("#nav-favorites, #mobile-nav-favorites").forEach(c=>{c&&(c.classList.toggle("hidden",a===0&&l===0),c.querySelectorAll(".fav-count").forEach(m=>m.textContent=a))})}function et(){return JSON.parse(localStorage.getItem("article-notes")||"{}")}function Ne(a){return et()[a]||""}function vt(a,l){const c=et();l.trim()?c[a]=l.trim():delete c[a],localStorage.setItem("article-notes",JSON.stringify(c))}function Jt(a,l,c=!1){const m=new Date().toLocaleDateString("es-MX",{day:"numeric",month:"long",year:"numeric"}),p=a.map(h=>{const x=c?Ne(h.id):"";return`
        ...
        ${p}
        </body></html>`,v=new Blob([w],{type:"text/html;charset=utf-8;"}),b=document.createElement("a");b.href=URL.createObjectURL(v),b.download=`${l.replace(/\s+/g,"_")}_${m.replace(/\s/g,"-")}.html`,b.click(),URL.revokeObjectURL(b.href)}function Xt(a,l,c=!1){const m=["Ley","Artículo","Título","Texto",...c?["Nota personal"]:[]],p=a.map(h=>[`"${(h.ley_origen||"").replace(/"/g,'""')}"`,`"${(h.articulo_label||"").replace(/"/g,'""')}"`,`"${(h.titulo_nombre||"").replace(/"/g,'""')}"`,`"${(h.texto||"").replace(/"/g,'""')}"`,...c?[`"${Ne(h.id).replace(/"/g,'""')}"`]:[]]),w=[m.join(","),...p.map(h=>h.join(","))].join(`
`),v=new Blob(["\uFEFF"+w],{type:"text/csv;charset=utf-8;"}),b=document.createElement("a");b.href=URL.createObjectURL(v),b.download=l,b.click(),URL.revokeObjectURL(b.href)}function xt(){var w,v,b;$(null),ye(),Ae();const a=He();r.classList.add("hidden"),n.classList.add("hidden"),e.classList.add("hidden"),t&&t.classList.add("hidden","opacity-0"),(w=document.getElementById("analisis-container"))==null||w.classList.add("hidden","opacity-0"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),f.classList.remove("hidden"),setTimeout(()=>f.classList.remove("opacity-0"),50);const l=document.getElementById("search-filters");if(l&&l.remove(),a.length===0){f.innerHTML='<div class="text-center py-16 text-gray-400 text-sm">No tienes artículos guardados aún.</div>';return}const c=a.map(h=>je(h)).filter(Boolean);ke=c,f.innerHTML=`
        ...
        `,(c=document.getElementById("compare-clear-btn"))==null||c.addEventListener("click",()=>{var w;ie=[],yt();const p=((w=document.getElementById("law-search-input"))==null?void 0:w.value.toLowerCase().trim())||"";Fe(q.slice(0,50),p)}),(m=document.getElementById("compare-go-btn"))==null||m.addEventListener("click",()=>{Yt(ie[0],ie[1])})}function Yt(a,l){const c=je(a),m=je(l);if(!c||!m)return;const p=document.getElementById("compare-modal"),w=document.getElementById("compare-content"),v=document.getElementById("compare-panel");if(!p||!w)return;const b=y=>`
...
`).map(C=>`<p class="mb-3">${C}</p>`).join("")}
            ...
            </div>`;w.innerHTML=b(c)+b(m),p.classList.remove("hidden"),p.classList.add("flex"),setTimeout(()=>{v==null||v.classList.remove("scale-95","opacity-0"),v==null||v.classList.add("scale-100","opacity-100")},10);const h=document.getElementById("compare-share-btn"),x=document.getElementById("compare-share-menu"),E=document.getElementById("compare-share-text-btn");h&&x&&(h.onclick=y=>{y.stopPropagation(),x.classList.toggle("hidden")},document.addEventListener("click",function y(C){C.target.closest("#compare-share-menu-wrapper")||(x.classList.add("hidden"),document.removeEventListener("click",y))})),E&&(E.onclick=()=>{x==null||x.classList.add("hidden"),tr(c,m)})}function tt(){const a=document.getElementById("compare-modal"),l=document.getElementById("compare-panel");l==null||l.classList.remove("scale-100","opacity-100"),l==null||l.classList.add("scale-95","opacity-0"),setTimeout(()=>{a==null||a.classList.add("hidden"),a==null||a.classList.remove("flex")},300)}async function Kt(a){const l=document.createElement("canvas");l.width=800,l.height=500;const c=l.getContext("2d"),m=c.createLinearGradient(0,0,0,l.height);m.addColorStop(0,"#9B2247"),m.addColorStop(1,"#6b1532"),c.fillStyle=m,c.fillRect(0,0,l.width,l.height),c.beginPath(),c.arc(l.width-60,60,120,0,Math.PI*2),c.fillStyle="rgba(255,255,255,0.06)",c.fill(),c.fillStyle="rgba(255,255,255,0.15)",c.beginPath(),c.roundRect(40,40,20+c.measureText(a.ley_origen).width+16,28,14),c.fill(),c.fillStyle="#fff",c.font="bold 13px system-ui, sans-serif",c.fillText(a.ley_origen,56,59),c.fillStyle="#fff",c.font="bold 28px system-ui, sans-serif";const p=wt(c,a.articulo_label,l.width-80);p.forEach((y,C)=>c.fillText(y,40,110+C*38));const w=110+p.length*38+16;c.strokeStyle="rgba(255,255,255,0.3)",c.lineWidth=1,c.beginPath(),c.moveTo(40,w),c.lineTo(l.width-40,w),c.stroke();const v=w+24,b=l.height-v-60;c.fillStyle="rgba(255,255,255,0.88)",c.font="16px Georgia, serif";const h=a.texto.replace(/\s+/g," ").trim().substring(0,500),x=wt(c,h,l.width-80);let E=0;for(const y of x){if(E*24>b){c.fillStyle="rgba(255,255,255,0.5)",c.font="13px system-ui, sans-serif",c.fillText("...",40,v+E*24);break}c.fillText(y,40,v+E*24),E++}return c.fillStyle="rgba(255,255,255,0.35)",c.fillRect(0,l.height-44,l.width,44),c.fillStyle="rgba(255,255,255,0.8)",c.font="12px system-ui, sans-serif",c.fillText("Buscador de Leyes Energéticas · SENER",40,l.height-16),l.toDataURL("image/png")}function wt(a,l,c,m){const p=l.split(" "),w=[];let v="";for(const b of p){const h=v?v+" "+b:b;a.measureText(h).width>c&&v?(w.push(v),v=b):v=h}return v&&w.push(v),w}function Zt(a){const l=`📋 *${a.articulo_label}*
🏛️ ${a.ley_origen}
...
${c}`,v=`${a.titulo} — Marco Legal Energético SENER`,b={whatsapp:`https://wa.me/?text=${encodeURIComponent(w)}`,telegram:`https://t.me/share/url?url=${encodeURIComponent(c)}&text=${encodeURIComponent(m)}`,twitter:`https://twitter.com/intent/tweet?text=${encodeURIComponent(v)}&url=${encodeURIComponent(c)}`,email:`mailto:?subject=${encodeURIComponent(m)}&body=${encodeURIComponent(w)}`};b[l]&&window.open(b[l],"_blank")}function kt(){var b,h;$(null),ye(),Ae(),r.classList.add("hidden"),n.classList.add("hidden"),e.classList.add("hidden"),t&&t.classList.add("hidden","opacity-0"),(b=document.getElementById("analisis-container"))==null||b.classList.add("hidden","opacity-0"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),f.classList.remove("hidden"),setTimeout(()=>f.classList.remove("opacity-0"),50);const a=document.getElementById("search-filters");if(a&&a.remove(),U.length===0){f.innerHTML='<div class="text-center py-16 text-gray-400">Cargando datos...</div>';return}const l=U.reduce((x,E)=>x+E.articulos,0),c=U.filter(x=>x.titulo.toLowerCase().startsWith("ley")),m=U.filter(x=>x.titulo.toLowerCase().startsWith("reglamento")),p=U.filter(x=>!x.titulo.toLowerCase().startsWith("ley")&&!x.titulo.toLowerCase().startsWith("reglamento")),w=[...U].sort((x,E)=>E.articulos-x.articulos),v=((h=w[0])==null?void 0:h.articulos)||1;f.innerHTML=`
        ...
        `,document.querySelectorAll(".stat-law-row").forEach(x=>{x.addEventListener("click",()=>{const E=U.find(y=>y.titulo===x.dataset.titulo);E&&Me(E)})})}function Te(){var h,x,E;if(!f)return;let a=O;if(W.type!=="all"&&(a=a.filter(y=>W.type==="ley"?y.ley_origen.toLowerCase().includes("ley"):W.type==="reglamento"?y.ley_origen.toLowerCase().includes("reglamento"):!y.ley_origen.toLowerCase().includes("ley")&&!y.ley_origen.toLowerCase().includes("reglamento"))),W.law!=="all"&&(a=a.filter(y=>y.ley_origen===W.law)),W.artNum){const y=parseInt(W.artNum);a=a.filter(C=>{const B=C.articulo_label.match(/\d+/);return B&&parseInt(B[0])===y})}const l=a,c=_,m=document.getElementById("search-filters");if(m&&m.remove(),O.length>0){const y=document.createElement("div");y.id="search-filters",y.className="flex flex-col items-center gap-2 mb-6 animate-fade-in-up";const C=[...new Set(O.map(G=>G.ley_origen))].sort();y.innerHTML=`
            ...
            `,f.parentNode.insertBefore(y,f),y.querySelectorAll(".filter-btn").forEach(G=>{G.addEventListener("click",ee=>{W.type=ee.target.dataset.type,V=1,Te()})});const B=document.getElementById("law-filter-select");B&&B.addEventListener("change",G=>{W.law=G.target.value,V=1,Te()});const H=document.getElementById("art-number-filter");if(H){let G;H.addEventListener("input",ee=>{clearTimeout(G),G=setTimeout(()=>{W.artNum=ee.target.value.trim(),V=1,Te()},400)})}(h=document.getElementById("clear-all-filters"))==null||h.addEventListener("click",()=>{W={type:"all",law:"all",artNum:""},V=1,Te()})}if(l.length===0){const y=W.type!=="all"||W.law!=="all";f.innerHTML=`
            ...
            `}).join(""),X(l.length,"results-container",Te),document.querySelectorAll(".result-item").forEach(y=>{y.addEventListener("click",C=>{C.target.closest(".bookmark-card-btn")||ge(y.dataset.id)})}),document.querySelectorAll(".bookmark-card-btn").forEach(y=>{y.addEventListener("click",C=>{C.stopPropagation(),Ze(y.dataset.id),Te()})})}function ge(a){const l=je(a);if(!l)return;L.textContent=l.ley_origen,k.textContent=l.articulo_label,L.onclick=()=>{const D=U.find(se=>se.titulo===l.ley_origen);D&&(We(),setTimeout(()=>Me(D),310))};let c=l.texto.replace(/\r\n/g,`
`).replace(/\n\s*\n/g,`

`).replace(/([a-z,;])\n([a-z])/g,"$1 $2");const m=D=>_?Ve(D,_):D,p=D=>D&&D!=="null"&&D!=="undefined"&&D.trim()?D.trim():null,w=p(l.titulo_nombre),v=p(l.capitulo_nombre),b=[w,v].filter(Boolean);g.innerHTML=`
            ${b.length?`
...
`).map(D=>`<p class="mb-4">${m(D)}</p>`).join("")}
        ...
        `;const h=ke.findIndex(D=>D.id===a),x=ke.length,E=document.getElementById("modal-prev-btn"),y=document.getElementById("modal-next-btn"),C=document.getElementById("modal-nav-counter");E&&(E.disabled=h<=0,E.onclick=()=>{h>0&&ge(ke[h-1].id)}),y&&(y.disabled=h<0||h>=x-1,y.onclick=()=>{h<x-1&&ge(ke[h+1].id)}),C&&(C.textContent=h>=0?`${h+1}/${x}`:"");const B=document.getElementById("modal-bookmark-btn");if(B){const D=Oe(a);B.innerHTML=D?'<svg class="w-5 h-5 text-guinda" fill="currentColor" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>':'<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>',B.onclick=()=>{Ze(a),ge(a)}}const H=document.getElementById("copy-btn");H&&(H.onclick=()=>{navigator.clipboard.writeText(g.innerText).then(()=>{Z("¡Texto copiado!","📋")})});const G=document.getElementById("share-btn"),ee=document.getElementById("share-menu");document.getElementById("share-text-btn"),document.getElementById("share-image-btn"),G&&ee&&(G.onclick=D=>{D.stopPropagation(),ee.classList.toggle("hidden")},document.addEventListener("click",function D(se){se.target.closest("#share-menu-wrapper")||(ee.classList.add("hidden"),document.removeEventListener("click",D))}));const Se=Ne(a);g.innerHTML+=`
