(function(){const S=document.createElement("link").relList;if(S&&S.supports&&S.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))e(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&e(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function e(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();function Tt($){return $&&$.__esModule&&Object.prototype.hasOwnProperty.call($,"default")?$.default:$}var vt={exports:{}};/**
 * lunr - http://lunrjs.com - A bit like Solr, but much smaller and not as bright - 2.3.9
 * Copyright (C) 2020 Oliver Nightingale
 * @license MIT
 */(function($,S){(function(){var t=function(e){var r=new t.Builder;return r.pipeline.add(t.trimmer,t.stopWordFilter,t.stemmer),r.searchPipeline.add(t.stemmer),e.call(r,r),r.build()};t.version="2.3.9";/*!
 * lunr.utils
 * Copyright (C) 2020 Oliver Nightingale
 ...
 * lunr.tokenizer
 * Copyright (C) 2020 Oliver Nightingale
 */t.tokenizer=function(e,r){if(e==null||e==null)return[];if(Array.isArray(e))return e.map(function(j){return new t.Token(t.utils.asString(j).toLowerCase(),t.utils.clone(r))});for(var o=e.toString().toLowerCase(),a=o.length,s=[],u=0,m=0;u<=a;u++){var L=o.charAt(u),k=u-m;if(L.match(t.tokenizer.separator)||u==a){if(k>0){var I=t.utils.clone(r)||{};I.position=[m,k],I.index=s.length,s.push(new t.Token(o.slice(m,u),I))}m=u+1}}return s},t.tokenizer.separator=/[\s\-]+/;/*!
 * lunr.Pipeline
 * Copyright (C) 2020 Oliver Nightingale
 */t.Pipeline=function(){this._stack=[]},t.Pipeline.registeredFunctions=Object.create(null),t.Pipeline.registerFunction=function(e,r){r in this.registeredFunctions&&t.utils.warn("Overwriting existing registered function: "+r),e.label=r,t.Pipeline.registeredFunctions[e.label]=e},t.Pipeline.warnIfFunctionNotRegistered=function(e){var r=e.label&&e.label in this.registeredFunctions;r||t.utils.warn(`Function is not registered with pipeline. This may cause problems when serialising the index.
`,e)},t.Pipeline.load=function(e){var r=new t.Pipeline;return e.forEach(function(o){var a=t.Pipeline.registeredFunctions[o];if(a)r.add(a);else throw new Error("Cannot load unregistered function: "+o)}),r},t.Pipeline.prototype.add=function(){var e=Array.prototype.slice.call(arguments);e.forEach(function(r){t.Pipeline.warnIfFunctionNotRegistered(r),this._stack.push(r)},this)},t.Pipeline.prototype.after=function(e,r){t.Pipeline.warnIfFunctionNotRegistered(r);var o=this._stack.indexOf(e);if(o==-1)throw new Error("Cannot find existingFn");o=o+1,this._stack.splice(o,0,r)},t.Pipeline.prototype.before=function(e,r){t.Pipeline.warnIfFunctionNotRegistered(r);var o=this._stack.indexOf(e);if(o==-1)throw new Error("Cannot find existingFn");this._stack.splice(o,0,r)},t.Pipeline.prototype.remove=function(e){var r=this._stack.indexOf(e);r!=-1&&this._stack.splice(r,1)},t.Pipeline.prototype.run=function(e){for(var r=this._stack.length,o=0;o<r;o++){for(var a=this._stack[o],s=[],u=0;u<e.length;u++){var m=a(e[u],u,e);if(!(m==null||m===""))if(Array.isArray(m))for(var L=0;L<m.length;L++)s.push(m[L]);else s.push(m)}e=s}return e},t.Pipeline.prototype.runString=function(e,r){var o=new t.Token(e,r);return this.run([o]).map(function(a){return a.toString()})},t.Pipeline.prototype.reset=function(){this._stack=[]},t.Pipeline.prototype.toJSON=function(){return this._stack.map(function(e){return t.Pipeline.warnIfFunctionNotRegistered(e),e.label})};/*!
 * lunr.Vector
 * Copyright (C) 2020 Oliver Nightingale
 */t.Vector=function(e){this._magnitude=0,this.elements=e||[]},t.Vector.prototype.positionForIndex=function(e){if(this.elements.length==0)return 0;for(var r=0,o=this.elements.length/2,a=o-r,s=Math.floor(a/2),u=this.elements[s*2];a>1&&(u<e&&(r=s),u>e&&(o=s),u!=e);)a=o-r,s=r+Math.floor(a/2),u=this.elements[s*2];if(u==e||u>e)return s*2;if(u<e)return(s+1)*2},t.Vector.prototype.insert=function(e,r){this.upsert(e,r,function(){throw"duplicate index"})},t.Vector.prototype.upsert=function(e,r,o){this._magnitude=0;var a=this.positionForIndex(e);this.elements[a]==e?this.elements[a+1]=o(this.elements[a+1],r):this.elements.splice(a,0,e,r)},t.Vector.prototype.magnitude=function(){if(this._magnitude)return this._magnitude;for(var e=0,r=this.elements.length,o=1;o<r;o+=2){var a=this.elements[o];e+=a*a}return this._magnitude=Math.sqrt(e)},t.Vector.prototype.dot=function(e){for(var r=0,o=this.elements,a=e.elements,s=o.length,u=a.length,m=0,L=0,k=0,I=0;k<s&&I<u;)m=o[k],L=a[I],m<L?k+=2:m>L?I+=2:m==L&&(r+=o[k+1]*a[I+1],k+=2,I+=2);return r},t.Vector.prototype.similarity=function(e){return this.dot(e)/this.magnitude()||0},t.Vector.prototype.toArray=function(){for(var e=new Array(this.elements.length/2),r=1,o=0;r<this.elements.length;r+=2,o++)e[o]=this.elements[r];return e},t.Vector.prototype.toJSON=function(){return this.elements};/*!
 * lunr.stemmer
 * Copyright (C) 2020 Oliver Nightingale
 * Includes code from - http://tartarus.org/~martin/PorterStemmer/js.txt
 */t.stemmer=function(){var e={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},r={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},o="[^aeiou]",a="[aeiouy]",s=o+"[^aeiouy]*",u=a+"[aeiou]*",m="^("+s+")?"+u+s,L="^("+s+")?"+u+s+"("+u+")?$",k="^("+s+")?"+u+s+u+s,I="^("+s+")?"+a,j=new RegExp(m),_=new RegExp(k),q=new RegExp(L),F=new RegExp(I),H=/^(.+?)(ss|i)es$/,B=/^(.+?)([^s])s$/,M=/^(.+?)eed$/,J=/^(.+?)(ed|ing)$/,U=/.$/,te=/(at|bl|iz)$/,le=new RegExp("([^aeiouylsz])\\1$"),de=new RegExp("^"+s+a+"[^aeiouwxy]$"),ce=/^(.+?[^aeiou])y$/,re=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,N=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,D=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,xe=/^(.+?)(s|t)(ion)$/,oe=/^(.+?)e$/,be=/ll$/,ve=new RegExp("^"+s+a+"[^aeiouwxy]$"),Z=function(b){var R,K,G,y,O,ue,ae;if(b.length<3)return b;if(G=b.substr(0,1),G=="y"&&(b=G.toUpperCase()+b.substr(1)),y=H,O=B,y.test(b)?b=b.replace(y,"$1$2"):O.test(b)&&(b=b.replace(O,"$1$2")),y=M,O=J,y.test(b)){var P=y.exec(b);y=j,y.test(P[1])&&(y=U,b=b.replace(y,""))}else if(O.test(b)){var P=O.exec(b);R=P[1],O=F,O.test(R)&&(b=R,O=te,ue=le,ae=de,O.test(b)?b=b+"e":ue.test(b)?(y=U,b=b.replace(y,"")):ae.test(b)&&(b=b+"e"))}if(y=ce,y.test(b)){var P=y.exec(b);R=P[1],b=R+"i"}if(y=re,y.test(b)){var P=y.exec(b);R=P[1],K=P[2],y=j,y.test(R)&&(b=R+e[K])}if(y=N,y.test(b)){var P=y.exec(b);R=P[1],K=P[2],y=j,y.test(R)&&(b=R+r[K])}if(y=D,O=xe,y.test(b)){var P=y.exec(b);R=P[1],y=_,y.test(R)&&(b=R)}else if(O.test(b)){var P=O.exec(b);R=P[1]+P[2],O=_,O.test(R)&&(b=R)}if(y=oe,y.test(b)){var P=y.exec(b);R=P[1],y=_,O=q,ue=ve,(y.test(R)||O.test(R)&&!ue.test(R))&&(b=R)}return y=be,O=_,y.test(b)&&O.test(b)&&(y=U,b=b.replace(y,"")),G=="y"&&(b=G.toLowerCase()+b.substr(1)),b};return function(ge){return ge.update(Z)}}(),t.Pipeline.registerFunction(t.stemmer,"stemmer");/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
 ...
 */t.Builder=function(){this._ref="id",this._fields=Object.create(null),this._documents=Object.create(null),this.invertedIndex=Object.create(null),this.fieldTermFrequencies={},this.fieldLengths={},this.tokenizer=t.tokenizer,this.pipeline=new t.Pipeline,this.searchPipeline=new t.Pipeline,this.documentCount=0,this._b=.75,this._k1=1.2,this.termIndex=0,this.metadataWhitelist=[]},t.Builder.prototype.ref=function(e){this._ref=e},t.Builder.prototype.field=function(e,r){if(/\//.test(e))throw new RangeError("Field '"+e+"' contains illegal character '/'");this._fields[e]=r||{}},t.Builder.prototype.b=function(e){e<0?this._b=0:e>1?this._b=1:this._b=e},t.Builder.prototype.k1=function(e){this._k1=e},t.Builder.prototype.add=function(e,r){var o=e[this._ref],a=Object.keys(this._fields);this._documents[o]=r||{},this.documentCount+=1;for(var s=0;s<a.length;s++){var u=a[s],m=this._fields[u].extractor,L=m?m(e):e[u],k=this.tokenizer(L,{fields:[u]}),I=this.pipeline.run(k),j=new t.FieldRef(o,u),_=Object.create(null);this.fieldTermFrequencies[j]=_,this.fieldLengths[j]=0,this.fieldLengths[j]+=I.length;for(var q=0;q<I.length;q++){var F=I[q];if(_[F]==null&&(_[F]=0),_[F]+=1,this.invertedIndex[F]==null){var H=Object.create(null);H._index=this.termIndex,this.termIndex+=1;for(var B=0;B<a.length;B++)H[a[B]]=Object.create(null);this.invertedIndex[F]=H}this.invertedIndex[F][u][o]==null&&(this.invertedIndex[F][u][o]=Object.create(null));for(var M=0;M<this.metadataWhitelist.length;M++){var J=this.metadataWhitelist[M],U=F.metadata[J];this.invertedIndex[F][u][o][J]==null&&(this.invertedIndex[F][u][o][J]=[]),this.invertedIndex[F][u][o][J].push(U)}}}},t.Builder.prototype.calculateAverageFieldLengths=function(){for(var e=Object.keys(this.fieldLengths),r=e.length,o={},a={},s=0;s<r;s++){var u=t.FieldRef.fromString(e[s]),m=u.fieldName;a[m]||(a[m]=0),a[m]+=1,o[m]||(o[m]=0),o[m]+=this.fieldLengths[u]}for(var L=Object.keys(this._fields),s=0;s<L.length;s++){var k=L[s];o[k]=o[k]/a[k]}this.averageFieldLength=o},t.Builder.prototype.createFieldVectors=function(){for(var e={},r=Object.keys(this.fieldTermFrequencies),o=r.length,a=Object.create(null),s=0;s<o;s++){for(var u=t.FieldRef.fromString(r[s]),m=u.fieldName,L=this.fieldLengths[u],k=new t.Vector,I=this.fieldTermFrequencies[u],j=Object.keys(I),_=j.length,q=this._fields[m].boost||1,F=this._documents[u.docRef].boost||1,H=0;H<_;H++){var B=j[H],M=I[B],J=this.invertedIndex[B]._index,U,te,le;a[B]===void 0?(U=t.idf(this.invertedIndex[B],this.documentCount),a[B]=U):U=a[B],te=U*((this._k1+1)*M)/(this._k1*(1-this._b+this._b*(L/this.averageFieldLength[m]))+M),te*=q,te*=F,le=Math.round(te*1e3)/1e3,k.insert(J,le)}e[u]=k}this.fieldVectors=e},t.Builder.prototype.createTokenSet=function(){this.tokenSet=t.TokenSet.fromArray(Object.keys(this.invertedIndex).sort())},t.Builder.prototype.build=function(){return this.calculateAverageFieldLengths(),this.createFieldVectors(),this.createTokenSet(),new t.Index({invertedIndex:this.invertedIndex,fieldVectors:this.fieldVectors,tokenSet:this.tokenSet,fields:Object.keys(this._fields),pipeline:this.searchPipeline})},t.Builder.prototype.use=function(e){var r=Array.prototype.slice.call(arguments,1);r.unshift(this),e.apply(this,r)},t.MatchData=function(e,r,o){for(var a=Object.create(null),s=Object.keys(o||{}),u=0;u<s.length;u++){var m=s[u];a[m]=o[m].slice()}this.metadata=Object.create(null),e!==void 0&&(this.metadata[e]=Object.create(null),this.metadata[e][r]=a)},t.MatchData.prototype.combine=function(e){for(var r=Object.keys(e.metadata),o=0;o<r.length;o++){var a=r[o],s=Object.keys(e.metadata[a]);this.metadata[a]==null&&(this.metadata[a]=Object.create(null));for(var u=0;u<s.length;u++){var m=s[u],L=Object.keys(e.metadata[a][m]);this.metadata[a][m]==null&&(this.metadata[a][m]=Object.create(null));for(var k=0;k<L.length;k++){var I=L[k];this.metadata[a][m][I]==null?this.metadata[a][m][I]=e.metadata[a][m][I]:this.metadata[a][m][I]=this.metadata[a][m][I].concat(e.metadata[a][m][I])}}}},t.MatchData.prototype.add=function(e,r,o){if(!(e in this.metadata)){this.metadata[e]=Object.create(null),this.metadata[e][r]=o;return}if(!(r in this.metadata[e])){this.metadata[e][r]=o;return}for(var a=Object.keys(o),s=0;s<a.length;s++){var u=a[s];u in this.metadata[e][r]?this.metadata[e][r][u]=this.metadata[e][r][u].concat(o[u]):this.metadata[e][r][u]=o[u]}},t.Query=function(e){this.clauses=[],this.allFields=e},t.Query.wildcard=new String("*"),t.Query.wildcard.NONE=0,t.Query.wildcard.LEADING=1,t.Query.wildcard.TRAILING=2,t.Query.presence={OPTIONAL:1,REQUIRED:2,PROHIBITED:3},t.Query.prototype.clause=function(e){return"fields"in e||(e.fields=this.allFields),"boost"in e||(e.boost=1),"usePipeline"in e||(e.usePipeline=!0),"wildcard"in e||(e.wildcard=t.Query.wildcard.NONE),e.wildcard&t.Query.wildcard.LEADING&&e.term.charAt(0)!=t.Query.wildcard&&(e.term="*"+e.term),e.wildcard&t.Query.wildcard.TRAILING&&e.term.slice(-1)!=t.Query.wildcard&&(e.term=""+e.term+"*"),"presence"in e||(e.presence=t.Query.presence.OPTIONAL),this.clauses.push(e),this},t.Query.prototype.isNegated=function(){for(var e=0;e<this.clauses.length;e++)if(this.clauses[e].presence!=t.Query.presence.PROHIBITED)return!1;return!0},t.Query.prototype.term=function(e,r){if(Array.isArray(e))return e.forEach(function(a){this.term(a,t.utils.clone(r))},this),this;var o=r||{};return o.term=e.toString(),this.clause(o),this},t.QueryParseError=function(e,r,o){this.name="QueryParseError",this.message=e,this.start=r,this.end=o},t.QueryParseError.prototype=new Error,t.QueryLexer=function(e){this.lexemes=[],this.str=e,this.length=e.length,this.pos=0,this.start=0,this.escapeCharPositions=[]},t.QueryLexer.prototype.run=function(){for(var e=t.QueryLexer.lexText;e;)e=e(this)},t.QueryLexer.prototype.sliceString=function(){for(var e=[],r=this.start,o=this.pos,a=0;a<this.escapeCharPositions.length;a++)o=this.escapeCharPositions[a],e.push(this.str.slice(r,o)),r=o+1;return e.push(this.str.slice(r,this.pos)),this.escapeCharPositions.length=0,e.join("")},t.QueryLexer.prototype.emit=function(e){this.lexemes.push({type:e,str:this.sliceString(),start:this.start,end:this.pos}),this.start=this.pos},t.QueryLexer.prototype.escapeCharacter=function(){this.escapeCharPositions.push(this.pos-1),this.pos+=1},t.QueryLexer.prototype.next=function(){if(this.pos>=this.length)return t.QueryLexer.EOS;var e=this.str.charAt(this.pos);return this.pos+=1,e},t.QueryLexer.prototype.width=function(){return this.pos-this.start},t.QueryLexer.prototype.ignore=function(){this.start==this.pos&&(this.pos+=1),this.start=this.pos},t.QueryLexer.prototype.backup=function(){this.pos-=1},t.QueryLexer.prototype.acceptDigitRun=function(){var e,r;do e=this.next(),r=e.charCodeAt(0);while(r>47&&r<58);e!=t.QueryLexer.EOS&&this.backup()},t.QueryLexer.prototype.more=function(){return this.pos<this.length},t.QueryLexer.EOS="EOS",t.QueryLexer.FIELD="FIELD",t.QueryLexer.TERM="TERM",t.QueryLexer.EDIT_DISTANCE="EDIT_DISTANCE",t.QueryLexer.BOOST="BOOST",t.QueryLexer.PRESENCE="PRESENCE",t.QueryLexer.lexField=function(e){return e.backup(),e.emit(t.QueryLexer.FIELD),e.ignore(),t.QueryLexer.lexText},t.QueryLexer.lexTerm=function(e){if(e.width()>1&&(e.backup(),e.emit(t.QueryLexer.TERM)),e.ignore(),e.more())return t.QueryLexer.lexText},t.QueryLexer.lexEditDistance=function(e){return e.ignore(),e.acceptDigitRun(),e.emit(t.QueryLexer.EDIT_DISTANCE),t.QueryLexer.lexText},t.QueryLexer.lexBoost=function(e){return e.ignore(),e.acceptDigitRun(),e.emit(t.QueryLexer.BOOST),t.QueryLexer.lexText},t.QueryLexer.lexEOS=function(e){e.width()>0&&e.emit(t.QueryLexer.TERM)},t.QueryLexer.termSeparator=t.tokenizer.separator,t.QueryLexer.lexText=function(e){for(;;){var r=e.next();if(r==t.QueryLexer.EOS)return t.QueryLexer.lexEOS;if(r.charCodeAt(0)==92){e.escapeCharacter();continue}if(r==":")return t.QueryLexer.lexField;if(r=="~")return e.backup(),e.width()>0&&e.emit(t.QueryLexer.TERM),t.QueryLexer.lexEditDistance;if(r=="^")return e.backup(),e.width()>0&&e.emit(t.QueryLexer.TERM),t.QueryLexer.lexBoost;if(r=="+"&&e.width()===1||r=="-"&&e.width()===1)return e.emit(t.QueryLexer.PRESENCE),t.QueryLexer.lexText;if(r.match(t.QueryLexer.termSeparator))return t.QueryLexer.lexTerm}},t.QueryParser=function(e,r){this.lexer=new t.QueryLexer(e),this.query=r,this.currentClause={},this.lexemeIdx=0},t.QueryParser.prototype.parse=function(){this.lexer.run(),this.lexemes=this.lexer.lexemes;for(var e=t.QueryParser.parseClause;e;)e=e(this);return this.query},t.QueryParser.prototype.peekLexeme=function(){return this.lexemes[this.lexemeIdx]},t.QueryParser.prototype.consumeLexeme=function(){var e=this.peekLexeme();return this.lexemeIdx+=1,e},t.QueryParser.prototype.nextClause=function(){var e=this.currentClause;this.query.clause(e),this.currentClause={}},t.QueryParser.parseClause=function(e){var r=e.peekLexeme();if(r!=null)switch(r.type){case t.QueryLexer.PRESENCE:return t.QueryParser.parsePresence;case t.QueryLexer.FIELD:return t.QueryParser.parseField;case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var o="expected either a field or a term, found "+r.type;throw r.str.length>=1&&(o+=" with value '"+r.str+"'"),new t.QueryParseError(o,r.start,r.end)}},t.QueryParser.parsePresence=function(e){var r=e.consumeLexeme();if(r!=null){switch(r.str){case"-":e.currentClause.presence=t.Query.presence.PROHIBITED;break;case"+":e.currentClause.presence=t.Query.presence.REQUIRED;break;default:var o="unrecognised presence operator'"+r.str+"'";throw new t.QueryParseError(o,r.start,r.end)}var a=e.peekLexeme();if(a==null){var o="expecting term or field, found nothing";throw new t.QueryParseError(o,r.start,r.end)}switch(a.type){case t.QueryLexer.FIELD:return t.QueryParser.parseField;case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var o="expecting term or field, found '"+a.type+"'";throw new t.QueryParseError(o,a.start,a.end)}}},t.QueryParser.parseField=function(e){var r=e.consumeLexeme();if(r!=null){if(e.query.allFields.indexOf(r.str)==-1){var o=e.query.allFields.map(function(u){return"'"+u+"'"}).join(", "),a="unrecognised field '"+r.str+"', possible fields: "+o;throw new t.QueryParseError(a,r.start,r.end)}e.currentClause.fields=[r.str];var s=e.peekLexeme();if(s==null){var a="expecting term, found nothing";throw new t.QueryParseError(a,r.start,r.end)}switch(s.type){case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var a="expecting term, found '"+s.type+"'";throw new t.QueryParseError(a,s.start,s.end)}}},t.QueryParser.parseTerm=function(e){var r=e.consumeLexeme();if(r!=null){e.currentClause.term=r.str.toLowerCase(),r.str.indexOf("*")!=-1&&(e.currentClause.usePipeline=!1);var o=e.peekLexeme();if(o==null){e.nextClause();return}switch(o.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var a="Unexpected lexeme type '"+o.type+"'";throw new t.QueryParseError(a,o.start,o.end)}}},t.QueryParser.parseEditDistance=function(e){var r=e.consumeLexeme();if(r!=null){var o=parseInt(r.str,10);if(isNaN(o)){var a="edit distance must be numeric";throw new t.QueryParseError(a,r.start,r.end)}e.currentClause.editDistance=o;var s=e.peekLexeme();if(s==null){e.nextClause();return}switch(s.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var a="Unexpected lexeme type '"+s.type+"'";throw new t.QueryParseError(a,s.start,s.end)}}},t.QueryParser.parseBoost=function(e){var r=e.consumeLexeme();if(r!=null){var o=parseInt(r.str,10);if(isNaN(o)){var a="boost must be numeric";throw new t.QueryParseError(a,r.start,r.end)}e.currentClause.boost=o;var s=e.peekLexeme();if(s==null){e.nextClause();return}switch(s.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var a="Unexpected lexeme type '"+s.type+"'";throw new t.QueryParseError(a,s.start,s.end)}}},function(e,r){$.exports=r()}(this,function(){return t})})()})(vt);var Mt=vt.exports;const _t=Tt(Mt);let Ge,fe=[];async function jt(){try{console.log("Initializing search...");const $=await fetch("/data/manifest.json");if(!$.ok)throw new Error("Manifest not found");const t=(await $.json()).map(s=>fetch(`/data/${s}`).then(u=>u.json())),e=await Promise.all(t);fe=e.flatMap(s=>s.articulos.map(u=>({...u,ley_origen:s.metadata.ley,fecha_publicacion:s.metadata.fecha_publicacion}))),Ge=_t(function(){this.ref("id"),this.field("texto"),this.field("titulo_nombre",{boost:5}),this.field("capitulo_nombre",{boost:3}),this.field("articulo_label",{boost:10}),this.field("ley_origen",{boost:5}),fe.forEach(s=>{this.add(s)})}),console.log(`Search Index Ready. ${fe.length} articles indexed.`);const r=new Set(fe.map(s=>s.ley_origen)),o=Qt(e),a={totalLeyes:r.size,totalArticulos:fe.length,leyes:Array.from(r),summaries:o};window.dispatchEvent(new CustomEvent("search-ready",{detail:a}))}catch($){console.error("Error initializing search:",$)}}function Qt($){return $.map(S=>{const t=S.metadata,e={};S.articulos.forEach(o=>{e[o.capitulo_nombre]||(e[o.capitulo_nombre]=0),e[o.capitulo_nombre]++});const r=Object.entries(e).sort((o,a)=>a[1]-o[1]).slice(0,3).map(o=>o[0]);return{titulo:t.ley,fecha:t.fecha_publicacion,articulos:t.total_articulos,temas_clave:r,id:t.ley.replace(/\s+/g,"-").toLowerCase(),resumen:t.resumen||"No hay resumen disponible para este documento."}})}function Rt($){if(!Ge)return[];try{let S=$;return!/[~*^:+]/.test($)&&(S=$.split(/\s+/).filter(r=>r.length>2).map(r=>`${r}~1 ${r}*`).join(" ")),Ge.search(S).map(r=>({...fe.find(a=>a.id===r.ref),score:r.score,matchData:r.matchData}))}catch(S){return console.warn("Search error",S),[]}}function Me($){return fe.find(S=>S.id===$)}function Ot($){return fe.filter(S=>S.ley_origen===$)}function Pt(){var nt,ot,at,st,it;const $=document.getElementById("search-input"),S=document.getElementById("results-container"),t=document.getElementById("law-detail-container"),e=document.getElementById("stats-minimal"),r=document.getElementById("hero-section"),o=document.getElementById("main-container"),a=document.getElementById("quick-filters"),s=document.getElementById("detail-modal"),u=document.getElementById("modal-panel"),m=document.getElementById("modal-content"),L=document.getElementById("modal-title"),k=document.getElementById("modal-ley"),I=document.getElementById("close-modal"),j=document.getElementById("copy-btn"),_=document.getElementById("loading-indicator"),q=document.getElementById("nav-inicio"),F=document.getElementById("nav-leyes"),H=document.getElementById("mobile-menu-btn"),B=document.getElementById("mobile-menu-overlay"),M=document.getElementById("mobile-menu-drawer"),J=document.getElementById("close-mobile-menu"),U=document.getElementById("mobile-nav-inicio"),te=document.getElementById("mobile-nav-leyes"),le="app-dark-mode";let de=localStorage.getItem(le)==="true";function ce(n){if(de=n,localStorage.setItem(le,n),document.documentElement.classList.toggle("dark-mode",n),!document.getElementById("global-dark-style")){const c=document.createElement("style");c.id="global-dark-style",c.innerHTML=`
            ...
            `,document.head.appendChild(c)}const i=document.querySelectorAll("#darkmode-icon-moon, #mobile-darkmode-moon"),l=document.querySelectorAll("#darkmode-icon-sun, #mobile-darkmode-sun"),d=document.getElementById("mobile-darkmode-label");i.forEach(c=>c.classList.toggle("hidden",n)),l.forEach(c=>c.classList.toggle("hidden",!n)),d&&(d.textContent=n?"Modo claro":"Modo oscuro")}de&&ce(!0),(nt=document.getElementById("darkmode-toggle"))==null||nt.addEventListener("click",()=>ce(!de)),(ot=document.getElementById("mobile-darkmode-toggle"))==null||ot.addEventListener("click",()=>ce(!de));function re(n){!M||!B||(n?(B.classList.remove("hidden"),B.offsetWidth,B.classList.remove("opacity-0"),M.classList.remove("translate-x-full"),document.body.style.overflow="hidden"):(B.classList.add("opacity-0"),M.classList.add("translate-x-full"),document.body.style.overflow="",setTimeout(()=>{B.classList.add("hidden")},300)))}H&&H.addEventListener("click",()=>re(!0)),J&&J.addEventListener("click",()=>re(!1)),B&&B.addEventListener("click",()=>re(!1)),U&&U.addEventListener("click",n=>{n.preventDefault(),ae(),re(!1)}),te&&te.addEventListener("click",n=>{n.preventDefault(),P(),re(!1)});let N=[],D=[];window.addEventListener("search-ready",n=>{const{totalLeyes:i,totalArticulos:l,summaries:d}=n.detail;N=d,e&&(e.innerHTML=`
            ...
            `),Xe(),setTimeout(ge,0)});const xe=document.getElementById("nav-favorites"),oe=document.getElementById("mobile-nav-favorites");xe&&xe.addEventListener("click",()=>Ke()),oe&&oe.addEventListener("click",()=>{Ke(),re(!1)});const be=document.getElementById("nav-stats"),ve=document.getElementById("mobile-nav-stats");be&&be.addEventListener("click",n=>{n.preventDefault(),tt()}),ve&&ve.addEventListener("click",n=>{n.preventDefault(),tt(),re(!1)}),(at=document.getElementById("close-compare-modal"))==null||at.addEventListener("click",Ne),(st=document.getElementById("compare-modal"))==null||st.addEventListener("click",n=>{n.target===document.getElementById("compare-modal")&&Ne()});function Z(n){history.replaceState(null,"",n?`${location.pathname}${n}`:location.pathname)}function ge(){const n=location.hash;if(n){if(n.startsWith("#art-")){const i=decodeURIComponent(n.slice(5)),l=Me(i);if(!l)return;he=[l],me(i)}else if(n.startsWith("#ley-")){const i=decodeURIComponent(n.slice(5)),l=N.find(d=>d.id===i);l&&ye(l)}}}function b(n,i="✓",l="bg-gray-900"){const d=document.getElementById("app-toast");d&&d.remove();const c=document.createElement("div");c.id="app-toast",c.className=`fixed bottom-24 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-2 px-5 py-3 ${l} text-white text-xs font-semibold rounded-full shadow-2xl transition-all duration-300 opacity-0 scale-90 pointer-events-none`,c.innerHTML=`<span>${i}</span><span>${n}</span>`,document.body.appendChild(c),requestAnimationFrame(()=>{c.classList.replace("opacity-0","opacity-100"),c.classList.replace("scale-90","scale-100")}),setTimeout(()=>{c.classList.replace("opacity-100","opacity-0"),c.classList.replace("scale-100","scale-90"),setTimeout(()=>c.remove(),300)},2500)}function R(n=5){S.innerHTML=Array(n).fill("").map(()=>`
        ...
        `).join("")}let K="",G=[],y=1;const O=10;function ue(n,i,l){const d=document.getElementById(i);if(!d)return;const c=d.nextElementSibling;if(c&&c.classList.contains("pagination-nav")&&c.remove(),n<=O)return;const f=Math.ceil(n/O),g=document.createElement("nav");g.className="pagination-nav flex justify-center items-center gap-2 mt-8 mb-4";const h=document.createElement("button");h.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>',h.className=`p-2 rounded-full border border-gray-200 text-gray-500 hover:bg-guinda hover:text-white hover:border-guinda transition-all ${y===1?"opacity-50 cursor-not-allowed":""}`,h.disabled=y===1,h.onclick=()=>{y>1&&(y--,l(),window.scrollTo({top:d.offsetTop-100,behavior:"smooth"}))};const p=document.createElement("span");p.className="text-xs text-gray-500 font-medium",p.innerText=`Página ${y} de ${f}`;const E=document.createElement("button");E.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>',E.className=`p-2 rounded-full border border-gray-200 text-gray-500 hover:bg-guinda hover:text-white hover:border-guinda transition-all ${y===f?"opacity-50 cursor-not-allowed":""}`,E.disabled=y===f,E.onclick=()=>{y<f&&(y++,l(),window.scrollTo({top:d.offsetTop-100,behavior:"smooth"}))},g.appendChild(h),g.appendChild(p),g.appendChild(E),d.parentNode.insertBefore(g,d.nextSibling)}q&&q.addEventListener("click",n=>{n.preventDefault(),ae()}),F&&F.addEventListener("click",n=>{n.preventDefault(),P()});function ae(){Z(null),$&&($.value=""),r.classList.remove("hidden"),a.classList.remove("hidden"),e.classList.remove("hidden"),o.classList.add("justify-center","pt-24"),o.classList.remove("pt-8"),S.classList.add("hidden","opacity-0"),S.innerHTML="",t&&t.classList.add("hidden","opacity-0");const n=document.getElementById("search-filters");n&&n.remove();const i=document.querySelector(".pagination-nav");i&&i.remove(),y=1,A={type:"all",law:"all",artNum:""}}function P(){if(Z(null),r.classList.add("hidden"),a.classList.add("hidden"),e.classList.add("hidden"),t&&t.classList.add("hidden","opacity-0"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),S.classList.remove("hidden"),setTimeout(()=>S.classList.remove("opacity-0"),50),$&&($.value=""),N.length===0){S.innerHTML='<div class="text-center py-12 text-gray-400">Cargando leyes...</div>';return}const n=N.filter(d=>d.titulo.toLowerCase().startsWith("ley")),i=N.filter(d=>d.titulo.toLowerCase().startsWith("reglamento")),l=N.filter(d=>!d.titulo.toLowerCase().startsWith("ley")&&!d.titulo.toLowerCase().startsWith("reglamento"));S.innerHTML=`
            ...
            ${Ie("Leyes Federales",n)}
            ${Ie("Reglamentos",i)}
            ${Ie("Acuerdos y Otros Instrumentos",l)}
        `,document.querySelectorAll(".law-card").forEach(d=>{d.addEventListener("click",()=>{const c=d.dataset.title,f=N.find(g=>g.titulo===c);f&&ye(f)})}),document.querySelectorAll(".carousel-container").forEach(d=>{const c=d.querySelector(".carousel-scroll"),f=d.querySelector(".scroll-left"),g=d.querySelector(".scroll-right");f&&g&&c&&(f.addEventListener("click",()=>{c.scrollBy({left:-300,behavior:"smooth"})}),g.addEventListener("click",()=>{c.scrollBy({left:300,behavior:"smooth"})}))})}function Ie(n,i){if(i.length===0)return"";const l=n.toLowerCase().includes("ley"),d=n.toLowerCase().includes("reglamento"),c=l?{gradFrom:"#6b1532",gradTo:"#9B2247",label:"Ley Federal",dotClass:"bg-guinda"}:d?{gradFrom:"#14403a",gradTo:"#1E5B4F",label:"Reglamento",dotClass:"bg-emerald-700"}:{gradFrom:"#7a5c1e",gradTo:"#A57F2C",label:"Instrumento",dotClass:"bg-amber-700"},f=l?'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/>':d?'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>':'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>';return`
        ...
        `}function ye(n){var ut,pt,gt,ht,mt,ft,xt,bt;if(!t)return;D=Ot(n.titulo);const i=[...new Set(D.map(v=>v.capitulo_nombre).filter(Boolean))];[...new Set(D.map(v=>v.titulo_nombre).filter(Boolean))];const l=D.filter(v=>v.articulo_label.toLowerCase().includes("transitorio")).length;S.classList.add("hidden"),r.classList.add("hidden"),a.classList.add("hidden"),e.classList.add("hidden"),t.classList.remove("hidden"),setTimeout(()=>t.classList.remove("opacity-0"),50),Z(`#ley-${encodeURIComponent(n.id)}`);let d=100,c=localStorage.getItem("reader-theme")||"light";t.innerHTML=`
...
`)[0]}</div>`:""}
        ...
        `,document.body.appendChild(f);const g=D.map((v,T)=>{const Y=v.articulo_label.match(/\d+/),W=Y?Y[0]:T+1,Ue=!!Le(v.id);return`<button class="toc-art-btn text-[11px] font-medium rounded-lg py-2 px-1 border transition-all text-center relative
                ...
                Art.${W}
                ${Ue?'<span class="absolute top-0.5 right-0.5 w-1.5 h-1.5 bg-amber-400 rounded-full"></span>':""}
        ...
        `,document.body.appendChild(p);const E=p.querySelector("#toc-tab-grid"),Q=p.querySelector("#toc-tab-list"),w=p.querySelector("#toc-content-grid"),x=p.querySelector("#toc-content-list"),C=p.querySelector("#toc-search"),X=["bg-guinda","text-white","shadow-sm"],V=["text-gray-500","hover:text-guinda","hover:bg-guinda/5"];E.addEventListener("click",()=>{E.classList.add(...X),E.classList.remove(...V),Q.classList.remove(...X),Q.classList.add(...V),w.classList.remove("hidden"),x.classList.add("hidden"),C&&(C.value=""),w.querySelectorAll(".toc-art-btn").forEach(v=>v.style.display="")}),Q.addEventListener("click",()=>{Q.classList.add(...X),Q.classList.remove(...V),E.classList.remove(...X),E.classList.add(...V),x.classList.remove("hidden"),w.classList.add("hidden"),C&&(C.value=""),x.querySelectorAll(".toc-art-btn").forEach(v=>v.style.display="")}),C&&(C.addEventListener("input",v=>{const T=v.target.value.toLowerCase().trim();(x.classList.contains("hidden")?w:x).querySelectorAll(".toc-art-btn").forEach(W=>{var We;const Ue=!T||((We=W.title)==null?void 0:We.toLowerCase().includes(T))||W.textContent.toLowerCase().includes(T);W.style.display=Ue?"":"none"})}),C.addEventListener("click",v=>v.stopPropagation()));let ne=!1;const se=v=>{ne=v,v?(p.classList.remove("translate-y-full"),document.body.style.overflow="hidden"):(p.classList.add("translate-y-full"),document.body.style.overflow="")};f.addEventListener("click",()=>se(!ne)),(ut=p.querySelector("#toc-close-btn"))==null||ut.addEventListener("click",()=>se(!1)),p.querySelectorAll(".toc-art-btn").forEach(v=>{v.addEventListener("click",()=>{se(!1),me(v.dataset.id)})});const Ee=()=>{f.remove(),p.remove(),document.body.style.overflow=""};(pt=document.getElementById("crumb-inicio"))==null||pt.addEventListener("click",Ee,{once:!0}),(gt=document.getElementById("crumb-categoria"))==null||gt.addEventListener("click",Ee,{once:!0});const lt=()=>{document.getElementById("toc-toggle-btn")&&Ee()};$==null||$.addEventListener("input",lt,{once:!0}),we(D.slice(0,20),""),setTimeout(()=>{Je(D)},100);const Be=document.getElementById("law-articles-list"),z=document.getElementById("btn-font-increase"),ie=document.getElementById("btn-font-decrease"),pe=document.getElementById("font-size-display"),dt=document.querySelectorAll(".theme-btn");document.getElementById("law-header-area");const De=v=>{if(c=v,localStorage.setItem("reader-theme",v),document.body.className=`bg-${v} text-gray-900 font-body min-h-screen flex flex-col antialiased transition-colors duration-300`,dt.forEach(T=>{T.classList.remove("ring-2","ring-guinda","ring-offset-1"),T.dataset.theme===v&&T.classList.add("ring-2","ring-guinda","ring-offset-1")}),document.querySelectorAll(".mob-theme-btn").forEach(T=>{T.classList.remove("border-guinda","text-guinda"),T.classList.add("border-transparent"),T.dataset.theme===v&&(T.classList.remove("border-transparent"),T.classList.add("border-guinda"),v!=="dark"&&T.classList.add("text-guinda"))}),!document.getElementById("reader-themes-style")){const T=document.createElement("style");T.id="reader-themes-style",T.innerHTML=`
                    /* Sepia Mode */
                ...
                `,document.head.appendChild(T)}};De(c);const Te=()=>{Be&&(Be.style.fontSize=`${d}%`),document.querySelectorAll("#font-size-display, #mob-font-display").forEach(v=>{v.innerText=`${d}%`})};z&&z.addEventListener("click",()=>{d<250&&(d+=10,Te())}),ie&&ie.addEventListener("click",()=>{d>80&&(d-=10,Te())}),pe&&(pe.addEventListener("click",()=>{d=100,Te()}),pe.style.cursor="pointer",pe.title="Restablecer al 100%"),dt.forEach(v=>{v.addEventListener("click",T=>{De(T.target.dataset.theme)})});const Ve=document.getElementById("mobile-reading-toggle"),He=document.getElementById("mobile-reading-sheet"),$e=document.getElementById("mobile-reading-overlay"),qe=v=>{He==null||He.classList.toggle("translate-y-full",!v),$e==null||$e.classList.toggle("hidden",!v)};Ve==null||Ve.addEventListener("click",()=>qe(!0)),$e==null||$e.addEventListener("click",()=>qe(!1)),(ht=document.getElementById("mob-font-decrease"))==null||ht.addEventListener("click",()=>{d>80&&(d-=10,Te())}),(mt=document.getElementById("mob-font-increase"))==null||mt.addEventListener("click",()=>{d<250&&(d+=10,Te())}),document.querySelectorAll(".mob-theme-btn").forEach(v=>{v.addEventListener("click",()=>{De(v.dataset.theme),qe(!1)})});const ct=document.getElementById("law-share-btn"),Ce=document.getElementById("law-share-menu");document.getElementById("law-share-text-btn"),document.getElementById("law-share-link-btn"),ct&&Ce&&(ct.addEventListener("click",v=>{v.stopPropagation(),Ce.classList.toggle("hidden")}),document.addEventListener("click",function v(T){T.target.closest("#law-share-wrapper")||(Ce.classList.add("hidden"),document.removeEventListener("click",v))})),Object.entries({"law-share-whatsapp-btn":()=>Qe(n,"whatsapp"),"law-share-telegram-btn":()=>Qe(n,"telegram"),"law-share-twitter-btn":()=>Qe(n,"twitter"),"law-share-email-btn":()=>Qe(n,"email"),"law-share-link-btn":()=>{const v=`${location.origin}${location.pathname}#ley-${encodeURIComponent(n.id)}`;navigator.clipboard.writeText(v).then(()=>b("¡Enlace copiado!","🔗","bg-blue-600"))}}).forEach(([v,T])=>{var Y;(Y=document.getElementById(v))==null||Y.addEventListener("click",()=>{Ce==null||Ce.classList.add("hidden"),T()})}),(ft=document.getElementById("print-btn"))==null||ft.addEventListener("click",()=>window.print()),(xt=document.getElementById("crumb-inicio"))==null||xt.addEventListener("click",()=>ae()),(bt=document.getElementById("crumb-categoria"))==null||bt.addEventListener("click",()=>P()),document.querySelectorAll(".theme-filter-btn").forEach(v=>{v.addEventListener("click",T=>{const Y=T.target.dataset.theme,W=document.getElementById("law-search-input");W&&(W.value=Y,W.dispatchEvent(new Event("input")))})}),document.getElementById("law-search-input").addEventListener("input",v=>{const T=v.target.value.toLowerCase().trim();let Y=D;T.length>2&&(Y=D.filter(W=>W.texto.toLowerCase().includes(T)||W.articulo_label.toLowerCase().includes(T)||W.titulo_nombre&&W.titulo_nombre.toLowerCase().includes(T)||W.capitulo_nombre&&W.capitulo_nombre.toLowerCase().includes(T))),we(Y.slice(0,50),T)}),document.getElementById("export-csv-btn").addEventListener("click",()=>{wt(D,`${n.titulo}.csv`)})}function Je(n){const i=document.getElementById("law-structure-chart");if(!i)return;if(!window.d3){i.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">Cargando visualización...</div>',setTimeout(()=>Je(n),1e3);return}if(i.innerHTML="",!n||n.length===0){i.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">No hay datos para visualizar</div>';return}const l={};n.forEach(x=>{let C=x.titulo_nombre||x.capitulo_nombre||"General";C=C.replace(/^TÍTULO\s+/i,"").replace(/^CAPÍTULO\s+/i,""),C=C.replace(/^[IVXLCDM]+\.?\s*-?\s*/,""),C=C.replace(/^(PRIMERO|SEGUNDO|TERCERO|CUARTO|QUINTO|SEXTO|SÉPTIMO|OCTAVO|NOVENO|DÉCIMO)\.?\s*-?\s*/i,""),C=C.trim(),C||(C="General"),C.length>25&&(C=C.substring(0,25)+"..."),l[C]=(l[C]||0)+1});const d=Object.entries(l).map(([x,C])=>({name:x,value:C})).sort((x,C)=>C.value-x.value).slice(0,5);if(d.length===0){i.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">Datos insuficientes</div>';return}const c={top:10,right:30,bottom:20,left:220},f=i.clientWidth,h=Math.max(i.clientHeight,d.length*35+c.top+c.bottom);d3.select(i).select("svg").remove();const p=d3.select(i).append("svg").attr("width","100%").attr("height",h).attr("viewBox",[0,0,f,h]).attr("style","max-width: 100%; height: auto; font: 11px sans-serif;"),E=d3.scaleLinear().domain([0,d3.max(d,x=>x.value)]).range([c.left,f-c.right]),Q=d3.scaleBand().domain(d.map(x=>x.name)).rangeRound([c.top,h-c.bottom]).padding(.3);d3.selectAll(".d3-tooltip").remove();const w=d3.select("body").append("div").attr("class","d3-tooltip absolute bg-gray-900/90 backdrop-blur text-white text-[10px] rounded-lg py-1.5 px-3 pointer-events-none opacity-0 transition-opacity z-50 shadow-xl border border-gray-700").style("display","none");p.append("g").attr("fill","#9B2247").selectAll("rect").data(d).join("rect").attr("x",E(0)).attr("y",x=>Q(x.name)).attr("width",x=>Math.max(0,E(x.value)-E(0))).attr("height",Q.bandwidth()).attr("rx",4).on("mouseover",(x,C)=>{d3.select(x.target).attr("fill","#7A1C39"),w.style("opacity","1").style("display","block").text(`${C.name}: ${C.value} artículos`)}).on("mousemove",x=>{w.style("left",x.pageX+10+"px").style("top",x.pageY-10+"px")}).on("mouseout",x=>{d3.select(x.target).attr("fill","#9B2247"),w.style("opacity","0").style("display","none")}),p.append("g").attr("fill","black").attr("text-anchor","start").attr("font-size","10px").selectAll("text").data(d).join("text").attr("x",x=>E(x.value)+4).attr("y",x=>Q(x.name)+Q.bandwidth()/2).attr("dy","0.35em").text(x=>x.value),p.append("g").call(d3.axisLeft(Q).tickSize(0)).attr("transform",`translate(${c.left},0)`).call(x=>x.select(".domain").remove()).call(x=>x.selectAll("text").attr("fill","#4B5563").attr("font-weight","500").style("text-anchor","end").attr("dx","-6"))}function we(n,i){const l=document.getElementById("law-articles-list");if(l){if(n.length===0){l.innerHTML='<div class="text-center py-8 text-gray-400 text-sm">No se encontraron artículos que coincidan con la búsqueda.</div>';return}he=n,l.innerHTML=n.map(d=>{const c=i?_e(d.texto,i):d.texto.substring(0,300)+"...",f=!!Le(d.id),g=Se(d.id)?'<svg class="w-3.5 h-3.5 text-guinda" fill="currentColor" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>':'<svg class="w-3.5 h-3.5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>',h=ee.includes(d.id),p=h?"text-guinda":ee.length>=2?"text-gray-100":"text-gray-300 hover:text-guinda",E=h?"bg-guinda/10":"";return`
            ...
            `}).join(""),document.querySelectorAll("#law-articles-list .result-item").forEach(d=>{d.addEventListener("click",c=>{c.target.closest(".bookmark-card-btn")||c.target.closest(".compare-card-btn")||me(d.dataset.id)})}),document.querySelectorAll("#law-articles-list .bookmark-card-btn").forEach(d=>{d.addEventListener("click",c=>{c.stopPropagation();const f=document.getElementById("law-search-input");Ae(d.dataset.id);const g=f?f.value.toLowerCase().trim():"";we(D.slice(0,50),g)})}),document.querySelectorAll("#law-articles-list .compare-card-btn").forEach(d=>{d.addEventListener("click",c=>{var p;c.stopPropagation();const f=d.dataset.id,g=ee.indexOf(f);g>=0?ee.splice(g,1):ee.length<2&&ee.push(f),Ze();const h=((p=document.getElementById("law-search-input"))==null?void 0:p.value.toLowerCase().trim())||"";we(D.slice(0,50),h)})})}}function Oe(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function _e(n,i){if(!i||!n)return n||"";const l=new RegExp(`(${Oe(i)})`,"gi");return n.replace(l,'<mark class="bg-yellow-200 text-gray-900 rounded-sm px-0.5">$1</mark>')}function yt(n,i){const l=i>0?n/i:0;return l>=.6?'<span class="text-[9px] font-bold text-guinda bg-guinda/10 px-1.5 py-0.5 rounded-full">Alta</span>':l>=.25?'<span class="text-[9px] font-bold text-amber-600 bg-amber-50 px-1.5 py-0.5 rounded-full">Media</span>':'<span class="text-[9px] font-bold text-gray-400 bg-gray-50 px-1.5 py-0.5 rounded-full">Baja</span>'}function wt(n,i){const l=["Ley","Artículo","Texto"],d=n.map(h=>[`"${h.ley_origen}"`,`"${h.articulo_label}"`,`"${h.texto.replace(/"/g,'""')}"`]),c=[l.join(","),...d.map(h=>h.join(","))].join(`
`),f=new Blob([c],{type:"text/csv;charset=utf-8;"}),g=document.createElement("a");if(g.download!==void 0){const h=URL.createObjectURL(f);g.setAttribute("href",h),g.setAttribute("download",i),g.style.visibility="hidden",document.body.appendChild(g),g.click(),document.body.removeChild(g)}}function kt(n){const i=Pe().filter(l=>l!==n);i.unshift(n),localStorage.setItem("search-history",JSON.stringify(i.slice(0,10)))}function Pe(){return JSON.parse(localStorage.getItem("search-history")||"[]")}if(a&&a.addEventListener("click",n=>{n.target.tagName==="BUTTON"&&($.value=n.target.textContent,$.dispatchEvent(new Event("input")))}),$){const n=document.createElement("div");n.id="autocomplete-results",n.className="absolute w-full bg-white border border-gray-100 rounded-2xl shadow-xl mt-2 hidden z-50 overflow-hidden",$.parentNode.appendChild(n),document.addEventListener("click",i=>{!$.contains(i.target)&&!n.contains(i.target)&&n.classList.add("hidden")}),$.addEventListener("focus",()=>{var l;if($.value.trim().length>0)return;const i=Pe();i.length!==0&&(n.innerHTML=`
            ...
            `,n.classList.remove("hidden"),(l=document.getElementById("clear-all-history"))==null||l.addEventListener("click",d=>{d.stopPropagation(),localStorage.removeItem("search-history"),n.classList.add("hidden")}),n.querySelectorAll(".history-item").forEach(d=>{d.addEventListener("click",c=>{if(c.target.classList.contains("remove-history-item")){c.stopPropagation();const f=c.target.dataset.query,g=Pe().filter(h=>h!==f);localStorage.setItem("search-history",JSON.stringify(g)),d.remove(),n.querySelectorAll(".history-item").length===0&&n.classList.add("hidden");return}$.value=d.dataset.query,$.dispatchEvent(new Event("input")),n.classList.add("hidden")})}))}),$.addEventListener("input",i=>{const l=i.target.value.trim();if(l.length>2){if(r.classList.add("hidden"),r.classList.remove("block"),a.classList.add("hidden"),e.classList.add("hidden"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),S.classList.remove("hidden"),setTimeout(()=>S.classList.remove("opacity-0"),50),_&&_.classList.remove("hidden"),R(),N.length>0){const d=N.filter(c=>c.titulo.toLowerCase().includes(l.toLowerCase())).slice(0,5);d.length>0?(n.innerHTML=`
                            ...
                            `).join("")}
                         `,n.classList.remove("hidden"),n.querySelectorAll(".suggestion-item").forEach(c=>{c.addEventListener("click",()=>{const f=c.dataset.title,g=N.find(h=>h.titulo===f);g&&(ye(g),n.classList.add("hidden"),$.value="")})})):n.classList.add("hidden")}setTimeout(()=>{G=Rt(l),K=l,y=1,A={type:"all",law:"all",artNum:""},kt(l),ke(),_&&_.classList.add("hidden")},100)}else l.length===0&&(r.classList.remove("hidden"),a.classList.remove("hidden"),e.classList.remove("hidden"),o.classList.add("justify-center","pt-24"),o.classList.remove("pt-8"),S.classList.add("hidden","opacity-0"),S.innerHTML="")})}let A={type:"all",law:"all",artNum:""},he=[],ee=[];function je(){return JSON.parse(localStorage.getItem("article-favorites")||"[]")}function Se(n){return je().includes(n)}function Ae(n){const i=je(),l=i.indexOf(n);l>=0?i.splice(l,1):i.unshift(n),localStorage.setItem("article-favorites",JSON.stringify(i)),Xe()}function Xe(){const n=je().length,i=Object.keys(Fe()).length;document.querySelectorAll("#nav-favorites, #mobile-nav-favorites").forEach(l=>{l&&(l.classList.toggle("hidden",n===0&&i===0),l.querySelectorAll(".fav-count").forEach(d=>d.textContent=n))})}function Fe(){return JSON.parse(localStorage.getItem("article-notes")||"{}")}function Le(n){return Fe()[n]||""}function Ye(n,i){const l=Fe();i.trim()?l[n]=i.trim():delete l[n],localStorage.setItem("article-notes",JSON.stringify(l))}function Lt(n,i,l=!1){const d=new Date().toLocaleDateString("es-MX",{day:"numeric",month:"long",year:"numeric"}),c=n.map(p=>{const E=l?Le(p.id):"";return`
        ...
        ${c}
        </body></html>`,g=new Blob([f],{type:"text/html;charset=utf-8;"}),h=document.createElement("a");h.href=URL.createObjectURL(g),h.download=`${i.replace(/\s+/g,"_")}_${d.replace(/\s/g,"-")}.html`,h.click(),URL.revokeObjectURL(h.href)}function Et(n,i,l=!1){const d=["Ley","Artículo","Título","Texto",...l?["Nota personal"]:[]],c=n.map(p=>[`"${(p.ley_origen||"").replace(/"/g,'""')}"`,`"${(p.articulo_label||"").replace(/"/g,'""')}"`,`"${(p.titulo_nombre||"").replace(/"/g,'""')}"`,`"${(p.texto||"").replace(/"/g,'""')}"`,...l?[`"${Le(p.id).replace(/"/g,'""')}"`]:[]]),f=[d.join(","),...c.map(p=>p.join(","))].join(`
`),g=new Blob(["\uFEFF"+f],{type:"text/csv;charset=utf-8;"}),h=document.createElement("a");h.href=URL.createObjectURL(g),h.download=i,h.click(),URL.revokeObjectURL(h.href)}function Ke(){var f,g;Z(null);const n=je();r.classList.add("hidden"),a.classList.add("hidden"),e.classList.add("hidden"),t&&t.classList.add("hidden","opacity-0"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),S.classList.remove("hidden"),setTimeout(()=>S.classList.remove("opacity-0"),50);const i=document.getElementById("search-filters");if(i&&i.remove(),n.length===0){S.innerHTML='<div class="text-center py-16 text-gray-400 text-sm">No tienes artículos guardados aún.</div>';return}const l=n.map(h=>Me(h)).filter(Boolean);he=l,S.innerHTML=`
            ...
            `).join("")}
        `,document.querySelectorAll("#results-container .result-item").forEach(h=>{h.addEventListener("click",()=>me(h.dataset.id))});const d=document.getElementById("export-favs-btn"),c=document.getElementById("export-favs-menu");d&&c&&(d.addEventListener("click",h=>{h.stopPropagation(),c.classList.toggle("hidden")}),document.addEventListener("click",function h(p){!p.target.closest("#export-favs-btn")&&!p.target.closest("#export-favs-menu")&&(c.classList.add("hidden"),document.removeEventListener("click",h))})),(f=document.getElementById("export-favs-html"))==null||f.addEventListener("click",()=>{c==null||c.classList.add("hidden"),Lt(l,"Mis Favoritos SENER",!1),b("¡Exportando HTML!","📄","bg-blue-600")}),(g=document.getElementById("export-favs-csv"))==null||g.addEventListener("click",()=>{c==null||c.classList.add("hidden"),Et(l,"favoritos_SENER.csv",!1),b("¡Exportando CSV!","📊","bg-green-700")})}function Ze(){var l,d;const n=document.getElementById("reading-controls");let i=document.getElementById("compare-bar");if(ee.length===0){i==null||i.remove(),n&&(n.classList.remove("bottom-16"),n.classList.add("bottom-6"));return}i||(i=document.createElement("div"),i.id="compare-bar",document.body.appendChild(i)),n&&(n.classList.remove("bottom-6"),n.classList.add("bottom-16")),i.className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-gray-200 shadow-2xl py-3 px-6 flex items-center justify-between",i.innerHTML=`
        ...
        `,(l=document.getElementById("compare-clear-btn"))==null||l.addEventListener("click",()=>{var f;ee=[],Ze();const c=((f=document.getElementById("law-search-input"))==null?void 0:f.value.toLowerCase().trim())||"";we(D.slice(0,50),c)}),(d=document.getElementById("compare-go-btn"))==null||d.addEventListener("click",()=>{$t(ee[0],ee[1])})}function $t(n,i){const l=Me(n),d=Me(i);if(!l||!d)return;const c=document.getElementById("compare-modal"),f=document.getElementById("compare-content"),g=document.getElementById("compare-panel");if(!c||!f)return;const h=w=>`
...
`).map(x=>`<p class="mb-3">${x}</p>`).join("")}
            ...
            </div>`;f.innerHTML=h(l)+h(d),c.classList.remove("hidden"),c.classList.add("flex"),setTimeout(()=>{g==null||g.classList.remove("scale-95","opacity-0"),g==null||g.classList.add("scale-100","opacity-100")},10);const p=document.getElementById("compare-share-btn"),E=document.getElementById("compare-share-menu"),Q=document.getElementById("compare-share-text-btn");p&&E&&(p.onclick=w=>{w.stopPropagation(),E.classList.toggle("hidden")},document.addEventListener("click",function w(x){x.target.closest("#compare-share-menu-wrapper")||(E.classList.add("hidden"),document.removeEventListener("click",w))})),Q&&(Q.onclick=()=>{E==null||E.classList.add("hidden"),Bt(l,d)})}function Ne(){const n=document.getElementById("compare-modal"),i=document.getElementById("compare-panel");i==null||i.classList.remove("scale-100","opacity-100"),i==null||i.classList.add("scale-95","opacity-0"),setTimeout(()=>{n==null||n.classList.add("hidden"),n==null||n.classList.remove("flex")},300)}async function Ct(n){const i=document.createElement("canvas");i.width=800,i.height=500;const l=i.getContext("2d"),d=l.createLinearGradient(0,0,0,i.height);d.addColorStop(0,"#9B2247"),d.addColorStop(1,"#6b1532"),l.fillStyle=d,l.fillRect(0,0,i.width,i.height),l.beginPath(),l.arc(i.width-60,60,120,0,Math.PI*2),l.fillStyle="rgba(255,255,255,0.06)",l.fill(),l.fillStyle="rgba(255,255,255,0.15)",l.beginPath(),l.roundRect(40,40,20+l.measureText(n.ley_origen).width+16,28,14),l.fill(),l.fillStyle="#fff",l.font="bold 13px system-ui, sans-serif",l.fillText(n.ley_origen,56,59),l.fillStyle="#fff",l.font="bold 28px system-ui, sans-serif";const c=et(l,n.articulo_label,i.width-80);c.forEach((w,x)=>l.fillText(w,40,110+x*38));const f=110+c.length*38+16;l.strokeStyle="rgba(255,255,255,0.3)",l.lineWidth=1,l.beginPath(),l.moveTo(40,f),l.lineTo(i.width-40,f),l.stroke();const g=f+24,h=i.height-g-60;l.fillStyle="rgba(255,255,255,0.88)",l.font="16px Georgia, serif";const p=n.texto.replace(/\s+/g," ").trim().substring(0,500),E=et(l,p,i.width-80);let Q=0;for(const w of E){if(Q*24>h){l.fillStyle="rgba(255,255,255,0.5)",l.font="13px system-ui, sans-serif",l.fillText("...",40,g+Q*24);break}l.fillText(w,40,g+Q*24),Q++}return l.fillStyle="rgba(255,255,255,0.35)",l.fillRect(0,i.height-44,i.width,44),l.fillStyle="rgba(255,255,255,0.8)",l.font="12px system-ui, sans-serif",l.fillText("Buscador de Leyes Energéticas · SENER",40,i.height-16),i.toDataURL("image/png")}function et(n,i,l,d){const c=i.split(" "),f=[];let g="";for(const h of c){const p=g?g+" "+h:h;n.measureText(p).width>l&&g?(f.push(g),g=h):g=p}return g&&f.push(g),f}function It(n){const i=`📋 *${n.articulo_label}*
🏛️ ${n.ley_origen}

${n.texto.substring(0,800)}${n.texto.length>800?"...":""}`,l=`https://wa.me/?text=${encodeURIComponent(i)}`;window.open(l,"_blank")}async function St(n){const i=await Ct(n),l=await(await fetch(i)).blob(),d=new File([l],"articulo.png",{type:"image/png"});if(navigator.canShare&&navigator.canShare({files:[d]}))await navigator.share({title:n.articulo_label,text:`${n.articulo_label} · ${n.ley_origen}`,files:[d]});else{const c=document.createElement("a");c.href=i,c.download=`${n.articulo_label.replace(/\s+/g,"_")}.png`,c.click()}}function Bt(n,i){const l=`⚖️ *Comparación de Artículos*

📋 *${n.articulo_label}* – ${n.ley_origen}
${n.texto.substring(0,400)}${n.texto.length>400?"...":""}

📋 *${i.articulo_label}* – ${i.ley_origen}
${i.texto.substring(0,400)}${i.texto.length>400?"...":""}`,d=`https://wa.me/?text=${encodeURIComponent(l)}`;window.open(d,"_blank")}function ze(n,i){const l=`${location.origin}${location.pathname}#art-${encodeURIComponent(n.id)}`,d=`${n.articulo_label} · ${n.ley_origen}`,c=`📋 *${n.articulo_label}*
🏛️ ${n.ley_origen}

${n.texto.substring(0,500)}${n.texto.length>500?"...":""}

${l}`,f=`${n.articulo_label} · ${n.ley_origen} — Marco Legal Energético SENER`,g={telegram:`https://t.me/share/url?url=${encodeURIComponent(l)}&text=${encodeURIComponent(d)}`,twitter:`https://twitter.com/intent/tweet?text=${encodeURIComponent(f)}&url=${encodeURIComponent(l)}`,email:`mailto:?subject=${encodeURIComponent(d)}&body=${encodeURIComponent(c)}`};g[i]&&window.open(g[i],"_blank")}function Qe(n,i){const l=`${location.origin}${location.pathname}#ley-${encodeURIComponent(n.id)}`,d=n.titulo,c=n.resumen?n.resumen.split(`
...
${l}`,g=`${n.titulo} — Marco Legal Energético SENER`,h={whatsapp:`https://wa.me/?text=${encodeURIComponent(f)}`,telegram:`https://t.me/share/url?url=${encodeURIComponent(l)}&text=${encodeURIComponent(d)}`,twitter:`https://twitter.com/intent/tweet?text=${encodeURIComponent(g)}&url=${encodeURIComponent(l)}`,email:`mailto:?subject=${encodeURIComponent(d)}&body=${encodeURIComponent(f)}`};h[i]&&window.open(h[i],"_blank")}function tt(){var h;Z(null),r.classList.add("hidden"),a.classList.add("hidden"),e.classList.add("hidden"),t&&t.classList.add("hidden","opacity-0"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),S.classList.remove("hidden"),setTimeout(()=>S.classList.remove("opacity-0"),50);const n=document.getElementById("search-filters");if(n&&n.remove(),N.length===0){S.innerHTML='<div class="text-center py-16 text-gray-400">Cargando datos...</div>';return}const i=N.reduce((p,E)=>p+E.articulos,0),l=N.filter(p=>p.titulo.toLowerCase().startsWith("ley")),d=N.filter(p=>p.titulo.toLowerCase().startsWith("reglamento")),c=N.filter(p=>!p.titulo.toLowerCase().startsWith("ley")&&!p.titulo.toLowerCase().startsWith("reglamento")),f=[...N].sort((p,E)=>E.articulos-p.articulos),g=((h=f[0])==null?void 0:h.articulos)||1;S.innerHTML=`
            <div class="w-full mb-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm text-center hover:shadow-md transition-shadow">
                    <span class="text-3xl font-head font-bold text-guinda block">${N.length}</span>
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm mb-6">
                ...
                <div class="space-y-3">
                    ${f.map(p=>{const E=p.titulo.toLowerCase().startsWith("ley"),Q=p.titulo.toLowerCase().startsWith("reglamento"),w=E?"#9B2247":Q?"#1E5B4F":"#A57F2C",x=Math.round(p.articulos/g*100);return`
        ...
        `,document.querySelectorAll(".stat-law-row").forEach(p=>{p.addEventListener("click",()=>{const E=N.find(Q=>Q.titulo===p.dataset.titulo);E&&ye(E)})})}function ke(){var p,E,Q;if(!S)return;let n=G;if(A.type!=="all"&&(n=n.filter(w=>A.type==="ley"?w.ley_origen.toLowerCase().includes("ley"):A.type==="reglamento"?w.ley_origen.toLowerCase().includes("reglamento"):!w.ley_origen.toLowerCase().includes("ley")&&!w.ley_origen.toLowerCase().includes("reglamento"))),A.law!=="all"&&(n=n.filter(w=>w.ley_origen===A.law)),A.artNum){const w=parseInt(A.artNum);n=n.filter(x=>{const C=x.articulo_label.match(/\d+/);return C&&parseInt(C[0])===w})}const i=n,l=K,d=document.getElementById("search-filters");if(d&&d.remove(),G.length>0){const w=document.createElement("div");w.id="search-filters",w.className="flex flex-col items-center gap-2 mb-6 animate-fade-in-up";const x=[...new Set(G.map(V=>V.ley_origen))].sort();w.innerHTML=`
            ...
            `,S.parentNode.insertBefore(w,S),w.querySelectorAll(".filter-btn").forEach(V=>{V.addEventListener("click",ne=>{A.type=ne.target.dataset.type,y=1,ke()})});const C=document.getElementById("law-filter-select");C&&C.addEventListener("change",V=>{A.law=V.target.value,y=1,ke()});const X=document.getElementById("art-number-filter");if(X){let V;X.addEventListener("input",ne=>{clearTimeout(V),V=setTimeout(()=>{A.artNum=ne.target.value.trim(),y=1,ke()},400)})}(p=document.getElementById("clear-all-filters"))==null||p.addEventListener("click",()=>{A={type:"all",law:"all",artNum:""},y=1,ke()})}if(i.length===0){const w=A.type!=="all"||A.law!=="all";S.innerHTML=`
                <div class="text-center py-16 px-4">
                    ...
                    `}
                </div>`,S.querySelectorAll(".empty-suggestion").forEach(C=>{C.addEventListener("click",()=>{$&&($.value=C.textContent,$.dispatchEvent(new Event("input")))})}),(E=document.getElementById("empty-browse-laws"))==null||E.addEventListener("click",()=>P());const x=document.getElementById("results-container").nextElementSibling;x&&x.classList.contains("pagination-nav")&&x.remove();return}const c=(y-1)*O,f=c+O,g=i.slice(c,f),h=((Q=i[0])==null?void 0:Q.score)||1;he=i,S.innerHTML=g.map(w=>{const x=_e(w.texto.substring(0,300)+"...",l),C=_e(w.articulo_label,l),X=yt(w.score,h),V=Se(w.id)?'<svg class="w-4 h-4 text-guinda" fill="currentColor" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>':'<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>';return`
            ...
            `}).join(""),ue(i.length,"results-container",ke),document.querySelectorAll(".result-item").forEach(w=>{w.addEventListener("click",x=>{x.target.closest(".bookmark-card-btn")||me(w.dataset.id)})}),document.querySelectorAll(".bookmark-card-btn").forEach(w=>{w.addEventListener("click",x=>{x.stopPropagation(),Ae(w.dataset.id),ke()})})}function me(n){const i=Me(n);if(!i)return;k.textContent=i.ley_origen,L.textContent=i.articulo_label,k.onclick=()=>{const z=N.find(ie=>ie.titulo===i.ley_origen);z&&(Re(),setTimeout(()=>ye(z),310))};let l=i.texto.replace(/\r\n/g,`
`).replace(/\n\s*\n/g,`

`).replace(/([a-z,;])\n([a-z])/g,"$1 $2");const d=z=>K?_e(z,K):z;m.innerHTML=`
            ...
            <div class="mb-4 flex items-center gap-2 text-[11px] text-amber-700 bg-amber-50 border border-amber-100 px-3 py-2 rounded-lg">
                ...
                Término resaltado: <mark class="bg-yellow-200 text-gray-900 rounded-sm px-1 font-semibold">${K}</mark>
            </div>`:""}
            <div class="prose prose-sm max-w-none text-gray-800 leading-relaxed font-serif text-justify">
                ${l.split(`

`).map(z=>`<p class="mb-4">${d(z)}</p>`).join("")}
            </div>
        `;const c=he.findIndex(z=>z.id===n),f=he.length,g=document.getElementById("modal-prev-btn"),h=document.getElementById("modal-next-btn"),p=document.getElementById("modal-nav-counter");g&&(g.disabled=c<=0,g.onclick=()=>{c>0&&me(he[c-1].id)}),h&&(h.disabled=c<0||c>=f-1,h.onclick=()=>{c<f-1&&me(he[c+1].id)}),p&&(p.textContent=c>=0?`${c+1}/${f}`:"");const E=document.getElementById("modal-bookmark-btn");if(E){const z=Se(n);E.innerHTML=z?'<svg class="w-5 h-5 text-guinda" fill="currentColor" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>':'<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>',E.onclick=()=>{Ae(n),me(n)}}const Q=document.getElementById("copy-btn");Q&&(Q.onclick=()=>{navigator.clipboard.writeText(m.innerText).then(()=>{b("¡Texto copiado!","📋")})});const w=document.getElementById("share-btn"),x=document.getElementById("share-menu");document.getElementById("share-text-btn"),document.getElementById("share-image-btn"),w&&x&&(w.onclick=z=>{z.stopPropagation(),x.classList.toggle("hidden")},document.addEventListener("click",function z(ie){ie.target.closest("#share-menu-wrapper")||(x.classList.add("hidden"),document.removeEventListener("click",z))}));const C=Le(n);m.innerHTML+=`
        ...
        `;const X=document.getElementById("article-note-input"),V=document.getElementById("save-note-btn"),ne=document.getElementById("delete-note-btn"),se=document.getElementById("note-saved-indicator");V&&X&&V.addEventListener("click",()=>{Ye(n,X.value),b("¡Nota guardada!","📝","bg-amber-600"),se==null||se.classList.remove("invisible"),ne&&ne.classList.toggle("hidden",!X.value.trim())}),ne&&X&&ne.addEventListener("click",()=>{Ye(n,""),X.value="",se==null||se.classList.add("invisible"),ne.classList.add("hidden"),b("Nota eliminada","🗑️","bg-gray-600")});const Ee=document.getElementById("cite-btn");Ee&&(Ee.onclick=()=>{const z=new Date().toLocaleDateString("es-MX",{day:"numeric",month:"long",year:"numeric"}),ie=`${location.origin}${location.pathname}#art-${encodeURIComponent(n)}`,pe=`${i.articulo_label} de la ${i.ley_origen}${i.fecha_publicacion?", publicada el "+i.fecha_publicacion:""}. Secretaría de Energía, Gobierno de México. Consultado el ${z}. Disponible en: ${ie}`;navigator.clipboard.writeText(pe).then(()=>b("¡Cita copiada!","📖","bg-guinda"))}),Object.entries({"share-text-btn":()=>It(i),"share-image-btn":()=>St(i),"share-telegram-btn":()=>ze(i,"telegram"),"share-twitter-btn":()=>ze(i,"twitter"),"share-email-btn":()=>ze(i,"email")}).forEach(([z,ie])=>{const pe=document.getElementById(z);pe&&(pe.onclick=()=>{x==null||x.classList.add("hidden"),ie()})}),Z(`#art-${encodeURIComponent(n)}`),s.classList.remove("hidden"),s.classList.add("flex");const Be=document.getElementById("share-link-btn");Be&&(Be.onclick=()=>{x==null||x.classList.add("hidden");const z=`${location.origin}${location.pathname}#art-${encodeURIComponent(n)}`;navigator.clipboard.writeText(z).then(()=>b("¡Enlace copiado!","🔗","bg-blue-600"))}),setTimeout(()=>{u.classList.remove("scale-95","opacity-0"),u.classList.add("scale-100","opacity-100")},10)}function Re(){Z(null),u.classList.remove("scale-100","opacity-100"),u.classList.add("scale-95","opacity-0"),setTimeout(()=>{s.classList.add("hidden"),s.classList.remove("flex")},300)}function rt(){var i;let n=document.getElementById("keyboard-help-modal");if(n){n.remove();return}n=document.createElement("div"),n.id="keyboard-help-modal",n.className="fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4",n.innerHTML=`
        ...
        `,document.body.appendChild(n),n.addEventListener("click",l=>{l.target===n&&n.remove()}),(i=document.getElementById("kbd-help-close"))==null||i.addEventListener("click",()=>n.remove())}(it=document.getElementById("keyboard-help-btn"))==null||it.addEventListener("click",rt),document.addEventListener("keydown",n=>{var c,f,g,h;const i=n.target.tagName,l=i==="INPUT"||i==="TEXTAREA"||i==="SELECT"||n.target.isContentEditable,d=!s.classList.contains("hidden");if(n.key==="?"&&!l){n.preventDefault(),rt();return}if(n.key==="Escape"){const p=document.getElementById("keyboard-help-modal");if(p){p.remove();return}const E=document.getElementById("toc-panel");if(E&&!E.classList.contains("translate-y-full")){E.classList.add("translate-y-full"),document.body.style.overflow="";return}if(d){Re();return}const Q=document.getElementById("compare-modal");if(Q&&!Q.classList.contains("hidden")){Ne();return}return}if(n.key==="/"&&!l){n.preventDefault(),$&&($.focus(),$.select());return}if(d&&!l){if(n.key==="ArrowRight"||n.key==="ArrowDown"){n.preventDefault(),(c=document.getElementById("modal-next-btn"))==null||c.click();return}if(n.key==="ArrowLeft"||n.key==="ArrowUp"){n.preventDefault(),(f=document.getElementById("modal-prev-btn"))==null||f.click();return}if(n.key==="f"||n.key==="F"){n.preventDefault(),(g=document.getElementById("modal-bookmark-btn"))==null||g.click();return}if((n.key==="c"||n.key==="C")&&!n.ctrlKey&&!n.metaKey){n.preventDefault(),(h=document.getElementById("copy-btn"))==null||h.click();return}}}),"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").catch(()=>{})}),I&&I.addEventListener("click",Re),s==null||s.addEventListener("click",n=>{n.target===s&&Re()}),j&&j.addEventListener("click",()=>{const n=m.innerText;navigator.clipboard.writeText(n).then(()=>{const i=j.innerHTML;j.innerHTML='<span class="text-verde font-bold">¡Copiado!</span>',setTimeout(()=>{j.innerHTML=i},2e3)})})}document.addEventListener("DOMContentLoaded",()=>{Pt(),jt()});
