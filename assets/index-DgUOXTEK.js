(function(){const S=document.createElement("link").relList;if(S&&S.supports&&S.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))e(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&e(a)}).observe(document,{childList:!0,subtree:!0});function t(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function e(n){if(n.ep)return;n.ep=!0;const o=t(n);fetch(n.href,o)}})();function Bt($){return $&&$.__esModule&&Object.prototype.hasOwnProperty.call($,"default")?$.default:$}var xt={exports:{}};/**
 * lunr - http://lunrjs.com - A bit like Solr, but much smaller and not as bright - 2.3.9
 * Copyright (C) 2020 Oliver Nightingale
 * @license MIT
 */(function($,S){(function(){var t=function(e){var n=new t.Builder;return n.pipeline.add(t.trimmer,t.stopWordFilter,t.stemmer),n.searchPipeline.add(t.stemmer),e.call(n,n),n.build()};t.version="2.3.9";/*!
 * lunr.utils
 * Copyright (C) 2020 Oliver Nightingale
 ...
 * lunr.Set
 * Copyright (C) 2020 Oliver Nightingale
 */t.Set=function(e){if(this.elements=Object.create(null),e){this.length=e.length;for(var n=0;n<this.length;n++)this.elements[e[n]]=!0}else this.length=0},t.Set.complete={intersect:function(e){return e},union:function(){return this},contains:function(){return!0}},t.Set.empty={intersect:function(){return this},union:function(e){return e},contains:function(){return!1}},t.Set.prototype.contains=function(e){return!!this.elements[e]},t.Set.prototype.intersect=function(e){var n,o,a,i=[];if(e===t.Set.complete)return this;if(e===t.Set.empty)return e;this.length<e.length?(n=this,o=e):(n=e,o=this),a=Object.keys(n.elements);for(var u=0;u<a.length;u++){var f=a[u];f in o.elements&&i.push(f)}return new t.Set(i)},t.Set.prototype.union=function(e){return e===t.Set.complete?t.Set.complete:e===t.Set.empty?this:new t.Set(Object.keys(this.elements).concat(Object.keys(e.elements)))},t.idf=function(e,n){var o=0;for(var a in e)a!="_index"&&(o+=Object.keys(e[a]).length);var i=(n-o+.5)/(o+.5);return Math.log(1+Math.abs(i))},t.Token=function(e,n){this.str=e||"",this.metadata=n||{}},t.Token.prototype.toString=function(){return this.str},t.Token.prototype.update=function(e){return this.str=e(this.str,this.metadata),this},t.Token.prototype.clone=function(e){return e=e||function(n){return n},new t.Token(e(this.str,this.metadata),this.metadata)};/*!
 * lunr.tokenizer
 * Copyright (C) 2020 Oliver Nightingale
 */t.tokenizer=function(e,n){if(e==null||e==null)return[];if(Array.isArray(e))return e.map(function(j){return new t.Token(t.utils.asString(j).toLowerCase(),t.utils.clone(n))});for(var o=e.toString().toLowerCase(),a=o.length,i=[],u=0,f=0;u<=a;u++){var L=o.charAt(u),k=u-f;if(L.match(t.tokenizer.separator)||u==a){if(k>0){var I=t.utils.clone(n)||{};I.position=[f,k],I.index=i.length,i.push(new t.Token(o.slice(f,u),I))}f=u+1}}return i},t.tokenizer.separator=/[\s\-]+/;/*!
 * lunr.Pipeline
 * Copyright (C) 2020 Oliver Nightingale
 */t.Pipeline=function(){this._stack=[]},t.Pipeline.registeredFunctions=Object.create(null),t.Pipeline.registerFunction=function(e,n){n in this.registeredFunctions&&t.utils.warn("Overwriting existing registered function: "+n),e.label=n,t.Pipeline.registeredFunctions[e.label]=e},t.Pipeline.warnIfFunctionNotRegistered=function(e){var n=e.label&&e.label in this.registeredFunctions;n||t.utils.warn(`Function is not registered with pipeline. This may cause problems when serialising the index.
`,e)},t.Pipeline.load=function(e){var n=new t.Pipeline;return e.forEach(function(o){var a=t.Pipeline.registeredFunctions[o];if(a)n.add(a);else throw new Error("Cannot load unregistered function: "+o)}),n},t.Pipeline.prototype.add=function(){var e=Array.prototype.slice.call(arguments);e.forEach(function(n){t.Pipeline.warnIfFunctionNotRegistered(n),this._stack.push(n)},this)},t.Pipeline.prototype.after=function(e,n){t.Pipeline.warnIfFunctionNotRegistered(n);var o=this._stack.indexOf(e);if(o==-1)throw new Error("Cannot find existingFn");o=o+1,this._stack.splice(o,0,n)},t.Pipeline.prototype.before=function(e,n){t.Pipeline.warnIfFunctionNotRegistered(n);var o=this._stack.indexOf(e);if(o==-1)throw new Error("Cannot find existingFn");this._stack.splice(o,0,n)},t.Pipeline.prototype.remove=function(e){var n=this._stack.indexOf(e);n!=-1&&this._stack.splice(n,1)},t.Pipeline.prototype.run=function(e){for(var n=this._stack.length,o=0;o<n;o++){for(var a=this._stack[o],i=[],u=0;u<e.length;u++){var f=a(e[u],u,e);if(!(f==null||f===""))if(Array.isArray(f))for(var L=0;L<f.length;L++)i.push(f[L]);else i.push(f)}e=i}return e},t.Pipeline.prototype.runString=function(e,n){var o=new t.Token(e,n);return this.run([o]).map(function(a){return a.toString()})},t.Pipeline.prototype.reset=function(){this._stack=[]},t.Pipeline.prototype.toJSON=function(){return this._stack.map(function(e){return t.Pipeline.warnIfFunctionNotRegistered(e),e.label})};/*!
 * lunr.Vector
 * Copyright (C) 2020 Oliver Nightingale
 */t.Vector=function(e){this._magnitude=0,this.elements=e||[]},t.Vector.prototype.positionForIndex=function(e){if(this.elements.length==0)return 0;for(var n=0,o=this.elements.length/2,a=o-n,i=Math.floor(a/2),u=this.elements[i*2];a>1&&(u<e&&(n=i),u>e&&(o=i),u!=e);)a=o-n,i=n+Math.floor(a/2),u=this.elements[i*2];if(u==e||u>e)return i*2;if(u<e)return(i+1)*2},t.Vector.prototype.insert=function(e,n){this.upsert(e,n,function(){throw"duplicate index"})},t.Vector.prototype.upsert=function(e,n,o){this._magnitude=0;var a=this.positionForIndex(e);this.elements[a]==e?this.elements[a+1]=o(this.elements[a+1],n):this.elements.splice(a,0,e,n)},t.Vector.prototype.magnitude=function(){if(this._magnitude)return this._magnitude;for(var e=0,n=this.elements.length,o=1;o<n;o+=2){var a=this.elements[o];e+=a*a}return this._magnitude=Math.sqrt(e)},t.Vector.prototype.dot=function(e){for(var n=0,o=this.elements,a=e.elements,i=o.length,u=a.length,f=0,L=0,k=0,I=0;k<i&&I<u;)f=o[k],L=a[I],f<L?k+=2:f>L?I+=2:f==L&&(n+=o[k+1]*a[I+1],k+=2,I+=2);return n},t.Vector.prototype.similarity=function(e){return this.dot(e)/this.magnitude()||0},t.Vector.prototype.toArray=function(){for(var e=new Array(this.elements.length/2),n=1,o=0;n<this.elements.length;n+=2,o++)e[o]=this.elements[n];return e},t.Vector.prototype.toJSON=function(){return this.elements};/*!
 * lunr.stemmer
 * Copyright (C) 2020 Oliver Nightingale
 * Includes code from - http://tartarus.org/~martin/PorterStemmer/js.txt
 */t.stemmer=function(){var e={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},n={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},o="[^aeiou]",a="[aeiouy]",i=o+"[^aeiouy]*",u=a+"[aeiou]*",f="^("+i+")?"+u+i,L="^("+i+")?"+u+i+"("+u+")?$",k="^("+i+")?"+u+i+u+i,I="^("+i+")?"+a,j=new RegExp(f),_=new RegExp(k),q=new RegExp(L),N=new RegExp(I),H=/^(.+?)(ss|i)es$/,B=/^(.+?)([^s])s$/,M=/^(.+?)eed$/,J=/^(.+?)(ed|ing)$/,U=/.$/,re=/(at|bl|iz)$/,le=new RegExp("([^aeiouylsz])\\1$"),de=new RegExp("^"+i+a+"[^aeiouwxy]$"),ce=/^(.+?[^aeiou])y$/,ne=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,z=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,D=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,xe=/^(.+?)(s|t)(ion)$/,ae=/^(.+?)e$/,be=/ll$/,ve=new RegExp("^"+i+a+"[^aeiouwxy]$"),ee=function(b){var R,K,G,y,O,ue,Z;if(b.length<3)return b;if(G=b.substr(0,1),G=="y"&&(b=G.toUpperCase()+b.substr(1)),y=H,O=B,y.test(b)?b=b.replace(y,"$1$2"):O.test(b)&&(b=b.replace(O,"$1$2")),y=M,O=J,y.test(b)){var P=y.exec(b);y=j,y.test(P[1])&&(y=U,b=b.replace(y,""))}else if(O.test(b)){var P=O.exec(b);R=P[1],O=N,O.test(R)&&(b=R,O=re,ue=le,Z=de,O.test(b)?b=b+"e":ue.test(b)?(y=U,b=b.replace(y,"")):Z.test(b)&&(b=b+"e"))}if(y=ce,y.test(b)){var P=y.exec(b);R=P[1],b=R+"i"}if(y=ne,y.test(b)){var P=y.exec(b);R=P[1],K=P[2],y=j,y.test(R)&&(b=R+e[K])}if(y=z,y.test(b)){var P=y.exec(b);R=P[1],K=P[2],y=j,y.test(R)&&(b=R+n[K])}if(y=D,O=xe,y.test(b)){var P=y.exec(b);R=P[1],y=_,y.test(R)&&(b=R)}else if(O.test(b)){var P=O.exec(b);R=P[1]+P[2],O=_,O.test(R)&&(b=R)}if(y=ae,y.test(b)){var P=y.exec(b);R=P[1],y=_,O=q,ue=ve,(y.test(R)||O.test(R)&&!ue.test(R))&&(b=R)}return y=be,O=_,y.test(b)&&O.test(b)&&(y=U,b=b.replace(y,"")),G=="y"&&(b=G.toLowerCase()+b.substr(1)),b};return function(pe){return pe.update(ee)}}(),t.Pipeline.registerFunction(t.stemmer,"stemmer");/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
 ...
 * lunr.TokenSet
 * Copyright (C) 2020 Oliver Nightingale
 */t.TokenSet=function(){this.final=!1,this.edges={},this.id=t.TokenSet._nextId,t.TokenSet._nextId+=1},t.TokenSet._nextId=1,t.TokenSet.fromArray=function(e){for(var n=new t.TokenSet.Builder,o=0,a=e.length;o<a;o++)n.insert(e[o]);return n.finish(),n.root},t.TokenSet.fromClause=function(e){return"editDistance"in e?t.TokenSet.fromFuzzyString(e.term,e.editDistance):t.TokenSet.fromString(e.term)},t.TokenSet.fromFuzzyString=function(e,n){for(var o=new t.TokenSet,a=[{node:o,editsRemaining:n,str:e}];a.length;){var i=a.pop();if(i.str.length>0){var u=i.str.charAt(0),f;u in i.node.edges?f=i.node.edges[u]:(f=new t.TokenSet,i.node.edges[u]=f),i.str.length==1&&(f.final=!0),a.push({node:f,editsRemaining:i.editsRemaining,str:i.str.slice(1)})}if(i.editsRemaining!=0){if("*"in i.node.edges)var L=i.node.edges["*"];else{var L=new t.TokenSet;i.node.edges["*"]=L}if(i.str.length==0&&(L.final=!0),a.push({node:L,editsRemaining:i.editsRemaining-1,str:i.str}),i.str.length>1&&a.push({node:i.node,editsRemaining:i.editsRemaining-1,str:i.str.slice(1)}),i.str.length==1&&(i.node.final=!0),i.str.length>=1){if("*"in i.node.edges)var k=i.node.edges["*"];else{var k=new t.TokenSet;i.node.edges["*"]=k}i.str.length==1&&(k.final=!0),a.push({node:k,editsRemaining:i.editsRemaining-1,str:i.str.slice(1)})}if(i.str.length>1){var I=i.str.charAt(0),j=i.str.charAt(1),_;j in i.node.edges?_=i.node.edges[j]:(_=new t.TokenSet,i.node.edges[j]=_),i.str.length==1&&(_.final=!0),a.push({node:_,editsRemaining:i.editsRemaining-1,str:I+i.str.slice(2)})}}}return o},t.TokenSet.fromString=function(e){for(var n=new t.TokenSet,o=n,a=0,i=e.length;a<i;a++){var u=e[a],f=a==i-1;if(u=="*")n.edges[u]=n,n.final=f;else{var L=new t.TokenSet;L.final=f,n.edges[u]=L,n=L}}return o},t.TokenSet.prototype.toArray=function(){for(var e=[],n=[{prefix:"",node:this}];n.length;){var o=n.pop(),a=Object.keys(o.node.edges),i=a.length;o.node.final&&(o.prefix.charAt(0),e.push(o.prefix));for(var u=0;u<i;u++){var f=a[u];n.push({prefix:o.prefix.concat(f),node:o.node.edges[f]})}}return e},t.TokenSet.prototype.toString=function(){if(this._str)return this._str;for(var e=this.final?"1":"0",n=Object.keys(this.edges).sort(),o=n.length,a=0;a<o;a++){var i=n[a],u=this.edges[i];e=e+i+u.id}return e},t.TokenSet.prototype.intersect=function(e){for(var n=new t.TokenSet,o=void 0,a=[{qNode:e,output:n,node:this}];a.length;){o=a.pop();for(var i=Object.keys(o.qNode.edges),u=i.length,f=Object.keys(o.node.edges),L=f.length,k=0;k<u;k++)for(var I=i[k],j=0;j<L;j++){var _=f[j];if(_==I||I=="*"){var q=o.node.edges[_],N=o.qNode.edges[I],H=q.final&&N.final,B=void 0;_ in o.output.edges?(B=o.output.edges[_],B.final=B.final||H):(B=new t.TokenSet,B.final=H,o.output.edges[_]=B),a.push({qNode:N,output:B,node:q})}}}return n},t.TokenSet.Builder=function(){this.previousWord="",this.root=new t.TokenSet,this.uncheckedNodes=[],this.minimizedNodes={}},t.TokenSet.Builder.prototype.insert=function(e){var n,o=0;if(e<this.previousWord)throw new Error("Out of order word insertion");for(var a=0;a<e.length&&a<this.previousWord.length&&e[a]==this.previousWord[a];a++)o++;this.minimize(o),this.uncheckedNodes.length==0?n=this.root:n=this.uncheckedNodes[this.uncheckedNodes.length-1].child;for(var a=o;a<e.length;a++){var i=new t.TokenSet,u=e[a];n.edges[u]=i,this.uncheckedNodes.push({parent:n,char:u,child:i}),n=i}n.final=!0,this.previousWord=e},t.TokenSet.Builder.prototype.finish=function(){this.minimize(0)},t.TokenSet.Builder.prototype.minimize=function(e){for(var n=this.uncheckedNodes.length-1;n>=e;n--){var o=this.uncheckedNodes[n],a=o.child.toString();a in this.minimizedNodes?o.parent.edges[o.char]=this.minimizedNodes[a]:(o.child._str=a,this.minimizedNodes[a]=o.child),this.uncheckedNodes.pop()}};/*!
 * lunr.Index
 * Copyright (C) 2020 Oliver Nightingale
 */t.Index=function(e){this.invertedIndex=e.invertedIndex,this.fieldVectors=e.fieldVectors,this.tokenSet=e.tokenSet,this.fields=e.fields,this.pipeline=e.pipeline},t.Index.prototype.search=function(e){return this.query(function(n){var o=new t.QueryParser(e,n);o.parse()})},t.Index.prototype.query=function(e){for(var n=new t.Query(this.fields),o=Object.create(null),a=Object.create(null),i=Object.create(null),u=Object.create(null),f=Object.create(null),L=0;L<this.fields.length;L++)a[this.fields[L]]=new t.Vector;e.call(n,n);for(var L=0;L<n.clauses.length;L++){var k=n.clauses[L],I=null,j=t.Set.empty;k.usePipeline?I=this.pipeline.runString(k.term,{fields:k.fields}):I=[k.term];for(var _=0;_<I.length;_++){var q=I[_];k.term=q;var N=t.TokenSet.fromClause(k),H=this.tokenSet.intersect(N).toArray();if(H.length===0&&k.presence===t.Query.presence.REQUIRED){for(var B=0;B<k.fields.length;B++){var M=k.fields[B];u[M]=t.Set.empty}break}for(var J=0;J<H.length;J++)for(var U=H[J],re=this.invertedIndex[U],le=re._index,B=0;B<k.fields.length;B++){var M=k.fields[B],de=re[M],ce=Object.keys(de),ne=U+"/"+M,z=new t.Set(ce);if(k.presence==t.Query.presence.REQUIRED&&(j=j.union(z),u[M]===void 0&&(u[M]=t.Set.complete)),k.presence==t.Query.presence.PROHIBITED){f[M]===void 0&&(f[M]=t.Set.empty),f[M]=f[M].union(z);continue}if(a[M].upsert(le,k.boost,function(Ce,ye){return Ce+ye}),!i[ne]){for(var D=0;D<ce.length;D++){var xe=ce[D],ae=new t.FieldRef(xe,M),be=de[xe],ve;(ve=o[ae])===void 0?o[ae]=new t.MatchData(U,M,be):ve.add(U,M,be)}i[ne]=!0}}}if(k.presence===t.Query.presence.REQUIRED)for(var B=0;B<k.fields.length;B++){var M=k.fields[B];u[M]=u[M].intersect(j)}}for(var ee=t.Set.complete,pe=t.Set.empty,L=0;L<this.fields.length;L++){var M=this.fields[L];u[M]&&(ee=ee.intersect(u[M])),f[M]&&(pe=pe.union(f[M]))}var b=Object.keys(o),R=[],K=Object.create(null);if(n.isNegated()){b=Object.keys(this.fieldVectors);for(var L=0;L<b.length;L++){var ae=b[L],G=t.FieldRef.fromString(ae);o[ae]=new t.MatchData}}for(var L=0;L<b.length;L++){var G=t.FieldRef.fromString(b[L]),y=G.docRef;if(ee.contains(y)&&!pe.contains(y)){var O=this.fieldVectors[G],ue=a[G.fieldName].similarity(O),Z;if((Z=K[y])!==void 0)Z.score+=ue,Z.matchData.combine(o[G]);else{var P={ref:y,score:ue,matchData:o[G]};K[y]=P,R.push(P)}}}return R.sort(function(Ae,$e){return $e.score-Ae.score})},t.Index.prototype.toJSON=function(){var e=Object.keys(this.invertedIndex).sort().map(function(o){return[o,this.invertedIndex[o]]},this),n=Object.keys(this.fieldVectors).map(function(o){return[o,this.fieldVectors[o].toJSON()]},this);return{version:t.version,fields:this.fields,fieldVectors:n,invertedIndex:e,pipeline:this.pipeline.toJSON()}},t.Index.load=function(e){var n={},o={},a=e.fieldVectors,i=Object.create(null),u=e.invertedIndex,f=new t.TokenSet.Builder,L=t.Pipeline.load(e.pipeline);e.version!=t.version&&t.utils.warn("Version mismatch when loading serialised index. Current version of lunr '"+t.version+"' does not match serialized index '"+e.version+"'");for(var k=0;k<a.length;k++){var I=a[k],j=I[0],_=I[1];o[j]=new t.Vector(_)}for(var k=0;k<u.length;k++){var I=u[k],q=I[0],N=I[1];f.insert(q),i[q]=N}return f.finish(),n.fields=e.fields,n.fieldVectors=o,n.invertedIndex=i,n.tokenSet=f.root,n.pipeline=L,new t.Index(n)};/*!
 * lunr.Builder
 * Copyright (C) 2020 Oliver Nightingale
 */t.Builder=function(){this._ref="id",this._fields=Object.create(null),this._documents=Object.create(null),this.invertedIndex=Object.create(null),this.fieldTermFrequencies={},this.fieldLengths={},this.tokenizer=t.tokenizer,this.pipeline=new t.Pipeline,this.searchPipeline=new t.Pipeline,this.documentCount=0,this._b=.75,this._k1=1.2,this.termIndex=0,this.metadataWhitelist=[]},t.Builder.prototype.ref=function(e){this._ref=e},t.Builder.prototype.field=function(e,n){if(/\//.test(e))throw new RangeError("Field '"+e+"' contains illegal character '/'");this._fields[e]=n||{}},t.Builder.prototype.b=function(e){e<0?this._b=0:e>1?this._b=1:this._b=e},t.Builder.prototype.k1=function(e){this._k1=e},t.Builder.prototype.add=function(e,n){var o=e[this._ref],a=Object.keys(this._fields);this._documents[o]=n||{},this.documentCount+=1;for(var i=0;i<a.length;i++){var u=a[i],f=this._fields[u].extractor,L=f?f(e):e[u],k=this.tokenizer(L,{fields:[u]}),I=this.pipeline.run(k),j=new t.FieldRef(o,u),_=Object.create(null);this.fieldTermFrequencies[j]=_,this.fieldLengths[j]=0,this.fieldLengths[j]+=I.length;for(var q=0;q<I.length;q++){var N=I[q];if(_[N]==null&&(_[N]=0),_[N]+=1,this.invertedIndex[N]==null){var H=Object.create(null);H._index=this.termIndex,this.termIndex+=1;for(var B=0;B<a.length;B++)H[a[B]]=Object.create(null);this.invertedIndex[N]=H}this.invertedIndex[N][u][o]==null&&(this.invertedIndex[N][u][o]=Object.create(null));for(var M=0;M<this.metadataWhitelist.length;M++){var J=this.metadataWhitelist[M],U=N.metadata[J];this.invertedIndex[N][u][o][J]==null&&(this.invertedIndex[N][u][o][J]=[]),this.invertedIndex[N][u][o][J].push(U)}}}},t.Builder.prototype.calculateAverageFieldLengths=function(){for(var e=Object.keys(this.fieldLengths),n=e.length,o={},a={},i=0;i<n;i++){var u=t.FieldRef.fromString(e[i]),f=u.fieldName;a[f]||(a[f]=0),a[f]+=1,o[f]||(o[f]=0),o[f]+=this.fieldLengths[u]}for(var L=Object.keys(this._fields),i=0;i<L.length;i++){var k=L[i];o[k]=o[k]/a[k]}this.averageFieldLength=o},t.Builder.prototype.createFieldVectors=function(){for(var e={},n=Object.keys(this.fieldTermFrequencies),o=n.length,a=Object.create(null),i=0;i<o;i++){for(var u=t.FieldRef.fromString(n[i]),f=u.fieldName,L=this.fieldLengths[u],k=new t.Vector,I=this.fieldTermFrequencies[u],j=Object.keys(I),_=j.length,q=this._fields[f].boost||1,N=this._documents[u.docRef].boost||1,H=0;H<_;H++){var B=j[H],M=I[B],J=this.invertedIndex[B]._index,U,re,le;a[B]===void 0?(U=t.idf(this.invertedIndex[B],this.documentCount),a[B]=U):U=a[B],re=U*((this._k1+1)*M)/(this._k1*(1-this._b+this._b*(L/this.averageFieldLength[f]))+M),re*=q,re*=N,le=Math.round(re*1e3)/1e3,k.insert(J,le)}e[u]=k}this.fieldVectors=e},t.Builder.prototype.createTokenSet=function(){this.tokenSet=t.TokenSet.fromArray(Object.keys(this.invertedIndex).sort())},t.Builder.prototype.build=function(){return this.calculateAverageFieldLengths(),this.createFieldVectors(),this.createTokenSet(),new t.Index({invertedIndex:this.invertedIndex,fieldVectors:this.fieldVectors,tokenSet:this.tokenSet,fields:Object.keys(this._fields),pipeline:this.searchPipeline})},t.Builder.prototype.use=function(e){var n=Array.prototype.slice.call(arguments,1);n.unshift(this),e.apply(this,n)},t.MatchData=function(e,n,o){for(var a=Object.create(null),i=Object.keys(o||{}),u=0;u<i.length;u++){var f=i[u];a[f]=o[f].slice()}this.metadata=Object.create(null),e!==void 0&&(this.metadata[e]=Object.create(null),this.metadata[e][n]=a)},t.MatchData.prototype.combine=function(e){for(var n=Object.keys(e.metadata),o=0;o<n.length;o++){var a=n[o],i=Object.keys(e.metadata[a]);this.metadata[a]==null&&(this.metadata[a]=Object.create(null));for(var u=0;u<i.length;u++){var f=i[u],L=Object.keys(e.metadata[a][f]);this.metadata[a][f]==null&&(this.metadata[a][f]=Object.create(null));for(var k=0;k<L.length;k++){var I=L[k];this.metadata[a][f][I]==null?this.metadata[a][f][I]=e.metadata[a][f][I]:this.metadata[a][f][I]=this.metadata[a][f][I].concat(e.metadata[a][f][I])}}}},t.MatchData.prototype.add=function(e,n,o){if(!(e in this.metadata)){this.metadata[e]=Object.create(null),this.metadata[e][n]=o;return}if(!(n in this.metadata[e])){this.metadata[e][n]=o;return}for(var a=Object.keys(o),i=0;i<a.length;i++){var u=a[i];u in this.metadata[e][n]?this.metadata[e][n][u]=this.metadata[e][n][u].concat(o[u]):this.metadata[e][n][u]=o[u]}},t.Query=function(e){this.clauses=[],this.allFields=e},t.Query.wildcard=new String("*"),t.Query.wildcard.NONE=0,t.Query.wildcard.LEADING=1,t.Query.wildcard.TRAILING=2,t.Query.presence={OPTIONAL:1,REQUIRED:2,PROHIBITED:3},t.Query.prototype.clause=function(e){return"fields"in e||(e.fields=this.allFields),"boost"in e||(e.boost=1),"usePipeline"in e||(e.usePipeline=!0),"wildcard"in e||(e.wildcard=t.Query.wildcard.NONE),e.wildcard&t.Query.wildcard.LEADING&&e.term.charAt(0)!=t.Query.wildcard&&(e.term="*"+e.term),e.wildcard&t.Query.wildcard.TRAILING&&e.term.slice(-1)!=t.Query.wildcard&&(e.term=""+e.term+"*"),"presence"in e||(e.presence=t.Query.presence.OPTIONAL),this.clauses.push(e),this},t.Query.prototype.isNegated=function(){for(var e=0;e<this.clauses.length;e++)if(this.clauses[e].presence!=t.Query.presence.PROHIBITED)return!1;return!0},t.Query.prototype.term=function(e,n){if(Array.isArray(e))return e.forEach(function(a){this.term(a,t.utils.clone(n))},this),this;var o=n||{};return o.term=e.toString(),this.clause(o),this},t.QueryParseError=function(e,n,o){this.name="QueryParseError",this.message=e,this.start=n,this.end=o},t.QueryParseError.prototype=new Error,t.QueryLexer=function(e){this.lexemes=[],this.str=e,this.length=e.length,this.pos=0,this.start=0,this.escapeCharPositions=[]},t.QueryLexer.prototype.run=function(){for(var e=t.QueryLexer.lexText;e;)e=e(this)},t.QueryLexer.prototype.sliceString=function(){for(var e=[],n=this.start,o=this.pos,a=0;a<this.escapeCharPositions.length;a++)o=this.escapeCharPositions[a],e.push(this.str.slice(n,o)),n=o+1;return e.push(this.str.slice(n,this.pos)),this.escapeCharPositions.length=0,e.join("")},t.QueryLexer.prototype.emit=function(e){this.lexemes.push({type:e,str:this.sliceString(),start:this.start,end:this.pos}),this.start=this.pos},t.QueryLexer.prototype.escapeCharacter=function(){this.escapeCharPositions.push(this.pos-1),this.pos+=1},t.QueryLexer.prototype.next=function(){if(this.pos>=this.length)return t.QueryLexer.EOS;var e=this.str.charAt(this.pos);return this.pos+=1,e},t.QueryLexer.prototype.width=function(){return this.pos-this.start},t.QueryLexer.prototype.ignore=function(){this.start==this.pos&&(this.pos+=1),this.start=this.pos},t.QueryLexer.prototype.backup=function(){this.pos-=1},t.QueryLexer.prototype.acceptDigitRun=function(){var e,n;do e=this.next(),n=e.charCodeAt(0);while(n>47&&n<58);e!=t.QueryLexer.EOS&&this.backup()},t.QueryLexer.prototype.more=function(){return this.pos<this.length},t.QueryLexer.EOS="EOS",t.QueryLexer.FIELD="FIELD",t.QueryLexer.TERM="TERM",t.QueryLexer.EDIT_DISTANCE="EDIT_DISTANCE",t.QueryLexer.BOOST="BOOST",t.QueryLexer.PRESENCE="PRESENCE",t.QueryLexer.lexField=function(e){return e.backup(),e.emit(t.QueryLexer.FIELD),e.ignore(),t.QueryLexer.lexText},t.QueryLexer.lexTerm=function(e){if(e.width()>1&&(e.backup(),e.emit(t.QueryLexer.TERM)),e.ignore(),e.more())return t.QueryLexer.lexText},t.QueryLexer.lexEditDistance=function(e){return e.ignore(),e.acceptDigitRun(),e.emit(t.QueryLexer.EDIT_DISTANCE),t.QueryLexer.lexText},t.QueryLexer.lexBoost=function(e){return e.ignore(),e.acceptDigitRun(),e.emit(t.QueryLexer.BOOST),t.QueryLexer.lexText},t.QueryLexer.lexEOS=function(e){e.width()>0&&e.emit(t.QueryLexer.TERM)},t.QueryLexer.termSeparator=t.tokenizer.separator,t.QueryLexer.lexText=function(e){for(;;){var n=e.next();if(n==t.QueryLexer.EOS)return t.QueryLexer.lexEOS;if(n.charCodeAt(0)==92){e.escapeCharacter();continue}if(n==":")return t.QueryLexer.lexField;if(n=="~")return e.backup(),e.width()>0&&e.emit(t.QueryLexer.TERM),t.QueryLexer.lexEditDistance;if(n=="^")return e.backup(),e.width()>0&&e.emit(t.QueryLexer.TERM),t.QueryLexer.lexBoost;if(n=="+"&&e.width()===1||n=="-"&&e.width()===1)return e.emit(t.QueryLexer.PRESENCE),t.QueryLexer.lexText;if(n.match(t.QueryLexer.termSeparator))return t.QueryLexer.lexTerm}},t.QueryParser=function(e,n){this.lexer=new t.QueryLexer(e),this.query=n,this.currentClause={},this.lexemeIdx=0},t.QueryParser.prototype.parse=function(){this.lexer.run(),this.lexemes=this.lexer.lexemes;for(var e=t.QueryParser.parseClause;e;)e=e(this);return this.query},t.QueryParser.prototype.peekLexeme=function(){return this.lexemes[this.lexemeIdx]},t.QueryParser.prototype.consumeLexeme=function(){var e=this.peekLexeme();return this.lexemeIdx+=1,e},t.QueryParser.prototype.nextClause=function(){var e=this.currentClause;this.query.clause(e),this.currentClause={}},t.QueryParser.parseClause=function(e){var n=e.peekLexeme();if(n!=null)switch(n.type){case t.QueryLexer.PRESENCE:return t.QueryParser.parsePresence;case t.QueryLexer.FIELD:return t.QueryParser.parseField;case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var o="expected either a field or a term, found "+n.type;throw n.str.length>=1&&(o+=" with value '"+n.str+"'"),new t.QueryParseError(o,n.start,n.end)}},t.QueryParser.parsePresence=function(e){var n=e.consumeLexeme();if(n!=null){switch(n.str){case"-":e.currentClause.presence=t.Query.presence.PROHIBITED;break;case"+":e.currentClause.presence=t.Query.presence.REQUIRED;break;default:var o="unrecognised presence operator'"+n.str+"'";throw new t.QueryParseError(o,n.start,n.end)}var a=e.peekLexeme();if(a==null){var o="expecting term or field, found nothing";throw new t.QueryParseError(o,n.start,n.end)}switch(a.type){case t.QueryLexer.FIELD:return t.QueryParser.parseField;case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var o="expecting term or field, found '"+a.type+"'";throw new t.QueryParseError(o,a.start,a.end)}}},t.QueryParser.parseField=function(e){var n=e.consumeLexeme();if(n!=null){if(e.query.allFields.indexOf(n.str)==-1){var o=e.query.allFields.map(function(u){return"'"+u+"'"}).join(", "),a="unrecognised field '"+n.str+"', possible fields: "+o;throw new t.QueryParseError(a,n.start,n.end)}e.currentClause.fields=[n.str];var i=e.peekLexeme();if(i==null){var a="expecting term, found nothing";throw new t.QueryParseError(a,n.start,n.end)}switch(i.type){case t.QueryLexer.TERM:return t.QueryParser.parseTerm;default:var a="expecting term, found '"+i.type+"'";throw new t.QueryParseError(a,i.start,i.end)}}},t.QueryParser.parseTerm=function(e){var n=e.consumeLexeme();if(n!=null){e.currentClause.term=n.str.toLowerCase(),n.str.indexOf("*")!=-1&&(e.currentClause.usePipeline=!1);var o=e.peekLexeme();if(o==null){e.nextClause();return}switch(o.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var a="Unexpected lexeme type '"+o.type+"'";throw new t.QueryParseError(a,o.start,o.end)}}},t.QueryParser.parseEditDistance=function(e){var n=e.consumeLexeme();if(n!=null){var o=parseInt(n.str,10);if(isNaN(o)){var a="edit distance must be numeric";throw new t.QueryParseError(a,n.start,n.end)}e.currentClause.editDistance=o;var i=e.peekLexeme();if(i==null){e.nextClause();return}switch(i.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var a="Unexpected lexeme type '"+i.type+"'";throw new t.QueryParseError(a,i.start,i.end)}}},t.QueryParser.parseBoost=function(e){var n=e.consumeLexeme();if(n!=null){var o=parseInt(n.str,10);if(isNaN(o)){var a="boost must be numeric";throw new t.QueryParseError(a,n.start,n.end)}e.currentClause.boost=o;var i=e.peekLexeme();if(i==null){e.nextClause();return}switch(i.type){case t.QueryLexer.TERM:return e.nextClause(),t.QueryParser.parseTerm;case t.QueryLexer.FIELD:return e.nextClause(),t.QueryParser.parseField;case t.QueryLexer.EDIT_DISTANCE:return t.QueryParser.parseEditDistance;case t.QueryLexer.BOOST:return t.QueryParser.parseBoost;case t.QueryLexer.PRESENCE:return e.nextClause(),t.QueryParser.parsePresence;default:var a="Unexpected lexeme type '"+i.type+"'";throw new t.QueryParseError(a,i.start,i.end)}}},function(e,n){$.exports=n()}(this,function(){return t})})()})(xt);var Tt=xt.exports;const Mt=Bt(Tt);let Xe,me=[];async function _t(){try{console.log("Initializing search...");const $=await fetch("/data/manifest.json");if(!$.ok)throw new Error("Manifest not found");const t=(await $.json()).map(i=>fetch(`/data/${i}`).then(u=>u.json())),e=await Promise.all(t);me=e.flatMap(i=>i.articulos.map(u=>({...u,ley_origen:i.metadata.ley,fecha_publicacion:i.metadata.fecha_publicacion}))),Xe=Mt(function(){this.ref("id"),this.field("texto"),this.field("titulo_nombre",{boost:5}),this.field("capitulo_nombre",{boost:3}),this.field("articulo_label",{boost:10}),this.field("ley_origen",{boost:5}),me.forEach(i=>{this.add(i)})}),console.log(`Search Index Ready. ${me.length} articles indexed.`);const n=new Set(me.map(i=>i.ley_origen)),o=jt(e),a={totalLeyes:n.size,totalArticulos:me.length,leyes:Array.from(n),summaries:o};window.dispatchEvent(new CustomEvent("search-ready",{detail:a}))}catch($){console.error("Error initializing search:",$)}}function jt($){return $.map(S=>{const t=S.metadata,e={};S.articulos.forEach(o=>{e[o.capitulo_nombre]||(e[o.capitulo_nombre]=0),e[o.capitulo_nombre]++});const n=Object.entries(e).sort((o,a)=>a[1]-o[1]).slice(0,3).map(o=>o[0]);return{titulo:t.ley,fecha:t.fecha_publicacion,articulos:t.total_articulos,temas_clave:n,id:t.ley.replace(/\s+/g,"-").toLowerCase(),resumen:t.resumen||"No hay resumen disponible para este documento."}})}function Qt($){if(!Xe)return[];try{let S=$;return!/[~*^:+]/.test($)&&(S=$.split(/\s+/).filter(n=>n.length>2).map(n=>`${n}~1 ${n}*`).join(" ")),Xe.search(S).map(n=>({...me.find(a=>a.id===n.ref),score:n.score,matchData:n.matchData}))}catch(S){return console.warn("Search error",S),[]}}function _e($){return me.find(S=>S.id===$)}function Rt($){return me.filter(S=>S.ley_origen===$)}function Ot(){var at,st,it,lt,dt;const $=document.getElementById("search-input"),S=document.getElementById("results-container"),t=document.getElementById("law-detail-container"),e=document.getElementById("stats-minimal"),n=document.getElementById("hero-section"),o=document.getElementById("main-container"),a=document.getElementById("quick-filters"),i=document.getElementById("detail-modal"),u=document.getElementById("modal-panel"),f=document.getElementById("modal-content"),L=document.getElementById("modal-title"),k=document.getElementById("modal-ley"),I=document.getElementById("close-modal"),j=document.getElementById("copy-btn"),_=document.getElementById("loading-indicator"),q=document.getElementById("nav-inicio"),N=document.getElementById("nav-leyes"),H=document.getElementById("mobile-menu-btn"),B=document.getElementById("mobile-menu-overlay"),M=document.getElementById("mobile-menu-drawer"),J=document.getElementById("close-mobile-menu"),U=document.getElementById("mobile-nav-inicio"),re=document.getElementById("mobile-nav-leyes"),le="app-dark-mode";let de=localStorage.getItem(le)==="true";function ce(r){if(de=r,localStorage.setItem(le,r),document.documentElement.classList.toggle("dark-mode",r),!document.getElementById("global-dark-style")){const c=document.createElement("style");c.id="global-dark-style",c.innerHTML=`
            ...
            `,document.head.appendChild(c)}const s=document.querySelectorAll("#darkmode-icon-moon, #mobile-darkmode-moon"),l=document.querySelectorAll("#darkmode-icon-sun, #mobile-darkmode-sun"),d=document.getElementById("mobile-darkmode-label");s.forEach(c=>c.classList.toggle("hidden",r)),l.forEach(c=>c.classList.toggle("hidden",!r)),d&&(d.textContent=r?"Modo claro":"Modo oscuro")}de&&ce(!0),(at=document.getElementById("darkmode-toggle"))==null||at.addEventListener("click",()=>ce(!de)),(st=document.getElementById("mobile-darkmode-toggle"))==null||st.addEventListener("click",()=>ce(!de));function ne(r){!M||!B||(r?(B.classList.remove("hidden"),B.offsetWidth,B.classList.remove("opacity-0"),M.classList.remove("translate-x-full"),document.body.style.overflow="hidden"):(B.classList.add("opacity-0"),M.classList.add("translate-x-full"),document.body.style.overflow="",setTimeout(()=>{B.classList.add("hidden")},300)))}H&&H.addEventListener("click",()=>ne(!0)),J&&J.addEventListener("click",()=>ne(!1)),B&&B.addEventListener("click",()=>ne(!1)),U&&U.addEventListener("click",r=>{r.preventDefault(),$e(),ne(!1)}),re&&re.addEventListener("click",r=>{r.preventDefault(),je(),ne(!1)});let z=[],D=[];window.addEventListener("search-ready",r=>{const{totalLeyes:s,totalArticulos:l,summaries:d}=r.detail;z=d,e&&(e.innerHTML=`
            ...
            `),Ke(),setTimeout(pe,0)});const xe=document.getElementById("nav-favorites"),ae=document.getElementById("mobile-nav-favorites");xe&&xe.addEventListener("click",()=>et()),ae&&ae.addEventListener("click",()=>{et(),ne(!1)});const be=document.getElementById("nav-stats"),ve=document.getElementById("mobile-nav-stats");be&&be.addEventListener("click",r=>{r.preventDefault(),nt()}),ve&&ve.addEventListener("click",r=>{r.preventDefault(),nt(),ne(!1)}),(it=document.getElementById("close-compare-modal"))==null||it.addEventListener("click",De),(lt=document.getElementById("compare-modal"))==null||lt.addEventListener("click",r=>{r.target===document.getElementById("compare-modal")&&De()});function ee(r){history.replaceState(null,"",r?`${location.pathname}${r}`:location.pathname)}function pe(){const r=location.hash;if(r){if(r.startsWith("#art-")){const s=decodeURIComponent(r.slice(5)),l=_e(s);if(!l)return;ge=[l],he(s)}else if(r.startsWith("#ley-")){const s=decodeURIComponent(r.slice(5)),l=z.find(d=>d.id===s);l&&ye(l)}}}function b(r,s="✓",l="bg-gray-900"){const d=document.getElementById("app-toast");d&&d.remove();const c=document.createElement("div");c.id="app-toast",c.className=`fixed bottom-24 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-2 px-5 py-3 ${l} text-white text-xs font-semibold rounded-full shadow-2xl transition-all duration-300 opacity-0 scale-90 pointer-events-none`,c.innerHTML=`<span>${s}</span><span>${r}</span>`,document.body.appendChild(c),requestAnimationFrame(()=>{c.classList.replace("opacity-0","opacity-100"),c.classList.replace("scale-90","scale-100")}),setTimeout(()=>{c.classList.replace("opacity-100","opacity-0"),c.classList.replace("scale-100","scale-90"),setTimeout(()=>c.remove(),300)},2500)}function R(r=5){S.innerHTML=Array(r).fill("").map(()=>`
        ...
        `}function ye(r){var ut,pt,gt,ht,ft,mt;if(!t)return;Z(),Ae(),D=Rt(r.titulo);const s=[...new Set(D.map(v=>v.capitulo_nombre).filter(Boolean))];[...new Set(D.map(v=>v.titulo_nombre).filter(Boolean))];const l=D.filter(v=>v.articulo_label.toLowerCase().includes("transitorio")).length;S.classList.add("hidden"),n.classList.add("hidden"),a.classList.add("hidden"),e.classList.add("hidden"),t.classList.remove("hidden"),setTimeout(()=>t.classList.remove("opacity-0"),50),ee(`#ley-${encodeURIComponent(r.id)}`);let d=100,c=localStorage.getItem("reader-theme")||"light";t.innerHTML=`
...
`)[0]}</div>`:""}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10 animate-fade-in-up" style="animation-delay: 0.2s;">
                ...
                <div class="lg:col-span-1 bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div class="flex flex-wrap gap-2 content-start">
                        ${r.temas_clave?r.temas_clave.map(v=>`<button class="theme-filter-btn text-xs bg-gray-50 text-gray-600 px-3 py-1.5 rounded-lg border border-gray-100 hover:bg-guinda hover:text-white hover:border-guinda transition-all shadow-sm" data-theme="${v}">${v}</button>`).join(""):'<span class="text-xs text-gray-400">No disponibles</span>'}
                    </div>
                </div>
            </div>
        ...
        `,document.body.appendChild(m);const g=D.map((v,T)=>{const Y=v.articulo_label.match(/\d+/),W=Y?Y[0]:T+1,Ge=!!ke(v.id);return`<button class="toc-art-btn text-[11px] font-medium rounded-lg py-2 px-1 border transition-all text-center relative
                ...
                Art.${W}
                ${Ge?'<span class="absolute top-0.5 right-0.5 w-1.5 h-1.5 bg-amber-400 rounded-full"></span>':""}
            </button>`}).join(""),h=D.map(v=>{const T=!!ke(v.id),Y=Se(v.id),W=v.titulo_nombre?`<span class="text-gray-400 ml-1 font-normal">· ${v.titulo_nombre}</span>`:"";return`<button class="toc-art-btn w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-left transition-all hover:bg-guinda/5 group/item
        ...
        `,document.body.appendChild(p);const E=p.querySelector("#toc-tab-grid"),Q=p.querySelector("#toc-tab-list"),w=p.querySelector("#toc-content-grid"),x=p.querySelector("#toc-content-list"),C=p.querySelector("#toc-search"),X=["bg-guinda","text-white","shadow-sm"],V=["text-gray-500","hover:text-guinda","hover:bg-guinda/5"];E.addEventListener("click",()=>{E.classList.add(...X),E.classList.remove(...V),Q.classList.remove(...X),Q.classList.add(...V),w.classList.remove("hidden"),x.classList.add("hidden"),C&&(C.value=""),w.querySelectorAll(".toc-art-btn").forEach(v=>v.style.display="")}),Q.addEventListener("click",()=>{Q.classList.add(...X),Q.classList.remove(...V),E.classList.remove(...X),E.classList.add(...V),x.classList.remove("hidden"),w.classList.add("hidden"),C&&(C.value=""),x.querySelectorAll(".toc-art-btn").forEach(v=>v.style.display="")}),C&&(C.addEventListener("input",v=>{const T=v.target.value.toLowerCase().trim();(x.classList.contains("hidden")?w:x).querySelectorAll(".toc-art-btn").forEach(W=>{var Je;const Ge=!T||((Je=W.title)==null?void 0:Je.toLowerCase().includes(T))||W.textContent.toLowerCase().includes(T);W.style.display=Ge?"":"none"})}),C.addEventListener("click",v=>v.stopPropagation()));let oe=!1;const se=v=>{oe=v,v?(p.classList.remove("translate-y-full"),document.body.style.overflow="hidden"):(p.classList.add("translate-y-full"),document.body.style.overflow="")};m.addEventListener("click",()=>se(!oe)),(ut=p.querySelector("#toc-close-btn"))==null||ut.addEventListener("click",()=>se(!1)),p.querySelectorAll(".toc-art-btn").forEach(v=>{v.addEventListener("click",()=>{se(!1),he(v.dataset.id)})}),Ie(D.slice(0,20),""),setTimeout(()=>{Ye(D)},100);const Be=document.getElementById("law-articles-list"),He=document.getElementById("btn-font-increase"),Te=document.getElementById("btn-font-decrease"),F=document.getElementById("font-size-display"),ie=document.querySelectorAll(".theme-btn");document.getElementById("law-header-area");const fe=v=>{if(c=v,localStorage.setItem("reader-theme",v),document.body.className=`bg-${v} text-gray-900 font-body min-h-screen flex flex-col antialiased transition-colors duration-300`,ie.forEach(T=>{T.classList.remove("ring-2","ring-guinda","ring-offset-1"),T.dataset.theme===v&&T.classList.add("ring-2","ring-guinda","ring-offset-1")}),document.querySelectorAll(".mob-theme-btn").forEach(T=>{T.classList.remove("border-guinda","text-guinda"),T.classList.add("border-transparent"),T.dataset.theme===v&&(T.classList.remove("border-transparent"),T.classList.add("border-guinda"),v!=="dark"&&T.classList.add("text-guinda"))}),!document.getElementById("reader-themes-style")){const T=document.createElement("style");T.id="reader-themes-style",T.innerHTML=`
                    /* Sepia Mode */
                ...
                `,document.head.appendChild(T)}};fe(c);const Me=()=>{Be&&(Be.style.fontSize=`${d}%`),document.querySelectorAll("#font-size-display, #mob-font-display").forEach(v=>{v.innerText=`${d}%`})};He&&He.addEventListener("click",()=>{d<250&&(d+=10,Me())}),Te&&Te.addEventListener("click",()=>{d>80&&(d-=10,Me())}),F&&(F.addEventListener("click",()=>{d=100,Me()}),F.style.cursor="pointer",F.title="Restablecer al 100%"),ie.forEach(v=>{v.addEventListener("click",T=>{fe(T.target.dataset.theme)})});const qe=document.getElementById("mobile-reading-toggle"),Ue=document.getElementById("mobile-reading-sheet"),Le=document.getElementById("mobile-reading-overlay"),We=v=>{Ue==null||Ue.classList.toggle("translate-y-full",!v),Le==null||Le.classList.toggle("hidden",!v)};qe==null||qe.addEventListener("click",()=>We(!0)),Le==null||Le.addEventListener("click",()=>We(!1)),(pt=document.getElementById("mob-font-decrease"))==null||pt.addEventListener("click",()=>{d>80&&(d-=10,Me())}),(gt=document.getElementById("mob-font-increase"))==null||gt.addEventListener("click",()=>{d<250&&(d+=10,Me())}),document.querySelectorAll(".mob-theme-btn").forEach(v=>{v.addEventListener("click",()=>{fe(v.dataset.theme),We(!1)})});const ct=document.getElementById("law-share-btn"),Ee=document.getElementById("law-share-menu");document.getElementById("law-share-text-btn"),document.getElementById("law-share-link-btn"),ct&&Ee&&(ct.addEventListener("click",v=>{v.stopPropagation(),Ee.classList.toggle("hidden")}),document.addEventListener("click",function v(T){T.target.closest("#law-share-wrapper")||(Ee.classList.add("hidden"),document.removeEventListener("click",v))})),Object.entries({"law-share-whatsapp-btn":()=>Oe(r,"whatsapp"),"law-share-telegram-btn":()=>Oe(r,"telegram"),"law-share-twitter-btn":()=>Oe(r,"twitter"),"law-share-email-btn":()=>Oe(r,"email"),"law-share-link-btn":()=>{const v=`${location.origin}${location.pathname}#ley-${encodeURIComponent(r.id)}`;navigator.clipboard.writeText(v).then(()=>b("¡Enlace copiado!","🔗","bg-blue-600"))}}).forEach(([v,T])=>{var Y;(Y=document.getElementById(v))==null||Y.addEventListener("click",()=>{Ee==null||Ee.classList.add("hidden"),T()})}),(ht=document.getElementById("print-btn"))==null||ht.addEventListener("click",()=>window.print()),(ft=document.getElementById("crumb-inicio"))==null||ft.addEventListener("click",()=>$e()),(mt=document.getElementById("crumb-categoria"))==null||mt.addEventListener("click",()=>je()),document.querySelectorAll(".theme-filter-btn").forEach(v=>{v.addEventListener("click",T=>{const Y=T.target.dataset.theme,W=document.getElementById("law-search-input");W&&(W.value=Y,W.dispatchEvent(new Event("input")))})}),document.getElementById("law-search-input").addEventListener("input",v=>{const T=v.target.value.toLowerCase().trim();let Y=D;T.length>2&&(Y=D.filter(W=>W.texto.toLowerCase().includes(T)||W.articulo_label.toLowerCase().includes(T)||W.titulo_nombre&&W.titulo_nombre.toLowerCase().includes(T)||W.capitulo_nombre&&W.capitulo_nombre.toLowerCase().includes(T))),Ie(Y.slice(0,50),T)}),document.getElementById("export-csv-btn").addEventListener("click",()=>{yt(D,`${r.titulo}.csv`)})}function Ye(r){const s=document.getElementById("law-structure-chart");if(!s)return;if(!window.d3){s.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">Cargando visualización...</div>',setTimeout(()=>Ye(r),1e3);return}if(s.innerHTML="",!r||r.length===0){s.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">No hay datos para visualizar</div>';return}const l={};r.forEach(x=>{let C=x.titulo_nombre||x.capitulo_nombre||"General";C=C.replace(/^TÍTULO\s+/i,"").replace(/^CAPÍTULO\s+/i,""),C=C.replace(/^[IVXLCDM]+\.?\s*-?\s*/,""),C=C.replace(/^(PRIMERO|SEGUNDO|TERCERO|CUARTO|QUINTO|SEXTO|SÉPTIMO|OCTAVO|NOVENO|DÉCIMO)\.?\s*-?\s*/i,""),C=C.trim(),C||(C="General"),C.length>25&&(C=C.substring(0,25)+"..."),l[C]=(l[C]||0)+1});const d=Object.entries(l).map(([x,C])=>({name:x,value:C})).sort((x,C)=>C.value-x.value).slice(0,5);if(d.length===0){s.innerHTML='<div class="flex items-center justify-center h-full text-xs text-gray-400">Datos insuficientes</div>';return}const c={top:10,right:30,bottom:20,left:220},m=s.clientWidth,h=Math.max(s.clientHeight,d.length*35+c.top+c.bottom);d3.select(s).select("svg").remove();const p=d3.select(s).append("svg").attr("width","100%").attr("height",h).attr("viewBox",[0,0,m,h]).attr("style","max-width: 100%; height: auto; font: 11px sans-serif;"),E=d3.scaleLinear().domain([0,d3.max(d,x=>x.value)]).range([c.left,m-c.right]),Q=d3.scaleBand().domain(d.map(x=>x.name)).rangeRound([c.top,h-c.bottom]).padding(.3);d3.selectAll(".d3-tooltip").remove();const w=d3.select("body").append("div").attr("class","d3-tooltip absolute bg-gray-900/90 backdrop-blur text-white text-[10px] rounded-lg py-1.5 px-3 pointer-events-none opacity-0 transition-opacity z-50 shadow-xl border border-gray-700").style("display","none");p.append("g").attr("fill","#9B2247").selectAll("rect").data(d).join("rect").attr("x",E(0)).attr("y",x=>Q(x.name)).attr("width",x=>Math.max(0,E(x.value)-E(0))).attr("height",Q.bandwidth()).attr("rx",4).on("mouseover",(x,C)=>{d3.select(x.target).attr("fill","#7A1C39"),w.style("opacity","1").style("display","block").text(`${C.name}: ${C.value} artículos`)}).on("mousemove",x=>{w.style("left",x.pageX+10+"px").style("top",x.pageY-10+"px")}).on("mouseout",x=>{d3.select(x.target).attr("fill","#9B2247"),w.style("opacity","0").style("display","none")}),p.append("g").attr("fill","black").attr("text-anchor","start").attr("font-size","10px").selectAll("text").data(d).join("text").attr("x",x=>E(x.value)+4).attr("y",x=>Q(x.name)+Q.bandwidth()/2).attr("dy","0.35em").text(x=>x.value),p.append("g").call(d3.axisLeft(Q).tickSize(0)).attr("transform",`translate(${c.left},0)`).call(x=>x.select(".domain").remove()).call(x=>x.selectAll("text").attr("fill","#4B5563").attr("font-weight","500").style("text-anchor","end").attr("dx","-6"))}function Ie(r,s){const l=document.getElementById("law-articles-list");if(l){if(r.length===0){l.innerHTML='<div class="text-center py-8 text-gray-400 text-sm">No se encontraron artículos que coincidan con la búsqueda.</div>';return}ge=r,l.innerHTML=r.map(d=>{const c=s?Qe(d.texto,s):d.texto.substring(0,300)+"...",m=!!ke(d.id),g=Se(d.id)?'<svg class="w-3.5 h-3.5 text-guinda" fill="currentColor" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>':'<svg class="w-3.5 h-3.5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>',h=te.includes(d.id),p=h?"text-guinda":te.length>=2?"text-gray-100":"text-gray-300 hover:text-guinda",E=h?"bg-guinda/10":"";return`
            ...
            `}).join(""),document.querySelectorAll("#law-articles-list .result-item").forEach(d=>{d.addEventListener("click",c=>{c.target.closest(".bookmark-card-btn")||c.target.closest(".compare-card-btn")||he(d.dataset.id)})}),document.querySelectorAll("#law-articles-list .bookmark-card-btn").forEach(d=>{d.addEventListener("click",c=>{c.stopPropagation();const m=document.getElementById("law-search-input");Ne(d.dataset.id);const g=m?m.value.toLowerCase().trim():"";Ie(D.slice(0,50),g)})}),document.querySelectorAll("#law-articles-list .compare-card-btn").forEach(d=>{d.addEventListener("click",c=>{var p;c.stopPropagation();const m=d.dataset.id,g=te.indexOf(m);g>=0?te.splice(g,1):te.length<2&&te.push(m),tt();const h=((p=document.getElementById("law-search-input"))==null?void 0:p.value.toLowerCase().trim())||"";Ie(D.slice(0,50),h)})})}}function bt(r){return r.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Qe(r,s){if(!s||!r)return r||"";const l=s.trim().split(/\s+/).filter(m=>m.length>1);if(l.length===0)return r;const d=l.map(m=>bt(m)).join("|"),c=new RegExp(`(${d})`,"gi");return r.replace(c,'<mark class="hl">$1</mark>')}function vt(r,s){const l=s>0?r/s:0;return l>=.6?'<span class="text-[9px] font-bold text-guinda bg-guinda/10 px-1.5 py-0.5 rounded-full">Alta</span>':l>=.25?'<span class="text-[9px] font-bold text-amber-600 bg-amber-50 px-1.5 py-0.5 rounded-full">Media</span>':'<span class="text-[9px] font-bold text-gray-400 bg-gray-50 px-1.5 py-0.5 rounded-full">Baja</span>'}function yt(r,s){const l=["Ley","Artículo","Texto"],d=r.map(h=>[`"${h.ley_origen}"`,`"${h.articulo_label}"`,`"${h.texto.replace(/"/g,'""')}"`]),c=[l.join(","),...d.map(h=>h.join(","))].join(`
`),m=new Blob([c],{type:"text/csv;charset=utf-8;"}),g=document.createElement("a");if(g.download!==void 0){const h=URL.createObjectURL(m);g.setAttribute("href",h),g.setAttribute("download",s),g.style.visibility="hidden",document.body.appendChild(g),g.click(),document.body.removeChild(g)}}function wt(r){const s=Fe().filter(l=>l!==r);s.unshift(r),localStorage.setItem("search-history",JSON.stringify(s.slice(0,10)))}function Fe(){return JSON.parse(localStorage.getItem("search-history")||"[]")}if(a&&a.addEventListener("click",r=>{r.target.tagName==="BUTTON"&&($.value=r.target.textContent,$.dispatchEvent(new Event("input")))}),$){const r=document.createElement("div");r.id="autocomplete-results",r.className="absolute w-full bg-white border border-gray-100 rounded-2xl shadow-xl mt-2 hidden z-50 overflow-hidden",$.parentNode.appendChild(r),document.addEventListener("click",s=>{!$.contains(s.target)&&!r.contains(s.target)&&r.classList.add("hidden")}),$.addEventListener("focus",()=>{var l;if($.value.trim().length>0)return;const s=Fe();s.length!==0&&(r.innerHTML=`
                ...
                `).join("")}
            `,r.classList.remove("hidden"),(l=document.getElementById("clear-all-history"))==null||l.addEventListener("click",d=>{d.stopPropagation(),localStorage.removeItem("search-history"),r.classList.add("hidden")}),r.querySelectorAll(".history-item").forEach(d=>{d.addEventListener("click",c=>{if(c.target.classList.contains("remove-history-item")){c.stopPropagation();const m=c.target.dataset.query,g=Fe().filter(h=>h!==m);localStorage.setItem("search-history",JSON.stringify(g)),d.remove(),r.querySelectorAll(".history-item").length===0&&r.classList.add("hidden");return}$.value=d.dataset.query,$.dispatchEvent(new Event("input")),r.classList.add("hidden")})}))}),$.addEventListener("input",s=>{const l=s.target.value.trim();if(l.length>2){if(Z(),t&&t.classList.add("hidden","opacity-0"),n.classList.add("hidden"),n.classList.remove("block"),a.classList.add("hidden"),e.classList.add("hidden"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),S.classList.remove("hidden"),setTimeout(()=>S.classList.remove("opacity-0"),50),_&&_.classList.remove("hidden"),R(),z.length>0){const d=z.filter(c=>c.titulo.toLowerCase().includes(l.toLowerCase())).slice(0,5);d.length>0?(r.innerHTML=`
                            ...
                            `).join("")}
                         `,r.classList.remove("hidden"),r.querySelectorAll(".suggestion-item").forEach(c=>{c.addEventListener("click",()=>{const m=c.dataset.title,g=z.find(h=>h.titulo===m);g&&(ye(g),r.classList.add("hidden"),$.value="")})})):r.classList.add("hidden")}setTimeout(()=>{G=Qt(l),K=l,y=1,A={type:"all",law:"all",artNum:""},wt(l),we(),_&&_.classList.add("hidden")},100)}else l.length===0&&(Z(),t&&t.classList.add("hidden","opacity-0"),n.classList.remove("hidden"),a.classList.remove("hidden"),e.classList.remove("hidden"),o.classList.add("justify-center","pt-24"),o.classList.remove("pt-8"),S.classList.add("hidden","opacity-0"),S.innerHTML="")})}let A={type:"all",law:"all",artNum:""},ge=[],te=[];function Re(){return JSON.parse(localStorage.getItem("article-favorites")||"[]")}function Se(r){return Re().includes(r)}function Ne(r){const s=Re(),l=s.indexOf(r);l>=0?s.splice(l,1):s.unshift(r),localStorage.setItem("article-favorites",JSON.stringify(s)),Ke()}function Ke(){const r=Re().length,s=Object.keys(ze()).length;document.querySelectorAll("#nav-favorites, #mobile-nav-favorites").forEach(l=>{l&&(l.classList.toggle("hidden",r===0&&s===0),l.querySelectorAll(".fav-count").forEach(d=>d.textContent=r))})}function ze(){return JSON.parse(localStorage.getItem("article-notes")||"{}")}function ke(r){return ze()[r]||""}function Ze(r,s){const l=ze();s.trim()?l[r]=s.trim():delete l[r],localStorage.setItem("article-notes",JSON.stringify(l))}function kt(r,s,l=!1){const d=new Date().toLocaleDateString("es-MX",{day:"numeric",month:"long",year:"numeric"}),c=r.map(p=>{const E=l?ke(p.id):"";return`
        ...
        ${c}
        </body></html>`,g=new Blob([m],{type:"text/html;charset=utf-8;"}),h=document.createElement("a");h.href=URL.createObjectURL(g),h.download=`${s.replace(/\s+/g,"_")}_${d.replace(/\s/g,"-")}.html`,h.click(),URL.revokeObjectURL(h.href)}function Lt(r,s,l=!1){const d=["Ley","Artículo","Título","Texto",...l?["Nota personal"]:[]],c=r.map(p=>[`"${(p.ley_origen||"").replace(/"/g,'""')}"`,`"${(p.articulo_label||"").replace(/"/g,'""')}"`,`"${(p.titulo_nombre||"").replace(/"/g,'""')}"`,`"${(p.texto||"").replace(/"/g,'""')}"`,...l?[`"${ke(p.id).replace(/"/g,'""')}"`]:[]]),m=[d.join(","),...c.map(p=>p.join(","))].join(`
`),g=new Blob(["\uFEFF"+m],{type:"text/csv;charset=utf-8;"}),h=document.createElement("a");h.href=URL.createObjectURL(g),h.download=s,h.click(),URL.revokeObjectURL(h.href)}function et(){var m,g;ee(null),Z(),P();const r=Re();n.classList.add("hidden"),a.classList.add("hidden"),e.classList.add("hidden"),t&&t.classList.add("hidden","opacity-0"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),S.classList.remove("hidden"),setTimeout(()=>S.classList.remove("opacity-0"),50);const s=document.getElementById("search-filters");if(s&&s.remove(),r.length===0){S.innerHTML='<div class="text-center py-16 text-gray-400 text-sm">No tienes artículos guardados aún.</div>';return}const l=r.map(h=>_e(h)).filter(Boolean);ge=l,S.innerHTML=`
        ...
        `,document.querySelectorAll("#results-container .result-item").forEach(h=>{h.addEventListener("click",()=>he(h.dataset.id))});const d=document.getElementById("export-favs-btn"),c=document.getElementById("export-favs-menu");d&&c&&(d.addEventListener("click",h=>{h.stopPropagation(),c.classList.toggle("hidden")}),document.addEventListener("click",function h(p){!p.target.closest("#export-favs-btn")&&!p.target.closest("#export-favs-menu")&&(c.classList.add("hidden"),document.removeEventListener("click",h))})),(m=document.getElementById("export-favs-html"))==null||m.addEventListener("click",()=>{c==null||c.classList.add("hidden"),kt(l,"Mis Favoritos SENER",!1),b("¡Exportando HTML!","📄","bg-blue-600")}),(g=document.getElementById("export-favs-csv"))==null||g.addEventListener("click",()=>{c==null||c.classList.add("hidden"),Lt(l,"favoritos_SENER.csv",!1),b("¡Exportando CSV!","📊","bg-green-700")})}function tt(){var l,d;const r=document.getElementById("reading-controls");let s=document.getElementById("compare-bar");if(te.length===0){s==null||s.remove(),r&&(r.classList.remove("bottom-16"),r.classList.add("bottom-6"));return}s||(s=document.createElement("div"),s.id="compare-bar",document.body.appendChild(s)),r&&(r.classList.remove("bottom-6"),r.classList.add("bottom-16")),s.className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-gray-200 shadow-2xl py-3 px-6 flex items-center justify-between",s.innerHTML=`
            <div class="flex items-center gap-3">
                ...
                <span class="text-xs font-bold text-gray-700">${te.length} de 2 seleccionados</span>
                ${te.length<2?'<span class="text-xs text-gray-400">Selecciona un artículo más para comparar</span>':""}
            </div>
            <div class="flex items-center gap-2">
                <button id="compare-clear-btn" class="text-xs text-gray-400 hover:text-guinda transition-colors px-3 py-1.5">Limpiar</button>
                ${te.length===2?'<button id="compare-go-btn" class="px-4 py-2 bg-guinda text-white text-xs font-bold rounded-full hover:bg-guinda/90 transition-colors">Comparar →</button>':""}
            </div>
        `,(l=document.getElementById("compare-clear-btn"))==null||l.addEventListener("click",()=>{var m;te=[],tt();const c=((m=document.getElementById("law-search-input"))==null?void 0:m.value.toLowerCase().trim())||"";Ie(D.slice(0,50),c)}),(d=document.getElementById("compare-go-btn"))==null||d.addEventListener("click",()=>{Et(te[0],te[1])})}function Et(r,s){const l=_e(r),d=_e(s);if(!l||!d)return;const c=document.getElementById("compare-modal"),m=document.getElementById("compare-content"),g=document.getElementById("compare-panel");if(!c||!m)return;const h=w=>`
...
`).map(x=>`<p class="mb-3">${x}</p>`).join("")}
            ...
            </div>`;m.innerHTML=h(l)+h(d),c.classList.remove("hidden"),c.classList.add("flex"),setTimeout(()=>{g==null||g.classList.remove("scale-95","opacity-0"),g==null||g.classList.add("scale-100","opacity-100")},10);const p=document.getElementById("compare-share-btn"),E=document.getElementById("compare-share-menu"),Q=document.getElementById("compare-share-text-btn");p&&E&&(p.onclick=w=>{w.stopPropagation(),E.classList.toggle("hidden")},document.addEventListener("click",function w(x){x.target.closest("#compare-share-menu-wrapper")||(E.classList.add("hidden"),document.removeEventListener("click",w))})),Q&&(Q.onclick=()=>{E==null||E.classList.add("hidden"),St(l,d)})}function De(){const r=document.getElementById("compare-modal"),s=document.getElementById("compare-panel");s==null||s.classList.remove("scale-100","opacity-100"),s==null||s.classList.add("scale-95","opacity-0"),setTimeout(()=>{r==null||r.classList.add("hidden"),r==null||r.classList.remove("flex")},300)}async function $t(r){const s=document.createElement("canvas");s.width=800,s.height=500;const l=s.getContext("2d"),d=l.createLinearGradient(0,0,0,s.height);d.addColorStop(0,"#9B2247"),d.addColorStop(1,"#6b1532"),l.fillStyle=d,l.fillRect(0,0,s.width,s.height),l.beginPath(),l.arc(s.width-60,60,120,0,Math.PI*2),l.fillStyle="rgba(255,255,255,0.06)",l.fill(),l.fillStyle="rgba(255,255,255,0.15)",l.beginPath(),l.roundRect(40,40,20+l.measureText(r.ley_origen).width+16,28,14),l.fill(),l.fillStyle="#fff",l.font="bold 13px system-ui, sans-serif",l.fillText(r.ley_origen,56,59),l.fillStyle="#fff",l.font="bold 28px system-ui, sans-serif";const c=rt(l,r.articulo_label,s.width-80);c.forEach((w,x)=>l.fillText(w,40,110+x*38));const m=110+c.length*38+16;l.strokeStyle="rgba(255,255,255,0.3)",l.lineWidth=1,l.beginPath(),l.moveTo(40,m),l.lineTo(s.width-40,m),l.stroke();const g=m+24,h=s.height-g-60;l.fillStyle="rgba(255,255,255,0.88)",l.font="16px Georgia, serif";const p=r.texto.replace(/\s+/g," ").trim().substring(0,500),E=rt(l,p,s.width-80);let Q=0;for(const w of E){if(Q*24>h){l.fillStyle="rgba(255,255,255,0.5)",l.font="13px system-ui, sans-serif",l.fillText("...",40,g+Q*24);break}l.fillText(w,40,g+Q*24),Q++}return l.fillStyle="rgba(255,255,255,0.35)",l.fillRect(0,s.height-44,s.width,44),l.fillStyle="rgba(255,255,255,0.8)",l.font="12px system-ui, sans-serif",l.fillText("Buscador de Leyes Energéticas · SENER",40,s.height-16),s.toDataURL("image/png")}function rt(r,s,l,d){const c=s.split(" "),m=[];let g="";for(const h of c){const p=g?g+" "+h:h;r.measureText(p).width>l&&g?(m.push(g),g=h):g=p}return g&&m.push(g),m}function Ct(r){const s=`📋 *${r.articulo_label}*
🏛️ ${r.ley_origen}

${r.texto.substring(0,800)}${r.texto.length>800?"...":""}`,l=`https://wa.me/?text=${encodeURIComponent(s)}`;window.open(l,"_blank")}async function It(r){const s=await $t(r),l=await(await fetch(s)).blob(),d=new File([l],"articulo.png",{type:"image/png"});if(navigator.canShare&&navigator.canShare({files:[d]}))await navigator.share({title:r.articulo_label,text:`${r.articulo_label} · ${r.ley_origen}`,files:[d]});else{const c=document.createElement("a");c.href=s,c.download=`${r.articulo_label.replace(/\s+/g,"_")}.png`,c.click()}}function St(r,s){const l=`⚖️ *Comparación de Artículos*

📋 *${r.articulo_label}* – ${r.ley_origen}
${r.texto.substring(0,400)}${r.texto.length>400?"...":""}

📋 *${s.articulo_label}* – ${s.ley_origen}
${s.texto.substring(0,400)}${s.texto.length>400?"...":""}`,d=`https://wa.me/?text=${encodeURIComponent(l)}`;window.open(d,"_blank")}function Ve(r,s){const l=`${location.origin}${location.pathname}#art-${encodeURIComponent(r.id)}`,d=`${r.articulo_label} · ${r.ley_origen}`,c=`📋 *${r.articulo_label}*
🏛️ ${r.ley_origen}

${r.texto.substring(0,500)}${r.texto.length>500?"...":""}

${l}`,m=`${r.articulo_label} · ${r.ley_origen} — Marco Legal Energético SENER`,g={telegram:`https://t.me/share/url?url=${encodeURIComponent(l)}&text=${encodeURIComponent(d)}`,twitter:`https://twitter.com/intent/tweet?text=${encodeURIComponent(m)}&url=${encodeURIComponent(l)}`,email:`mailto:?subject=${encodeURIComponent(d)}&body=${encodeURIComponent(c)}`};g[s]&&window.open(g[s],"_blank")}function Oe(r,s){const l=`${location.origin}${location.pathname}#ley-${encodeURIComponent(r.id)}`,d=r.titulo,c=r.resumen?r.resumen.split(`

`)[0].substring(0,400):`${r.articulos} artículos`,m=`🏛️ *${r.titulo}*
📅 Publicado: ${r.fecha}
📖 ${r.articulos} artículos

${c}

${l}`,g=`${r.titulo} — Marco Legal Energético SENER`,h={whatsapp:`https://wa.me/?text=${encodeURIComponent(m)}`,telegram:`https://t.me/share/url?url=${encodeURIComponent(l)}&text=${encodeURIComponent(d)}`,twitter:`https://twitter.com/intent/tweet?text=${encodeURIComponent(g)}&url=${encodeURIComponent(l)}`,email:`mailto:?subject=${encodeURIComponent(d)}&body=${encodeURIComponent(m)}`};h[s]&&window.open(h[s],"_blank")}function nt(){var h;ee(null),Z(),P(),n.classList.add("hidden"),a.classList.add("hidden"),e.classList.add("hidden"),t&&t.classList.add("hidden","opacity-0"),o.classList.remove("justify-center","pt-24"),o.classList.add("pt-8"),S.classList.remove("hidden"),setTimeout(()=>S.classList.remove("opacity-0"),50);const r=document.getElementById("search-filters");if(r&&r.remove(),z.length===0){S.innerHTML='<div class="text-center py-16 text-gray-400">Cargando datos...</div>';return}const s=z.reduce((p,E)=>p+E.articulos,0),l=z.filter(p=>p.titulo.toLowerCase().startsWith("ley")),d=z.filter(p=>p.titulo.toLowerCase().startsWith("reglamento")),c=z.filter(p=>!p.titulo.toLowerCase().startsWith("ley")&&!p.titulo.toLowerCase().startsWith("reglamento")),m=[...z].sort((p,E)=>E.articulos-p.articulos),g=((h=m[0])==null?void 0:h.articulos)||1;S.innerHTML=`
            <div class="w-full mb-8">
        ...
        `,document.querySelectorAll(".stat-law-row").forEach(p=>{p.addEventListener("click",()=>{const E=z.find(Q=>Q.titulo===p.dataset.titulo);E&&ye(E)})})}function we(){var p,E,Q;if(!S)return;let r=G;if(A.type!=="all"&&(r=r.filter(w=>A.type==="ley"?w.ley_origen.toLowerCase().includes("ley"):A.type==="reglamento"?w.ley_origen.toLowerCase().includes("reglamento"):!w.ley_origen.toLowerCase().includes("ley")&&!w.ley_origen.toLowerCase().includes("reglamento"))),A.law!=="all"&&(r=r.filter(w=>w.ley_origen===A.law)),A.artNum){const w=parseInt(A.artNum);r=r.filter(x=>{const C=x.articulo_label.match(/\d+/);return C&&parseInt(C[0])===w})}const s=r,l=K,d=document.getElementById("search-filters");if(d&&d.remove(),G.length>0){const w=document.createElement("div");w.id="search-filters",w.className="flex flex-col items-center gap-2 mb-6 animate-fade-in-up";const x=[...new Set(G.map(V=>V.ley_origen))].sort();w.innerHTML=`
                ...
                <div class="flex items-center gap-2 flex-wrap justify-center">
                    ...
                    <select id="law-filter-select" class="text-xs border rounded-full px-4 py-1.5 focus:outline-none bg-white cursor-pointer transition-colors ${A.law!=="all"?"border-guinda text-guinda":"border-gray-200 text-gray-500 hover:border-guinda"}">
                        ...
                        ${x.map(V=>`<option value="${V}" ${A.law===V?"selected":""}>${V}</option>`).join("")}
                    </select>
                    `:""}
            ...
            `,S.parentNode.insertBefore(w,S),w.querySelectorAll(".filter-btn").forEach(V=>{V.addEventListener("click",oe=>{A.type=oe.target.dataset.type,y=1,we()})});const C=document.getElementById("law-filter-select");C&&C.addEventListener("change",V=>{A.law=V.target.value,y=1,we()});const X=document.getElementById("art-number-filter");if(X){let V;X.addEventListener("input",oe=>{clearTimeout(V),V=setTimeout(()=>{A.artNum=oe.target.value.trim(),y=1,we()},400)})}(p=document.getElementById("clear-all-filters"))==null||p.addEventListener("click",()=>{A={type:"all",law:"all",artNum:""},y=1,we()})}if(s.length===0){const w=A.type!=="all"||A.law!=="all";S.innerHTML=`
                <div class="text-center py-16 px-4">
                    ...
                    `}
                </div>`,S.querySelectorAll(".empty-suggestion").forEach(C=>{C.addEventListener("click",()=>{$&&($.value=C.textContent,$.dispatchEvent(new Event("input")))})}),(E=document.getElementById("empty-browse-laws"))==null||E.addEventListener("click",()=>je());const x=document.getElementById("results-container").nextElementSibling;x&&x.classList.contains("pagination-nav")&&x.remove();return}const c=(y-1)*O,m=c+O,g=s.slice(c,m),h=((Q=s[0])==null?void 0:Q.score)||1;ge=s,S.innerHTML=g.map(w=>{const x=Qe(w.texto.substring(0,300)+"...",l),C=Qe(w.articulo_label,l),X=vt(w.score,h),V=Se(w.id)?'<svg class="w-4 h-4 text-guinda" fill="currentColor" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>':'<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>';return`
...
`).map(F=>`<p class="mb-4">${d(F)}</p>`).join("")}
            </div>
        `;const c=ge.findIndex(F=>F.id===r),m=ge.length,g=document.getElementById("modal-prev-btn"),h=document.getElementById("modal-next-btn"),p=document.getElementById("modal-nav-counter");g&&(g.disabled=c<=0,g.onclick=()=>{c>0&&he(ge[c-1].id)}),h&&(h.disabled=c<0||c>=m-1,h.onclick=()=>{c<m-1&&he(ge[c+1].id)}),p&&(p.textContent=c>=0?`${c+1}/${m}`:"");const E=document.getElementById("modal-bookmark-btn");if(E){const F=Se(r);E.innerHTML=F?'<svg class="w-5 h-5 text-guinda" fill="currentColor" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>':'<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>',E.onclick=()=>{Ne(r),he(r)}}const Q=document.getElementById("copy-btn");Q&&(Q.onclick=()=>{navigator.clipboard.writeText(f.innerText).then(()=>{b("¡Texto copiado!","📋")})});const w=document.getElementById("share-btn"),x=document.getElementById("share-menu");document.getElementById("share-text-btn"),document.getElementById("share-image-btn"),w&&x&&(w.onclick=F=>{F.stopPropagation(),x.classList.toggle("hidden")},document.addEventListener("click",function F(ie){ie.target.closest("#share-menu-wrapper")||(x.classList.add("hidden"),document.removeEventListener("click",F))}));const C=ke(r);f.innerHTML+=`
        ...
        `;const X=document.getElementById("article-note-input"),V=document.getElementById("save-note-btn"),oe=document.getElementById("delete-note-btn"),se=document.getElementById("note-saved-indicator");V&&X&&V.addEventListener("click",()=>{Ze(r,X.value),b("¡Nota guardada!","📝","bg-amber-600"),se==null||se.classList.remove("invisible"),oe&&oe.classList.toggle("hidden",!X.value.trim())}),oe&&X&&oe.addEventListener("click",()=>{Ze(r,""),X.value="",se==null||se.classList.add("invisible"),oe.classList.add("hidden"),b("Nota eliminada","🗑️","bg-gray-600")});const Be=document.getElementById("cite-btn");Be&&(Be.onclick=()=>{const F=new Date().toLocaleDateString("es-MX",{day:"numeric",month:"long",year:"numeric"}),ie=`${location.origin}${location.pathname}#art-${encodeURIComponent(r)}`,fe=`${s.articulo_label} de la ${s.ley_origen}${s.fecha_publicacion?", publicada el "+s.fecha_publicacion:""}. Secretaría de Energía, Gobierno de México. Consultado el ${F}. Disponible en: ${ie}`;navigator.clipboard.writeText(fe).then(()=>b("¡Cita copiada!","📖","bg-guinda"))}),Object.entries({"share-text-btn":()=>Ct(s),"share-image-btn":()=>It(s),"share-telegram-btn":()=>Ve(s,"telegram"),"share-twitter-btn":()=>Ve(s,"twitter"),"share-email-btn":()=>Ve(s,"email")}).forEach(([F,ie])=>{const fe=document.getElementById(F);fe&&(fe.onclick=()=>{x==null||x.classList.add("hidden"),ie()})}),ee(`#art-${encodeURIComponent(r)}`),i.classList.remove("hidden"),i.classList.add("flex");const Te=document.getElementById("share-link-btn");Te&&(Te.onclick=()=>{x==null||x.classList.add("hidden");const F=`${location.origin}${location.pathname}#art-${encodeURIComponent(r)}`;navigator.clipboard.writeText(F).then(()=>b("¡Enlace copiado!","🔗","bg-blue-600"))}),setTimeout(()=>{u.classList.remove("scale-95","opacity-0"),u.classList.add("scale-100","opacity-100")},10)}function Pe(){ee(null),u.classList.remove("scale-100","opacity-100"),u.classList.add("scale-95","opacity-0"),setTimeout(()=>{i.classList.add("hidden"),i.classList.remove("flex")},300)}function ot(){var s;let r=document.getElementById("keyboard-help-modal");if(r){r.remove();return}r=document.createElement("div"),r.id="keyboard-help-modal",r.className="fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4",r.innerHTML=`
        ...
        `,document.body.appendChild(r),r.addEventListener("click",l=>{l.target===r&&r.remove()}),(s=document.getElementById("kbd-help-close"))==null||s.addEventListener("click",()=>r.remove())}(dt=document.getElementById("keyboard-help-btn"))==null||dt.addEventListener("click",ot),document.addEventListener("keydown",r=>{var c,m,g,h;const s=r.target.tagName,l=s==="INPUT"||s==="TEXTAREA"||s==="SELECT"||r.target.isContentEditable,d=!i.classList.contains("hidden");if(r.key==="?"&&!l){r.preventDefault(),ot();return}if(r.key==="Escape"){const p=document.getElementById("keyboard-help-modal");if(p){p.remove();return}const E=document.getElementById("toc-panel");if(E&&!E.classList.contains("translate-y-full")){E.classList.add("translate-y-full"),document.body.style.overflow="";return}if(d){Pe();return}const Q=document.getElementById("compare-modal");if(Q&&!Q.classList.contains("hidden")){De();return}return}if(r.key==="/"&&!l){r.preventDefault(),$&&($.focus(),$.select());return}if(d&&!l){if(r.key==="ArrowRight"||r.key==="ArrowDown"){r.preventDefault(),(c=document.getElementById("modal-next-btn"))==null||c.click();return}if(r.key==="ArrowLeft"||r.key==="ArrowUp"){r.preventDefault(),(m=document.getElementById("modal-prev-btn"))==null||m.click();return}if(r.key==="f"||r.key==="F"){r.preventDefault(),(g=document.getElementById("modal-bookmark-btn"))==null||g.click();return}if((r.key==="c"||r.key==="C")&&!r.ctrlKey&&!r.metaKey){r.preventDefault(),(h=document.getElementById("copy-btn"))==null||h.click();return}}}),"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").catch(()=>{})}),I&&I.addEventListener("click",Pe),i==null||i.addEventListener("click",r=>{r.target===i&&Pe()}),j&&j.addEventListener("click",()=>{const r=f.innerText;navigator.clipboard.writeText(r).then(()=>{const s=j.innerHTML;j.innerHTML='<span class="text-verde font-bold">¡Copiado!</span>',setTimeout(()=>{j.innerHTML=s},2e3)})})}document.addEventListener("DOMContentLoaded",()=>{Ot(),_t()});
