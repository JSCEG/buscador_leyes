...
CONFIG['DECRETO-REFORMA-ENERGETICA']=('Reformas a la Ley del Fondo Mexicano del Petróleo para la Estabilización y el Desarrollo y a la Ley Orgánica de la Administración Pública Federal (artículos Noveno y Décimo del decreto del 18 de marzo de 2025)','decreto',['Reforma energética','Fondo Mexicano del Petróleo','Administración Pública Federal'])
...
def note(source):
 ...
 if source['name']=='DECRETO-REFORMA-ENERGETICA':text+='\nAlcance de esta ficha: artículos Noveno (Ley del Fondo Mexicano del Petróleo) y Décimo (Ley Orgánica de la Administración Pública Federal), sus transitorios, los dos transitorios generales y la publicación del decreto del 18 de marzo de 2025. Las ocho leyes expedidas por sus artículos Primero a Octavo ya están disponibles como instrumentos propios en el acervo y no se duplican aquí. Esta ficha reproduce las reformas; no es el texto íntegro de las dos leyes reformadas ni del decreto completo.\n'
...
def build(name):
 ...
 if name=='DECRETO-REFORMA-ENERGETICA':law['siglas']='REFORMAS-FMP-LOAPF'
