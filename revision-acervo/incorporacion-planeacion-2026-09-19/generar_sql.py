...
def note(source):
 ...
 text+='Publicación consultada y, cuando corresponde, su decreto de aprobación:\n\n'
 for s in SOURCES:
 ...
 text+='\nEl plan o programa se organiza por sus apartados y anexos originales. Las tablas conservan sus celdas y las figuras se consultan por enlaces verificados al DOF; no se reconstruyen mapas ni se inventan artículos para estos apartados. Las imágenes requieren conexión con la fuente oficial. No se certifica la vigencia ni se presenta un texto consolidado. Fuentes revisadas el 19 de septiembre de 2026.\n'
